        	...
        	<tr>
        		<td align="left" style="padding-left: 10px; padding-right: 10px;">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 						...
 						<a id="yhgl_btn_add" href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="trqkadd()">添加</a>
	 					<a id="yhgl_btn_out" href="javascript:void(0)" class="easyui-linkbutton" plain="true"  iconCls="icon-remove"  onclick="exportTrqk()">导出Excel</a>
 					</p>
 			</fieldset>
      </td>
   </tr>
