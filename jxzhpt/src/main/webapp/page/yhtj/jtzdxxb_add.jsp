...
<script type="text/javascript">
	$(function(){
		...
		$('#zdsj').datebox('setValue', y+"-"+m+"-"+d);
		$('#yjhfsj').datebox('setValue', y+"-"+m+"-"+d);
	...
	function insertzdxx(){
		...
		+"&zdxx.zdsj="+$('#zdsj').datebox('getValue')+"&zdxx.yjhfsj="+$('#yjhfsj').datebox('getValue')+"&zdxx.tbsj="+$('#tbsj').datebox('getValue');
		 $.ajax({
 			type:"post",
 			url:"/jxzhpt/wjxt/insertzdxx.do",
 			dataType:'json',
 			data:data,
	...
	<table style="width: 100%; background-color: #aacbf8; font-size: 12px"
			...
			<tr style="height: 35px;">
				...
				<a href="javascript:void(0)" id="qx_window" class="easyui-linkbutton"  plain="true" iconCls="icon-cancel" onclick="closes('zdxx_add')">取消</a></td>
			</tr>
			</table>
		</form>
</body>
