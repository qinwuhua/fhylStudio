...
<body id="index_layout" class="easyui-layout">
    <div data-options="region:'west',split:false, iconCls: 'icon-west'" style="width:253px;overflow:hidden">
		<div id="aa" class="easyui-accordion" style="width:251px;">  
		    ...
		    <div id="left_menu2" title="项目基础库审核" data-options="iconCls:'icon-reload'" style="padding:10px;">
	
		    </div>
		     <div id="left_menu3" title="项目审查库管理" data-options="iconCls:'icon-reload'" style="padding:10px;">
	
		    </div>
		     <div id="left_menu4" title="项目审查库审核" data-options="iconCls:'icon-reload'" style="padding:10px;">
