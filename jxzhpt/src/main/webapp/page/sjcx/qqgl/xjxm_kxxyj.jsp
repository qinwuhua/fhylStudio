		...
		function showAllxjsh(){
			...
			$('#datagrid').datagrid({    
			    ...
			    columns:[[
				    ...
				    {field : 'ghlxbh',title : '路线编码',width : 180,align : 'center'},
					...
					<div>
						<table style="margin: 7px; vertical-align: middle;"
							...
							<tr height="32">
								...
								<td>技术等级：</td>
								<td><select name="jsdj" id="jsdj" style="width: 65px;"
									class="easyui-combobox"></select></td>
								<td>行政等级：</td>
								<td><select name="gldj" id="gldj" style="width: 68px;"
									class="easyui-combobox"></select></td>
							</tr>
							<tr height="32">
								<td colspan="10"><img onclick="showAllxjsh()" alt="搜索"
