...
<table style="width: 100%; background-color: #aacbf8; font-size: 12px"
			...
			<tr  style="height: 30px;">
				...
				<td style="background-color: #ffffff;width:12%" align="left">
					<input  type="checkbox" value="pftz" name="checkbox2" class="part2"/>批复总投资</td>
			...
			<tr  style="height: 30px;">
				...
				<td style="background-color: #ffffff;width:10%" align="left">
					<input  type="checkbox" value="xmlc" name="checkbox1" class="part1"/>隐患里程</td>
				<td style="background-color: #ffffff;width:12%" align="left">
			...
			<tr  style="height: 30px;">
				<td style="background-color: #ffffff;width:10%" align="left">
					<input  type="checkbox" value="yjsdj" name="checkbox1" class="part1"/>原技术等级</td>
				<td style="background-color: #ffffff;width:10%" align="left">
			...
			<tr  style="height: 30px;">
				<td style="background-color: #ffffff;width:10%" align="left">
					<input  type="checkbox" value="jhnf" name="checkbox1" class="part1"/>项目年份</td>
				<td style="background-color: #ffffff;width:10%" align="left">
