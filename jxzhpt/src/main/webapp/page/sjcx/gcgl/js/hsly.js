...
function xghslyyb(){
	...
	+"&gcglhsly.qksm="+$("#xg_qksm").val()+"&gcglhsly.bfzj="+$("#xg_bfzj").val()+"&gcglhsly.sbyf="+$("#xg_sbyf").find("option:selected").text()
...
function showAll(){
	...
	var ybzt=$("#ybzt").val();
	$('#datagrid').datagrid({    
	    url:'/jxzhpt/gcgl/selectHslyjhList.do',
	    striped:true,
	    pagination:true,
	    rownumbers:true,
	    pageNumber:1,
...
function showYBlist(){
	...
	$('#ybgrid').datagrid({    
	    url:'/jxzhpt/gcgl/selecthslyYbByJhid.do',
	    striped:true,
	    pagination:true,
	    rownumbers:true,
	    pageNumber:1,
