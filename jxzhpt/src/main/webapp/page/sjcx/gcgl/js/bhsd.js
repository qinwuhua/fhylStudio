...
function xgwqgzyb(){
	...
	+"&gcglbhsd.jhid="+parent.obj.jhid+"&gcglbhsd.id="+parent.obj.id+"&gcglbhsd.sbyf="+$("#xg_sbyf").val()+"&gcglbhsd.sbsj="+$("#xg_sbsj").html();
...
//	var jgzt='0';
	...
	$('#datagrid').datagrid({    
	    url:'/jxzhpt/gcgl/selectBhsdjhList.do',
	    striped:true,
	    pagination:true,
	    rownumbers:true,
	    pageNumber:1,
...
function showYBlist(){
	...
	$('#ybgrid').datagrid({    
	    url:'/jxzhpt/gcgl/selectBhsdYbByJhid.do',
	    striped:true,
	    pagination:true,
	    rownumbers:true,
	    pageNumber:1,
...
function sbsjyb(index){
	...
	var data='';
	if(yhjb.length==6){
		data="gcglbhsd.id="+data1.id+"&gcglbhsd.sfsj=4"+"&gcglbhsd.yhtype=6"+"&gcglbhsd.jhid="+data1.jhid+
		"&gcglbhsd.yb_thyj="+"";
	}
	if(yhjb.length==4){
		data="gcglbhsd.id="+data1.id+"&gcglbhsd.sfsj=2"+"&gcglbhsd.yhtype=4"+"&gcglbhsd.jhid="+data1.jhid+
		"&gcglbhsd.yb_thyj="+"";
	}
	if(confirm("确认上报吗？")){
		$.ajax({
