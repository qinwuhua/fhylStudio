...
function gclmsjxm(jh,lx){
	...
	var grid={id:'grdab',url:'../../../jhgl/queryGcsjList.do',pagination:true,queryParams:params,
		rownumbers:false,pageNumber:1,pageSize:10,height:$(window).height()-185,width:$('#searchField').width(),
		columns:[[
		    ...
		    {field:'pftz',title:'批复总投资',width:90,align:'center'},
		    {field:'jhsybbzje',title:'部补助资金',width:90,align:'center'},
		    {field:'jhsydfzczj',title:'省补助金额资金',width:90,align:'center'}
	    ]],
	    view: detailview,
...
function gclmsjxm_zjxd(jh,lx){
	...
	var grid={id:'grdab',url:'../../../jhgl/queryGcsjList.do',striped:true,pagination:true,
		...
		columns:[[
			...
			{field:'c1',title:'资金下达',width:80,align:'center',formatter:function(value,row,index){
				return '<a href="javascript:openDialog('+"'zjxd_gclmsj','工程改造路面升级项目资金下达','../zjxd/gclmsj.jsp'"+')" style="text-decoration:none;color:#3399CC;">资金下达</a>';
			}},
