...
<table style="width: 98%; margin-top: 15px;margin-left: 10px; background-color: #aacbf8; font-size: 12px"
			...
			<tr>
				<td style="background-color: #ffffff; height: 30px;width:15%" align="right">路线编码：</td>
				<td style="background-color: #ffffff; height: 30px;" align="left">
					<span id="lxbm" style="font-size: 13px"></span></td>
				<td style="background-color: #ffffff; height: 30px;" align="right">路线名称：</td>
				<td style="background-color: #ffffff; height: 30px;width:15%" align="left">
					<span id="lxmc"></span></td>
					<td style="background-color: #ffffff; height: 30px;width:15%" align="right">管养单位：</td>
				<td style="background-color: #ffffff; height: 30px;" align="left">
			...
			<tr>
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<span id="qzlc" style="font-size: 13px"></span></td>
			</tr>
			<tr>
				<td style="background-color: #ffffff; height: 30px;width:15%" align="right">行政区划代码：</td>
				<td style="background-color: #ffffff; height: 30px;" align="left">
					<span id="xzqhdm" style="font-size: 14px"></span></td>
				<td style="background-color: #ffffff; height: 30px;" align="right">行政区划名称：</td>
				<td style="background-color: #ffffff; height: 30px;width:15%" align="left">
					<span id="xzqhmc"></span></td>
					<td style="background-color: #ffffff; height: 30px;width:15%" align="right">修建/改建年度：</td>
				<td style="background-color: #ffffff; height: 30px;" align="left">
			...
			<tr>
				<td style="background-color: #ffffff; height: 30px;width:15%" align="right">项目年份：</td>
				<td style="background-color: #ffffff; height: 30px;" align="left">
					<span id="xmnf" style="font-size: 13px"></span></td>
				<td style="background-color: #ffffff; height: 30px;" align="right">项目状态：</td>
				<td style="background-color: #ffffff; height: 30px;width:15%" align="left">
