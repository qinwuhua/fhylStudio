					...
					<p style="margin:8px 0px 4px 20px;">
                        ...
                        <p style="margin:8px 0px 4px 20px;">
                             ...
                             <p style="margin:8px 0px 4px 20px;">
								...
								<img name="btnDCMB" id="btnDCMB" onmouseover="this.src='../../../images/Button/DC2.gif'" alt="导出模版" onmouseout="this.src='../../../images/Button/DC1.gif'" src="../../../images/Button/DC1.gif" onclick="exportWqgzModule('危桥改造模板')" style="border-width:0px;cursor: hand;" />
								<img name="insertData"id="insertData" alt="导入数据" src="../../../images/Button/dreclLeave.GIF" onmouseover="this.src='../../../images/Button/dreclClick.GIF'" onmouseout="this.src='../../../images/Button/dreclLeave.GIF'" onclick="importWqgz();" style="border-width:0px;" />
                                ...
                                <img name="btnExcel" id="btnExcel" onmouseover="this.src='../../../images/Button/dcecl2.gif'" alt="导出Excel" onmouseout="this.src='../../../images/Button/dcecl1.gif'" src="../../../images/Button/dcecl1.gif" onclick="javascript:exportExcel_wqgz();" style="border-width:0px;cursor: hand;" />
                             </p>
					</div>
				</fieldset>
			</td>
