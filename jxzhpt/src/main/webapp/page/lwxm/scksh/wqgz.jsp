	...
	<table align="left" width="100%" cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td align="left" style="padding-left:10px; padding-right:25px;">
				<fieldset style="width:1600px;text-align:left;vertical-align:middle;">
						...
						<tbody>
							<tr>
                              ...
                              <td align="left" colspan="3"  style="width:250px">
                              	<select id="cc" class="easyui-combobox" style="width:250px">
                              		<option>===请选择===</option>
                              		<option>嘿嘿</option>
                              	</select>
                              </td>
                              ...
                              <td align="left" colspan="3" style="width: 250px;">
                              	<select id="ss" class="easyui-combobox" style="width:250px">
                              		<option>===请选择===</option>
                              		<option>嘿嘿</option>
                              	</select>
                              </td>
                              ...
                              <td align="right" width="80px" >桥梁名称：
                              </td>
                              <td align="left"  style="width: 160px;">
                              	<input type="text" style="width:140px"/>
                              </td>
                              <td rowspan="2" align="left"  style="width:400px">
                             ...
                             <tr>
                              ...
                              <td align="left" style="width: 160px;">
                              	<select id="ss5" class="easyui-combobox" style="width:144px">
                              		<option selected="selected" value="">全部</option>
                              	...
                              	<td align="right" width="80px" >按跨径分类：</td>
                              	<td align="left" style="width: 160px;">
                              	<select id="ss6" class="easyui-combobox" style="width:144px">
                              		<option selected="selected" value="">全部</option>
