...
<body id="index_layout" class="easyui-layout">
    <div data-options="region:'west',split:true, iconCls: 'icon-west'" style="width:205px;overflow:hidden">
		<div id="aa" fit="true" class="easyui-accordion" style="width:205px;">  
		    <div id="left_menu1" title="项目基础库管理" data-options="iconCls:'icon-note',selected:true" style="overflow:auto;display:block;">
		    
		    </div>
		    <div id="left_menu2" title="项目基础库审核" data-options="iconCls:'icon-note'" style="overflow:auto;">
	
		    </div>
		     <div id="left_menu3" title="项目审查库管理" data-options="iconCls:'icon-note'" style="overflow:auto;">
	
		    </div>
		     <div id="left_menu4" title="项目审查库审核" data-options="iconCls:'icon-note'" style="overflow:auto;">
