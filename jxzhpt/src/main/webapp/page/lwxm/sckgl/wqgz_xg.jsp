...
function loadxx(){
	...
	getBmbm('上部结构形式','sck_sbjgxs',item.sck_sbjgxs);
	getBmbm('通航等级','scthdj',item.scthdj);
	getBmbm('荷载等级','hzdj',item.hzdj);
	getBmbm('行政等级','ydgldj',item.ydgldj);
// 	$("#sck_sbjgxs").val(item.sck_sbjgxs);
// 	$("#scthdj").val(item.scthdj);
// 	$("#hzdj").val(item.hzdj);
// 	$("#ydgldj").val(item.ydgldj);
	//$("#kjzh").val(item.kjzh);
...
function saveWqgz(){
	...
	+"&jckwqgzsj.sjsd="+$("#sjsd").val()+"&jckwqgzsj.scsqs="+$("#scsqs").val()+"&jckwqgzsj.scxsq="+$("#scxsq").val()+"&jckwqgzsj.scszxz="+$("#scszxz").val()+"&jckwqgzsj.sfylrbwqk="+$("#sfylrbwqk").html();
	$.ajax({
		type:'post',
...
<table style="width: 98%; margin-top: 15px;margin-left: 10px; background-color: #aacbf8; font-size: 12px"
			...
			<tr style="height: 30px;">
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
<!-- 					<input type="text" id="hzdj" style="width: 150px" /> -->
			...
			<tr style="height: 30px;">
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
<!-- 					<input type="text"  id="kjzh" style="width: 150px" /> -->
...
<!-- 					<input type="text" id="scthdj" style="width: 150px" /> -->
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
<!-- 					<input type="text" id="ydgldj" style="width: 150px" /> -->
			...
			<tr style="height: 30px;">
				...
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">拟申请部补助<br>资金（万元）：</td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" id="nsqbbz" style="width: 150px" onblur="checksfzq()"/>&nbsp;&nbsp;<span style="color: red" id='trzjdx'></span></td>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">拟申请省补助<br>资金（万元）：</td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" id="nsqsbz" style="width: 150px" />
				</td>
			</tr>
			<tr style="height: 30px;">
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">设区市：</td>
