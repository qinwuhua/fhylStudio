...
<body>
	<table align="left" width="100%" cellpadding="0" cellspacing="0" border="0">
		<tr>
			...
			<font color="#5C5C5C" style="font-size: small">灾害防治项目管理</font></td>
		</tr>
		<tr>
			<td align="left" style="padding-left:10px; padding-right:25px;">
				...
				<font style="color: #0866A0; font-weight: bold">项目信息：</font>
					...
					<table width="100%" cellpadding="2" cellspacing="0" border="0" style="padding-left: 20px">
						<tbody>
							<tr>
							  <td align="right" width="8%" >管养单位：
                              </td>
                              <td align="left" colspan="3" >
                              	<select id="cc" style="width:246px">
                              	</select>
                              </td>
                              <td align="right" width="8%" >行政区划：
                              </td>
                              <td align="left" colspan="3" >
                              	<select id="ss" style="width:246px">
                              	</select>
                              </td>
                               <td align="right" width="8%" >路线名称：
                              </td>
                             ...
                             <tr>
							  <td align="right" width="8%" >项目年份：</td>
                              <td align="left" >
                              ...
                              <td align="right" width="8%" >项目状态： </td>
                              <td align="left" >
                              ...
                              <td align="right" width="8%" >审查状态：</td>
                              <td align="left" >
                              ...
                              <td align="right" width="8%" >技术等级：</td>
                              <td align="left" >
                              	...
                              	<td align="right" width="8%" >公路等级：</td>
                              	<td align="left" >
                             ...
                             <tr>
                                ...
                                <input type="image" name="addOne" id="addOne" src="../../../images/Button/tianj1.gif" onmouseover="this.src='../../../images/Button/tianj2.gif'" onmouseout="this.src='../../../images/Button/tianj1.gif'   " src="" onclick="addSck('zhfz_add.jsp','900','500');" style="border-width:0px;" />
