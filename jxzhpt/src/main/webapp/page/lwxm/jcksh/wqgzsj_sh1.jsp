...
<script type="text/javascript">
	function shty(){
		...
		$.ajax({
			 type : "POST",
			 url : "/jxzhpt/wqgzsj/sjshtyWqgzsjByIdbeatch.do",
			 dataType : 'json',
			 data : 'jckwqgzsj.id=' +parent.ob.id+"&jckwqgzsj.shbm="+$.cookie("unit")+"&jckwqgzsj.sbthcd="+($.cookie("unit2").length),
	...
	function shbty(){
		...
		$.ajax({
			 type : "POST",
			 url : "/jxzhpt/wqgzsj/sjshbtyWqgzsjByIdbeatch.do",
			 dataType : 'json',
			 data : 'jckwqgzsj.id=' +parent.ob.id+"&jckwqgzsj.shbm="+$.cookie("unit")+"&jckwqgzsj.sbthcd1="+sbthcd+"&jckwqgzsj.shyj2="+$("#shyj2").val(),
			 success : function(msg){
				 if(msg){
					 alert('审核成功！');
					 parent.$("#grid").datagrid('reload');
