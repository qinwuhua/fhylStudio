...
<script type="text/javascript">
	function shty(){
		$.ajax({
			 type : "POST",
			 url : "/jxzhpt/aqsmfh/afXmkZs.do",
			 dataType : 'json',
			 data : 'xmkaqsmfh.id=' +parent.obj.id+"&xmkaqsmfh.zszt=已审核"+"&xmkaqsmfh.sbthcd="+($.cookie("unit2").length)+"&xmkaqsmfh.cszt=已审核"
			 +"&xmkaqsmfh.zsyj=同意",
	...
	function shbty(){
		...
		$.ajax({
			 ...
			 url : "/jxzhpt/aqsmfh/afXmkZs.do",
			 dataType : 'json',
			 data : 'xmkaqsmfh.id=' +parent.obj.id+"&xmkaqsmfh.zszt=未审核"+"&xmkaqsmfh.sbthcd="+sbthcd+"&xmkaqsmfh.cszt=未审核"
