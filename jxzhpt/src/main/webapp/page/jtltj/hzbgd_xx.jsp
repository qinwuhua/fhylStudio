...
<body style="margin: 0px; overflow: auto;">
	<script type="text/javascript">
		...
		var data="id"+id;
		$.ajax({
			url:"/jxzhpt/wjxt/getJtlgdDataList.do?id="+id,
			data:data,
			type:"post",
			dataType:"JSON",
		...
		$.ajax({
			url:"/jxzhpt/wjxt/getJtlgdDataList1.do?id="+id,
			data:data,
			type:"post",
			dataType:"JSON",
			success:function(msg){
                            ...
                            <td>
                                <table cellpadding="0" cellspacing="0" style="width: 99.8%;">
                                    ...
                                    <tr style="vertical-align: bottom;">
                                        ...
                                        <td align="center" style="font-size: 12px;">
                                            <div id="divReport" style="text-align: left; width: 200px;">表    号：交调统2表<br/>制表机关：交通运输部<br/>备案机关：国家统计局<br/>备案文号：国统办函〔2011〕167号<br/>有效期限：2014年11月</div>
                                        </td>
                                    </tr>
                                </table>
                            </td>
