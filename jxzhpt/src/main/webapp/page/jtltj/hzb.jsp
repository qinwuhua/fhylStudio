...
function Deletemxb(_id){
	var data="jtlhz.id="+_id;
	if(!confirm("确认删除吗？")){
		return;
	}
	$.ajax({
		type:'post',
		url:'/jxzhpt/wjxt/deletejtl.do',
		data:data,
		dataType:'json',
...
function download(id){
	window.location.href="/jxzhpt/wjxt/downjtqkhzbFile.do?id="+id
}
function dcmb(){
	window.location.href="/jxzhpt/xtgl/getModule_jhfeiLw.do?moduleName=jtqkhzb";
}
</script>
<div style="width:100%;">
    <div  style="height:84px;" border="false">
	    <div id="righttop">
			<div id="p_top">当前位置>&nbsp;交通量统计>&nbsp;交通情况汇总表</div>
		</div>
