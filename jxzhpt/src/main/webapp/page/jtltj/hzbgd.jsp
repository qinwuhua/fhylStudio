...
function Deletemxb(_id){
	...
	$.ajax({
		type:'post',
		url:'/jxzhpt/wjxt/deletejtlgd.do',
		data:data,
		dataType:'json',
...
function download(id){
	window.location.href="/jxzhpt/wjxt/downjtqkhzbgdFile.do?id="+id
}
function dcmb(){
	window.location.href="/jxzhpt/xtgl/getModule_jhfeiLw.do?moduleName=jtqkhzbgd";
}
</script>
<div style="width:100%;">
    <div  style="height:84px;" border="false">
	    <div id="righttop">
			<div id="p_top">当前位置>&nbsp;交通量统计>&nbsp;交通情况汇总表(国道)</div>
		</div>
			...
			<fieldset style="width:99%; text-align: left; vertical-align: middle;border:1px solid #cde0f3;">
 				...
 				<div>
 					<p style="margin: 5px;">
	 					...
	 					<a id="yhgl_btn_add" href="javascript:void(0)" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="inserttgdData('hzbgd')">导入数据</a>
