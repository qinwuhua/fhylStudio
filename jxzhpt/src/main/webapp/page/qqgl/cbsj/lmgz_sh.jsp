			        		...
			        		if(row.sbzt=='1' || row.shzt=='1'){
			        			result+='&nbsp;编辑&nbsp;添加路线&nbsp;变更';
			        			 ...
			        			 result+='&nbsp;<a href="javascript:openWindow1('+"'lmgzedit'"+','+"'路面改造工程项目'"+','+
									"'/jxzhpt/page/qqgl/cbsj/lmgz_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAdd2('+"'lmgz','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','lmgz'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
			        		}
			        	}else{
							 result+='&nbsp;<a href="javascript:openWindow1('+"'lmgzedit'"+','+"'路面改造工程项目'"+','+
								"'/jxzhpt/page/qqgl/cbsj/lmgz_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAdd2('+"'lmgz','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','lmgz'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
