			...
			grid.columns=[[
				...
				{field:'cz',title:'操作',width:240,align:'center',
					formatter: function(value,row,index){
						...
						result+='&nbsp;<a href="javascript:openWindow1('+"'lmgzxx'"+','+"'路面改造工程项目'"+','+
						"'/jxzhpt/page/qqgl/cbsj/lmgz_xx.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">详细</a>';
			        	if($.cookie("unit2").length!=7){
			        		if(row.sbzt=='1' || row.shzt=='1'){
			        			result+='&nbsp;编辑&nbsp;'+'&nbsp;<a style="text-decoration:none;color:#3399CC;" href="#" onclick="approvalDocuments('+index+')">批复文件</a>'+'添加路线&nbsp;变更';
			        		}else{
			        			 result+='&nbsp;<a href="javascript:openWindow1('+"'lmgzedit'"+','+"'路面改造工程项目'"+','+
									"'/jxzhpt/page/qqgl/cbsj/lmgz_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAdd2('+"'lmgz','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>'+'&nbsp;<a style="text-decoration:none;color:#3399CC;" href="#" onclick="approvalDocuments('+index+')">批复文件</a>'+'&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','lmgz'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
			        		}
			        	}else{
							 result+='&nbsp;<a href="javascript:openWindow1('+"'lmgzedit'"+','+"'路面改造工程项目'"+','+
								"'/jxzhpt/page/qqgl/cbsj/lmgz_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAdd2('+"'lmgz','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>'+'&nbsp;<a style="text-decoration:none;color:#3399CC;" href="#" onclick="approvalDocuments('+index+')">批复文件</a>'+'&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','lmgz'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
				...
				{field:'dc_lc',title:'垫层（公里）',width:100,align:'center'},
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;工程初步设计>&nbsp;<span id="bstext"></span>>&nbsp;路面改造工程项目</div>
	</div>
		<table width="99%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
        	...
        	<tr>
            	<td style="padding-left: 10px;font-size:12px;">
            		...
            		其中建安费【<span id="jaf" style="color: red;">0</span>】万元。
            		...
            		建安费【<span id="jaf" style="color: red;">0</span>】万元。 -->
            		</div>
            		<div>
            			<table id="grid"></table>
            		</div>
