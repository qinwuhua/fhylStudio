        				...
        				<div>
        					<table style="margin:7px; vertical-align:middle;" cellspacing="0" class="abgc_td" >
								<tr height="32">
									...
									<td><select name="xmlx" id="xmlx" style="width:70px;" ></select></td>
	        					...
	        					<td align="right">行政等级：</td>
	        						...
	        						<td ><input name="txtlxbm" type="text" id="txtlxbm" style="width:70px;" /></td>
	        						<td align="right">原路线名称：</td>
	        						<td><input name="txtlxmc" type="text" id="txtlxmc" style="width:70px;" /></td>
									<td align="right">规划路线编码：</td>
	        						<td><input type="text" id="ghlxbm" style="width:55px;" /></td>
								...
								<td>
									<select id='lsxmlx' class="easyui-combobox" style="width: 160px;">
									</select>
								</td>
