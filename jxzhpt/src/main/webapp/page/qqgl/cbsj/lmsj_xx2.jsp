	...
	<script type="text/javascript">
		$(function(){
			$.ajax({
				...
				data:'jhsh.xmlx='+1+'&jhsh.xmbm='+parent.xmbm,
				dataType:'json',
			...
			$.ajax({
				...
				data:'xmlx='+1+'&xmbm='+parent.xmbm,
				dataType:'json',
				success:function(data){
					$('#kxxyj').form("load",data);
					fileShow1('gkpfTable',parent.xmbm,"工可批复文件");
				}
			});
			$.ajax({
				type:'post',
				url:'../../../qqgl/queryCbsjbgByXmbm.do',
				data:'cbsj.xmlx='+1+'&cbsj.xmbm='+parent.xmbm,
				dataType:'json',
				success:function(data){
					$('#cbsj').form("load",data);
					$("#tzsj").html(data.tzsj);
					...
					fileShow1('sjpfTable',parent.xmbm,"设计批复文件");
				}
			});
			$.ajax({
				type:'post',
		...
		<form id="lxsh">
			...
			<tr style="height: 35px;">
				...
				<td colspan="5" style="background-color: #ffffff; height: 20px;width:18%" align="left">
					...
					现状总里程：<input id="lc" name="lc" style="width: 50px;" type="text"/>
				</td>
			</tr>
			<tr style="height: 35px;">
				<td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0; color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF; width: 15%; padding-right: 5px;">
				...
				<td colspan="5" style="background-color: #ffffff; height: 20px;width:18%" align="left">
					...
					建设总里程：<input id="jszlc" name="jszlc" style="width: 50px;" type="text"/>
				</td>
			</tr>
			<tr style="height: 35px;">
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">
