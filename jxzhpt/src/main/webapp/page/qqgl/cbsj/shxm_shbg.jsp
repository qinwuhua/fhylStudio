...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function ckxx(str1,str2){
		if(str2=='qx'){
			xmbm=str1;
			YMLib.UI.createWindow('wq_tz','项目详情',"shxm_xx1.jsp",'wq_tz',980,400);
		}else{
			xmbm=str1;
			YMLib.UI.createWindow('wq_tz','项目详情',"shxm_xx2.jsp",'wq_tz',980,400);
		}
	}
	function tz(id,lx){
		xmbm=id;
		...
		function queryShxm(){
			...
			var params={'cbsj.xmlx':5,'cbsj.xzqhdm':getxzqhdm('xzqh'),'cbsj.ghlxbh':$('#txtlxbm').val(),'cbsj.xmmc':$('#xmmc').val(),"cbsj.jdbs":2,
				...
				{field:'cz',title:'操作',width:150,align:'center',
					formatter: function(value,row,index){
						...
						if(row.tzxz=='取消'){
							...
							result+='&nbsp;编辑&nbsp;<a href="javascript:thtz('+"'"+row.xmbm+"','sh','2'"+')" style="text-decoration:none;color:#3399CC; ">退回</a>';
						}
						else{
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;初步设计或施工图设计>&nbsp;灾毁重建变更</div>
	</div>
