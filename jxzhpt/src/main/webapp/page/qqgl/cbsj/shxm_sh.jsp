					...
					formatter: function(value,row,index){
						...
						//if(row.shzt==0){
							...
							result+='&nbsp;<a href="javascript:openWindow('+"'shxmedit'"+','+"'水毁项目'"+','+
								"'/jxzhpt/page/qqgl/cbsj/shxm_edit.jsp'"+',980,400)" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','sh'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
						//}else{
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;初步设计或施工图设计申请>&nbsp;灾毁重建</div>
	</div>
