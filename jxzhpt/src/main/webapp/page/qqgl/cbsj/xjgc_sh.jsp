	...
	function tz(id,lx){
		...
		$(function(){
			 if(getQxfromSession('rolename')!="省局综规处"){
				window.location.href='/jxzhpt/page/qqgl/cbsj/xjgc_sh2.jsp?&id='+getUrlParame('id');
			}; 
					...
					formatter: function(value,row,index){
						...
						if($.cookie("unit2").length!=7){
			        		if(row.sbzt=='1' || row.shzt=='1'){
								...
								"'/jxzhpt/page/qqgl/cbsj/xjgc_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAdd2('+"'xjgc','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>'+'&nbsp;<a style="text-decoration:none;color:#3399CC;" href="#" onclick="approvalDocuments('+index+')">批复文件</a>'+'&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','xj'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
			        		}
			        	}else{
			        		result+='&nbsp;<a href="javascript:openWindow1('+"'xjgcedit'"+','+"'新建工程项目'"+','+
							"'/jxzhpt/page/qqgl/cbsj/xjgc_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAdd2('+"'xjgc','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>'+'&nbsp;<a style="text-decoration:none;color:#3399CC;" href="#" onclick="approvalDocuments('+index+')">批复文件</a>'+'&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','xj'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
