...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	function tz(id,lx){
				...
				{field:'cz',title:'操作',width:200,align:'center',
					formatter: function(value,row,index){
						...
						//if(row.shzt==0){
							...
							result+='&nbsp;<a href="javascript:openWindow1('+"'yhdzxedit'"+','+"'养护大中修项目'"+','+
								"'/jxzhpt/page/qqgl/cbsj/yhdzx_edit.jsp'"+",900,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">编辑</a>&nbsp;<a href="javascript:openLxAddyh('+"'yhdzx','"+row.xmbm+"','"+YMLib.Var.jdbs+"'"+')" style="color:#3399CC;">添加路线</a>&nbsp;<a href="javascript:tz('+"'"+row.xmbm+"','yh'"+')" style="text-decoration:none;color:#3399CC; ">变更</a>';
						//}else{
		...
		function exportCbsj(){
			...
			var param='xmlx=4&shzt='+$('#shzt').combo("getValue")+'&xzqhdm='+getxzqhdm('xzqh')+'&xmbm='+xmnf+
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;施工图设计>&nbsp;<span id="bstext"></span>>&nbsp;养护大中修项目</div>
	</div>
        		...
        		<td align="left" style="padding-left:10px;padding-right: 10px; padding-top: 10px;">
					...
					<tr height="32">
							...
							<td align="right">是否有补助历史：</td>
								...
								<td>
									<select id='lsxmlx' class="easyui-combobox" style="width: 55px;">
									</select>
								</td>
