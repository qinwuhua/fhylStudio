        	...
        	<tr>
        		<td align="left" style="padding-left: 10px; padding-top: 5px;">
        			...
        			<tr>
        						...
        						<td id='zt'><select id="sbzt" style="width:118px;" class="easyui-combobox">
									<option selected="selected" value="">全部</option>
								...
								<td>
									<select id='xmklx' class="easyui-combobox" style="width: 65px;" data-options="editable:false,panelHeight:'auto'">
