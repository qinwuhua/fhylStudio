...
<script type="text/javascript">
	...
	function saveLxsh(){
		...
		+"&lxsh.tz="+$("#tz").val()+"&lxsh.bzys="+$("#bzcs").html()+"&lxsh.dfzc="+$("#dfzc").html();
		//alert(data);
		$.ajax({
			type:'post',
