...
function showAlllmsh123(){
	...
	$('#datagrid').datagrid({    
	    ...
	    queryParams: {
			...
			ghlxmc:$("#ghlxmc").val(),
			jsjsdj:jsjsdj,
			gldj:gldj,ghlxbh:$("#lxbm").val().toUpperCase(),lxmc:$("#lxmc").val()
		},
	    columns:[[
	        {field:'allSel',title:'全选',width:60,align:'center',checkbox:'true'},
	        /*{field:'c',title:'操作',width:150,align:'center',formatter:function(value,row,index){	        	
...
//	        }},
		    ...
		    {field : 'gydw',title : '管养单位',width : 180,align : 'center'},
		    {field : 'xzqh',title : '行政区划',width : 180,align : 'center'},
		    {field : 'ghlxbh',title : '规划路线编码',width : 180,align : 'center'},
		    {field : 'minqdzh',title : '规划起点桩号',width : 100,align : 'center'},
		    {field : 'maxzdzh',title : '规划止点桩号',width : 100,align : 'center'},
		    {field:'qdmc',title:'起点名称',width:150,align:'center'},
		    {field:'zdmc',title:'止点名称',width:150,align:'center'},
