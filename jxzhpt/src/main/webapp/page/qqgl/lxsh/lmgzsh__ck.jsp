...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			xmnfdx("xmnf"); 
			//showAlllmsh123();
			setTimeout("showAlllmsh123()",'1700');
		});
...
<!--         						<td colspan="3" style="width:220px;"><select id="gydw" style="width:215px;"></select></td> -->
                              <td colspan="10">
        						<img onclick="showAlllmsh123()" alt="搜索" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/Serch01.gif'" style="vertical-align:middle;"/>
				              </td>
                            </tr></table>
        				</div>
        			</fieldset>
