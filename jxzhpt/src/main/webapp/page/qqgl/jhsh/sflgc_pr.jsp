...
function querySflgcYap(){
	
	grid.id="grid";
	grid.url="../../../qqgl/querySflgcYap.do";
...
//	 						+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
							...
							if($.cookie('unit2').length!=7){
								...
								if(row.xdzt=='1')
									...
									"'/jxzhpt/page/qqgl/jhsh/sflgc_xmth.jsp'"+",900,400,'"+row.id+"'"+')" style="color:#3399CC;">退回</a>'; 
							return result;
						}
					},					
					{field:'xdzt',title:'审核状态',width:60,align:'center',
						formatter: function(value,row,index){
							...
							if(row.xdzt=='0')
						 	...
						 	if(row.xdzt=='1')
								result='<a href="javascript:changeXdzt('+index+')" style="color:#3399CC;">已审核</a>';
