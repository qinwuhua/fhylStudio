			...
			grid.columns=[[
				...
				{rowspan:2,field:'cz',title:'操作',width:100,align:'center',
					formatter: function(value,row,index){
						...
						result+='&nbsp;<a href="javascript:openWindow('+"'yhdzxxx'"+','+"'养护中心详情'"+','+
						"'/jxzhpt/page/qqgl/jhsh/yhzx_jhxx.jsp'"+',980,400)" style="color:#3399CC;">详细</a>';
						return result;
					}
				},
				{rowspan:2,field:'xdzt',title:'计划审核',width:100,align:'center',
					formatter:function(value,row,index){
						xmlx=6;
						var result='<a href="javascript:openJhxd1('+"'jhxdYhzx.jsp',"+index+')" style="color:#3399CC;">计划审核</a>';
						return result;
					}
				},
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;<span id="astext">计划库</span>>&nbsp;<span id="bstext"></span>>&nbsp;养护中心项目</div>
	</div>
