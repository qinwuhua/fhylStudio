...
<script type="text/javascript">
	$(function(){
		...
		//var data=parent.YMLib.Var.xmbm;
		
		 $.post('/jxzhpt/qqgl/getWninfobyid.do',{xmbm:parent.YMLib.Var.xmbm,xmlx:'改建'},
					function(data){
	...
	function sfylx(){
		var data="lxsh.xmbm="+parent.YMLib.Var.xmbm;
		$.ajax({
			type:'post',
	...
	function setlx(){
		$('#table_lx').datagrid({
    		url:'/jxzhpt/qqgl/selectwnSjlxList.do',
    		 queryParams: {
    			 	jdbs:0,
    			 	'lxsh.xmbm':parent.YMLib.Var.xmbm
    			},
			columns:[[
