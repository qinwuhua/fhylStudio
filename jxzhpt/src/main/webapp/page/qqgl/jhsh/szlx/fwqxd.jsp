...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		$(function(){
			...
			if(getUrlParame('id')=='010113030207')
			xmnfs3w("scxdnf",'无');
			else
			xmnfs2w("scxdnf",'无');
			...
			$('#grid').datagrid({    
		    	...
		    	{field:'CZ',title:'操作',width:100,align:'center',
					formatter: function(value,row,index){
						var result="";
						result='<a href="javascript:szxmXdInfo('+"'"+index+"','fwq'"+')" style="color:#3399CC;">详情&nbsp;&nbsp;</a>';
						return result;
						}
				},
		...
		function showMxbAll(){
			...
			$('#jhbz').datagrid({    
				...
				{field:'BZCGS',title:'车购税',width:100,align:'center',editor:{type:'text',options:{required:false}}},
...
<%-- 									<img onclick="exportZjxd()" id="btnShangbao" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/dcecl2.gif'" alt="上报" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/dcecl1.gif'" src="${pageContext.request.contextPath}/images/Button/dcecl1.gif" style="border-width:0px;cursor: hand;vertical-align:middle;"/> --%>
        	...
        	<tr>
            	<td style="padding-left: 10px;padding-top:5px; font-size:12px;">
            		...
            		其中：车购税【<span id="xdcgs" style="color: red;">0</span>】万元,
