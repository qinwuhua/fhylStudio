...
$(function(){
	...
	if(getUrlParame('id')=='010113020206')
	xmnfs3w("xmnf");
	else
	xmnfs2w("xmnf");
...
function querySflgc(){
	...
	grid.columns=[[	{field:'ck',checkbox:true},
					...
					formatter: function(value,row,index){
						...
						if(row.SHZT=='0')
							result+='<a href="javascript:thxjSzxm('+"'"+index+"','yhzx'"+')" style="color:#3399CC;">退回下级&nbsp;&nbsp;</a>'+'退回未审核';	
						else
							result+='退回下级&nbsp;&nbsp;'+'<a href="javascript:thwshSzxm('+"'"+index+"','yhzx'"+')" style="color:#3399CC;">退回未审核</a>';
							return result;
						}
					},
					{field:'shzt',title:'审核状态',width:60,align:'center',
						formatter: function(value,row,index){
							...
							if(row.SHZT=='1')
								...
								result='<a href="javascript:shSzxm('+"'"+index+"','yhzx'"+')" style="color:#3399CC;">未审核</a>';
							return result;
							}
						},
...
<body>
	<div id="righttop">
		<div id="p_top">
			计划管理>&nbsp;<span id="astext">计划预安排</span>>&nbsp;养护中心
		</div>
	</div>
						...
						<table style="margin: 5px; vertical-align: middle;"
							...
							<tr height="32">
								...
								<td colspan="8"><img onclick="querySflgc()" alt="搜索"
									...
									<img id="shenpi" alt="审批" onclick="shSzxm('无','yhzx')" style="border-width:0px;cursor: hand;vertical-align:middle;" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/sp2.jpg'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/sp1.jpg'" src="${pageContext.request.contextPath}/images/Button/sp1.jpg"/>
									<img id="thxj"  alt="退回下级" onclick="thxjSzxm('无','yhzx');" src="${pageContext.request.contextPath}/images/thxj1.jpg" onmouseover="this.src='${pageContext.request.contextPath}/images/thxj2.jpg'" onmouseout="this.src='${pageContext.request.contextPath}/images/thxj1.jpg'   " src=""   style="border-width:0px;vertical-align:middle;" />
									<img id="thwsh" alt="退回未审核" onclick="thwshSzxm('无','yhzx')" style="vertical-align:middle;" src="${pageContext.request.contextPath}/images/thwsh1.jpg" onmouseover="this.src='${pageContext.request.contextPath}/images/thwsh2.jpg'" onmouseout="this.src='${pageContext.request.contextPath}/images/thwsh1.jpg'"/>
