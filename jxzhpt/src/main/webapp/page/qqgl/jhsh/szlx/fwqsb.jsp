...
$(function(){
	...
	if(getUrlParame('id')=='010113010207')
	xmnfs3w("xmnf");
	else
	xmnfs2w("xmnf");
	...
	grid.columns=[[	{field:'ck',checkbox:true},
					...
					formatter: function(value,row,index){
						...
						if(row.SBZT=='1')
							...
							result+='<a href="javascript:editSzxm('+"'"+index+"','fwq'"+')" style="color:#3399CC;">编辑&nbsp;&nbsp;</a>';
							return result;
						}
					},
					{field:'sbzt',title:'上报状态',width:60,align:'center',
						formatter: function(value,row,index){
							...
							if(row.SBZT=='1')
								...
								result='<a href="javascript:sbSzxm('+"'"+index+"','fwq'"+')" style="color:#3399CC;">未上报</a>';
							return result;
							}
						},
						...
						<table style="margin: 5px; vertical-align: middle;"
							...
							<tr height="32">
								...
								<td colspan="8"><img onclick="querySflgc()" alt="搜索"
									...
									<img id="sb" name="dishi" alt="上报" onclick="sbSzxm('无','fwq')" style="border-width:0px;cursor: hand;vertical-align:middle;" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/shangbao_2.png'" alt="上报" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/shangbao_1.png'" src="${pageContext.request.contextPath}/images/Button/shangbao_1.png"/>
