...
$(function() {
	...
	$.ajax({
		type : 'get',
		url : '../../../qqgl/queryYhzxshById.do',
		data : 'jhsh.id='+parent.YMLib.Var.xmid,
		dataType : 'json',
		success : function(data) {
			$('#yhzxshFrom').form("load", data);
			$("#ztz").numberbox('setValue',data.ztz);
			$("#jbzj").numberbox('setValue',data.jbzj);
...
function updateZhzxsh() {
	$('#yhzxshFrom').ajaxSubmit({
		dataType : 'json',
...
<body>
	<center>
		<table width="98%" height="60%" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td>
					<form id="yhzxshFrom" action="../../../qqgl/updateZhzxsh.do"
						method="post">
						...
						<table width="98%" border="0"
							...
							<tr style="height: 30px; font-size: 10px;">
								...
								<td
									...
									<b><font color="#009ACD"
										style="cursor: hand; font-size: 12px">奖补资金：</font></b>
								</td>
								<td
									...
									<input id="jbzj" name="jbzj" class="easyui-" type="text"
									value="0" style="width: 100px; height: 20px;" />万元
								</td>
							</tr>
							<tr style="height: 30px; font-size: 10px;">
						...
						<table width="98%" border="0"
							...
							<tr style="height: 30px;">
								<td align="center">
								<td align="center"><img onclick="updateZhzxsh()" alt="保存"
