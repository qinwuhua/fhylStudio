...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryXj(){
			...
			var params={'jhsh.xmlx':3,'jhsh.xzqhdm':getxzqhdm('xzqh'),'jhsh.ghlxbh':$('#txtlxbm').val(),'jhsh.xmmc':$('#txtxmmc').val(),
					'jhsh.tsdq':$('#tsdq').combo("getText"),'jhsh.xdzt':$('#xdzt').combobox("getValue"),'jhsh.xmbm':$('#xmnf').combobox("getValue"),
		...
		function exportJhshxx(){
			var param='jhsh.xmbm='+$('#xmnf').combobox("getValue")+'&jhsh.xmlx=3&jhsh.xdzt='+$('#xdzt').combobox("getValue")
