...
function queryYhzxshSb(){
	grid.id="grid";
	grid.url="../../../qqgl/queryYhzxshSb.do";
...
//	 						+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
					...
					{field:'sbzt',title:'上报状态',width:60,align:'center',
						formatter: function(value,row,index){
							...
							xmlx=4;
							if(row.sbzt=='0')
							result='<a href="javascript:sbById('+index+')" style="color:#3399CC;">未上报</a>';
							else
								result='已上报';
							return result;
						}
...
<body>
	<div id="righttop">
		<div id="p_top">
			计划管理>&nbsp;<span id="astext">计划申报</span>>&nbsp;综合养护中心
		</div>
	</div>
		...
		<tr>
			<td style="padding-left: 10px; padding-top: 3px; font-size: 12px;">
				<div>项目【<span id="xmsl" style="color: red;">0</span>】个,
            		...
            		奖补资金【<span id="jbzj" style="color: red;">0</span>】万元,
