...
function querySflgcXdXmlb(){
	...
	grid.url="../../../qqgl/queryYhzxshJhxd.do";
...
function querySflgcXdJhbz(){
	$('#gridSflgcJhbz').datagrid({    
		...
		{field:'stz',title:'省补助资金(万元)',width:60,align:'center'},
		{field:'zddzjl',title:'重点打造奖励(万元)',width:60,align:'center'},
