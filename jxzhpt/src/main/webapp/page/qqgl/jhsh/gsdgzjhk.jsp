				 ...
				 {field:'cz',title:'操作',width:100,align:'center',
					formatter: function(value,row,index){
						...
						result+='&nbsp;<a href="javascript:openWindow('+"'lmsjxx'"+','+"'国省道改造'"+','+
								"'/jxzhpt/page/qqgl/jhsh/lmsj_xx1.jsp'"+',980,400)" style="color:#3399CC;">详细</a>'
								//+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
								;
						if(row.xmbm.substr(10,1)=='2')
							result+='&nbsp;<a href="javascript:openWindow('+"'lmsjxx'"+','+"'国省道改造'"+','+
								"'/jxzhpt/page/qqgl/jhsh/lmgz_xx1.jsp'"+',980,400)" style="color:#3399CC;">详细</a>'
								//+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
								;
						if(row.xmbm.substr(10,1)=='3')
							result+='&nbsp;<a href="javascript:openWindow('+"'lmsjxx'"+','+"'国省道改造'"+','+
								"'/jxzhpt/page/qqgl/jhsh/xjgc_xx1.jsp'"+',980,400)" style="color:#3399CC;">详细</a>'
								//+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
								;
...
// 			 	{field:'gydw',title:'管养单位',width:100,align:'center'}, 
				...
				{field:'xmlx1',title:'建设性质',width:100,align:'center'},
				...
				{field:'scxdnf',title:'首次下达年份（或项目年份）',width:100,align:'center'},
...
// 				{field:'tsdq',title:'特殊地区',width:100,align:'center'},
		...
		function exportJhshxx(){
			...
			if(xmnf.substr(0,1)==',')
				xmnf=xmnf.substr(1,xmnf.length);
			var param='jhsh.xmbm='+$('#xmnf').combobox("getValues").join(',')+'&jhsh.xmlx1='+xmlx
				+'&jhsh.xzqhdm='+getxzqhdm('xzqh')+'&jhsh.ghlxbh='+$('#lxbm').val()
				...
				+'&ylxbh='+$('#gldj').combobox("getValues").join(',')+'&jhsh.lxmc='+$("#lxmc").val()+'&jhsh.ghxlxbm='+$("#ghlxbm").val()+'&jhsh.ghxlxmc='+$("#ghlxmc").val()+'&jhsh.jsjsdj='+$("#jsjsdj").combobox("getValues").join(",")+'&jhsh.jhxdwh='+$("#jhxdwh").val()+
				'&jhsh.xmnf='+xmnf;
