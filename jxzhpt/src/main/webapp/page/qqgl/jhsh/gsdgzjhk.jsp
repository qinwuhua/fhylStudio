	...
	<script type="text/javascript">
		...
		function queryLmsj(){
			...
			var params={'jhsh.xmlx1':xmlx,'jhsh.xzqhdm':getxzqhdm('xzqh'),'jhsh.xmmc':$('#xmmc').val(),
					...
					'jhsh.ghlxbh':$('#lxbm').val().toUpperCase(),'jhsh.lxmc':$('#lxmc').val(),'jhsh.xdzttj':xdzt,
				 ...
				 {field:'cz',title:'操作',width:100,align:'center',
					formatter: function(value,row,index){
						...
						result+='&nbsp;<a href="javascript:openWindow1('+"'lmsjxx'"+','+"'国省道改造'"+','+
								"'/jxzhpt/page/qqgl/jhsh/lmsj_xx1.jsp'"+",980,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">详细</a>'
								//+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
								;
						if(row.xmbm.substr(10,1)=='2')
							result+='&nbsp;<a href="javascript:openWindow1('+"'lmsjxx'"+','+"'国省道改造'"+','+
								"'/jxzhpt/page/qqgl/jhsh/lmgz_xx1.jsp'"+",980,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">详细</a>'
								//+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
								;
						if(row.xmbm.substr(10,1)=='3')
							result+='&nbsp;<a href="javascript:openWindow1('+"'lmsjxx'"+','+"'国省道改造'"+','+
								"'/jxzhpt/page/qqgl/jhsh/xjgc_xx1.jsp'"+",980,400,'"+row.xmbm+"'"+')" style="color:#3399CC;">详细</a>'
								//+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
								;
...
// 							"'/jxzhpt/page/qqgl/jhsh/jhxd3.jsp'"+',900,400)" style="color:#3399CC;">计划审核</a>';
				...
				{field:'jhxdsj',title:'下达时间',width:100,align:'center'},
		...
		function exportJhshxx(){
			...
			if(zjly.substr(0,1)==',')
			  ...
			  var param='jhsh.xmbm='+xmnf+'&jhsh.xmlx1='+xmlx
				+'&jhsh.xzqhdm='+getxzqhdm('xzqh')+'&jhsh.ghlxbh='+$('#lxbm').val().toUpperCase()+'&jhsh.scxdnf='+xmnf
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;计划查询>&nbsp;<span id="bstext"></span>>&nbsp;国省道改造</div>
	</div>
