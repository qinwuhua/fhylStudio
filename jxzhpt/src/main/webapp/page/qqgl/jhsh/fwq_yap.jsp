...
function queryFwqYap(){
	
	grid.id="grid";
	grid.url="../../../qqgl/listFwqSbzt.do";
	...
	grid.columns=[[
					...
					{field:'cz',title:'操作',width:130,align:'center',
						formatter: function(value,row,index){
							...
							result+='&nbsp;<a href="javascript:openWindowById('+"'jhxd'"+','+"'服务区'"+','+
...
//	 						+'&nbsp;<a href="javascript:qxxm('+row.xmbm+')" style="color:#3399CC;">取消</a>'
							...
							if($.cookie('unit2').length!=7){
								if(row.xdzt=='1')
									...
									"'/jxzhpt/page/qqgl/jhsh/fwq_edit.jsp'"+",900,400,'"+row.id+"'"+')" style="color:#3399CC;">编辑</a>';
							}else{
								result+='&nbsp;<a href="javascript:openWindowById('+"'jhxd'"+','+"'编辑'"+','+
								"'/jxzhpt/page/qqgl/jhsh/fwq_edit.jsp'"+",900,400,'"+row.id+"'"+')" style="color:#3399CC;">编辑</a>';
							}
								if(row.xdzt=='1')
									...
									"'/jxzhpt/page/qqgl/jhsh/fwq_xmth.jsp'"+",900,400,'"+row.id+"'"+')" style="color:#3399CC;">退回</a>'; 
							return result;
						}
					},	
					...
					{field:'xdzt',title:'审核状态',width:60,align:'center',
						formatter: function(value,row,index){
							...
							xmlx=6;
							if(row.xdzt=='0')
								result='<a href="javascript:changeFwqXdzt('+index+')" style="color:#3399CC;">未审核</a>';
						 	if(row.xdzt=='1')
								result='<a href="javascript:changeFwqXdzt('+index+')" style="color:#3399CC;">已审核</a>';
//								result='<a href="javascript:plansh('+index')" style="color:#3399CC;">已审核</a>';
