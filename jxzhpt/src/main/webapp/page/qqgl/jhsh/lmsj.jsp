...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function queryLmsj(){
			...
			grid.columns=[[
				...
				{field:'xdzt',title:'资金追加',width:100,align:'center',
					formatter: function(value,row,index){
						var result="";
						result='<a href="javascript:openZjzj('+"'"+index+"',"+"'1'"+')" style="color:#3399CC;">资金追加</a>';
						return result;
					}
				},
		...
		function exportJhshxx(){
			var param='jhsh.xmbm='+$('#xmnf').combobox("getValue")+'&jhsh.xmlx=1&jhsh.xdzt='+$('#xdzt').combobox("getValue")+'&jhsh.xzqhdm='+getxzqhdm('xzqh')+'&jhsh.ghlxbh='+$('#txtlxbm').val()+
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;项目计划库审核>&nbsp;改建工程项目</div>
	</div>
        				...
        				<table style="margin:7px; vertical-align:middle;" cellspacing="0" class="abgc_td" >
        					...
        					<tr height="32">
                            	...
                            	<td colspan="8">
									...
									<img onclick="plscbtn()" alt="批量上传计划下达文件" src="../../../images/plsc.png" style="vertical-align:middle;">
        						</td>
                            </tr>
        					</table>
        				</div>
