	...
	<script type="text/javascript">
		$(function(){
			$.ajax({
				...
				data:'jhsh.xmlx='+4+'&jhsh.xmbm='+parent.YMLib.Var.xmbm,
				dataType:'json',
			...
			<table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;border-color: #55BEEE #C0C0C0 #C0C0C0 #C0C0C0;" cellspacing="0" cellpadding="0">
				...
				<tr style="height: 25px;">
					<td colspan="6"  style="text-align: center;">
						<a><img onclick="openZjxd1()" id="imgAdd" alt="添加" onmouseover="this.src='../../../images/Button/tianj2.gif'" onmouseout="this.src='../../../images/Button/tianj1.gif'" src="../../../images/Button/tianj1.gif" style="text-align: center;"/></a>
