	...
	<script type="text/javascript">
		...
		function queryxmList(){
			...
			$('#grid').datagrid({    
				...
				{field:'xjsdj',title:'技术等级',width:74,align:'center'},
		...
		function showMxbAll(){
			...
			$('#jhbz').datagrid({    
				...
				{field:'bzdk',title:'厅贷款',width:60,align:'center',editor:{type:'text',options:{required:false}}},
...
// 							"'/jxzhpt/page/qqgl/jhsh/jhxd3.jsp'"+',900,400)" style="color:#3399CC;">计划审核</a>';
				...
				{field:'xjsdj',title:'技术等级',width:70,align:'center'},
