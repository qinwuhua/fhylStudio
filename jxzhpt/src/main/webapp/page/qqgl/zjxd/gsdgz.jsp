...
<%-- 	<script type="text/javascript" src="${pageContext.request.contextPath}/page/qqgl/lxsh/js/sjgz.js"></script> --%>
	...
	<script type="text/javascript">
		...
		function queryxmList(){
			...
			var params={'jhsh.xmlx1':xmlx,'jhsh.xzqhdm':getxzqhdm('xzqh'),'jhsh.ghlxbh':$('#lxbm').val().toUpperCase(),'jhsh.xdzttj':xdzt,'jhsh.zjly':zjly,'jhsh.ghxlxbm':$('#ghlxbm').val().toUpperCase(),'jhsh.ghxlxmc':$('#ghlxmc').val(),'jhsh.lxmc':$('#lxmc').val(),
		...
		function showMxbAll(){
			...
			$('#jhbz').datagrid({    
				...
				{field:'bzpfztz',title:'总投资',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzcgs',title:'车购税',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzgz',title:'国债',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzsz',title:'省债',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzzq',title:'债券',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzdk',title:'贷款',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzjl',title:'奖励',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzqt',title:'其他',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzdfzc',title:'地方自筹',width:60,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzyhdk',title:'银行贷款',width:60,align:'center',editor:{type:'text',options:{required:false}}},
...
/* 			 var param='jhsh.xmlx1='+xmlx+'&jhsh.xzqhdm='+getxzqhdm('xzqh')+'&jhsh.ghlxbh='+$("#lxbm").val()+'&jhsh.xdzttj='+xdzt+'&jhsh.zjly='+zjly+'&jhsh.ghxlxbm='+$("#ghlxbm").val()+'&jhsh.ghxlxmc='+$("#ghlxmc").val()+'&jhsh.lxmc='+$("#lxmc").val()
		  ...
		  var param='jhsh.xmbm='+$('#scxdnf').combobox("getValues").join(',')+'&jhsh.xmlx1='+xmlx
			+'&jhsh.xzqhdm='+getxzqhdm('xzqh')+'&jhsh.ghlxbh='+$('#lxbm').val().toUpperCase()+'&jhsh.scxdnf='+$("#scxdnf").combobox("getValues").join(",")
			...
			+'&ylxbh='+$('#gldj').combobox("getValues").join(',')+'&jhsh.lxmc='+$("#lxmc").val()+'&jhsh.ghxlxbm='+$("#ghlxbm").val().toUpperCase()+'&jhsh.ghxlxmc='+$("#ghlxmc").val()+'&jhsh.jsjsdj='+$("#jsjsdj").combobox("getValues").join(",")+'&jhsh.jhxdwh='+jhxdwh
        			...
        			<fieldset id="searchField" style="width:99.9%; text-align: left; vertical-align: middle;">
        				...
        				<table style="margin:7px; vertical-align:middle;" cellspacing="0" class="abgc_td" >
        					<tr height="32">
        						...
        						<td><select id="xzqh" style="width:114px;"></select></td>
        						<td align="right">项目名称：</td>
        						<td><input name="xmmc" type="text" id="xmmc" style="width:90px;" /></td>
        						...
        						<td align="right">现技术等级：</td>
        						<td><select name="jsdj" class="easyui-combobox" id="jsdj" style="width:70px;"></select></td>
        					...
        					<td align="right">规划路线名称：</td>
        						...
        						<td><input name="jhxdwh" type="text" id="jhxdwh" style="width:90px;" /></td>
								...
								<td align="right">原路线编码：</td>
        						<td><input name="lxbm" type="text" id="lxbm" style="width:70px;" /></td>
        						</tr>
        					<tr height="32">
        					<td align="right">原路线名称：</td>
        						<td><input name="lxmc" type="text" id="lxmc" style="width:110px;" /></td>
        						<td align="right">规划路线编码：</td>
        						<td><input name="ghlxbm" type="text" id="ghlxbm" style="width:90px;" /></td>
        						...
        						<td align="right">特殊地区：</td>
        						<td><select name="tsdq" id="tsdq" class="easyui-combobox" style="width:70px;"></select></td>
        						</tr>
        					<tr height="32">
        					 <td align="right">管养分类：</td>
        						<td><input name="gyfl" type="text" id="gyfl" style="width:110px;" /></td>
        						<td align="right">下达状态：</td>
        						<td><input name="xdzt" type="text" id="xdzt" style="width:90px;" /></td>
