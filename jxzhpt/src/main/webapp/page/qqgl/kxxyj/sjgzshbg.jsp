...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			xmnf("xmnf");
			//showAllsjshbg();
			setTimeout("showAllsjshbg()",'1700');
		});
		function showAllsjshbg(){
			...
			$('#datagrid').datagrid({    
			    url:'/jxzhpt/qqgl/selectSjgzkxbgList.do',
			    striped:true,
			    pagination:true,
			    rownumbers:true,
			    pageNumber:1,
...
//					sbzt:sbzt,
			    ...
			    columns:[[
			        ...
			        {field:'c',title:'操作',width:200,align:'center',formatter:function(value,row,index){
			        	if(row.tzxz=='取消')
			        		return '<a style="text-decoration:none;color:#3399CC;" href="#" onclick="dingwei('+index+')">定位</a>   '+'<a style="text-decoration:none;color:#3399CC;" href="#" onclick="xiangxi('+index+')">详细</a>    '+'<a style="text-decoration:none;color:#000000;" href="#" >编辑</a> <a href="javascript:thtz('+"'"+row.xmbm+"','sjgz','1'"+')" style="text-decoration:none;color:#3399CC; ">退回</a>';
		        		else	
			        		return '<a style="text-decoration:none;color:#3399CC;" href="#" onclick="dingwei('+index+')">定位</a>   '+'<a style="text-decoration:none;color:#3399CC;" href="#" onclick="xiangxitz('+index+')">详细</a>    '+'<a style="text-decoration:none;color:#3399CC;" href="#" onclick="edit('+index+')">编辑</a>  <a href="javascript:thtz1('+"'"+row.xmbm+"','sjgz','1'"+')" style="text-decoration:none;color:#3399CC; ">退回</a>';
			        }},
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;工程可行性研究审核>&nbsp;改建工程项目变更</div>
	</div>
        		...
        		<td align="left" style="padding-left: 10px; padding-top: 10px;height: 100px;">
					...
					<tr height="32">
        					...
        					<td>变更类别：</td>
                              ...
                              <td colspan="10">
        						<img onclick="showAllsjshbg()" alt="搜索" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/Serch01.gif'" style="vertical-align:middle;"/>
<!--         						<img onclick="dckxxModule('sjgz');" name="bxs" id="btnDCMB" onmouseover="this.src='../../../images/Button/DC2.gif'" alt="导出模版" onmouseout="this.src='../../../images/Button/DC1.gif'" src="../../../images/Button/DC1.gif" style="border-width:0px;cursor: hand;vertical-align:middle;" /> -->
<!-- 								<img onclick="importsjgzkxx('sjgzsh')" name="bxs"id="insertData" alt="导入数据" src="../../../images/Button/dreclLeave.GIF" onmouseover="this.src='../../../images/Button/dreclClick.GIF'" onmouseout="this.src='../../../images/Button/dreclLeave.GIF'" style="border-width:0px;vertical-align:middle;" /> -->
				             </td>
                            </tr></table>
        				</div>
        			</fieldset>
