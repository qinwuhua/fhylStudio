...
// 		});	
	...
	function saveLxsh(){
		...
		+"&kxxyj.lxbh="+$('#lxbh').val()+"&kxxyj.qdzh="+$('#qdzh').val()+"&kxxyj.zdzh="+$('#zdzh').val()+"&kxxyj.jsxz="+$('#jsxz').val()
...
<table style="width: 100%; background-color: #aacbf8; font-size: 12px"
			...
			<tr style="height: 35px;">
				...
				<td colspan="3" style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input type="text" id='xzqh' style="width: 408px;"/>
				</td>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right"></td>
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left"></td>
			</tr>
		    ...
		    <tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input type="text" id="hyscyj" name="hyscyj" style="width: 120px;"/>
				</td>
			...
			<tr style="height: 35px;">
				...
				<td colspan="3" style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input type="text" id="gydw" name="gydw" style="width: 410px;"/>
				</td>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right"></td>
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left"></td>
			</tr>
