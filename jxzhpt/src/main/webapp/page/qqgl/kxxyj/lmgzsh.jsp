...
<!--         						<img  name="bxs" id="btnDCMB" onmouseover="this.src='../../../images/Button/DC2.gif'" alt="导出模版" onmouseout="this.src='../../../images/Button/DC1.gif'" src="../../../images/Button/DC1.gif" onclick="dckxxModule('lmgz');" style="border-width:0px;cursor: hand;vertical-align:middle;" /> -->
								...
								<img name="bxs"id="insertData" alt="导入数据" src="../../../images/Button/dreclLeave.GIF" onmouseover="this.src='../../../images/Button/dreclClick.GIF'" onmouseout="this.src='../../../images/Button/dreclLeave.GIF'" onclick="importlmgzkxx('lmgzsh')" style="border-width:0px;vertical-align:middle;" />
