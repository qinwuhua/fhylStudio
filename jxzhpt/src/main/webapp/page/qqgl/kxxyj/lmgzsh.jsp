        			...
        			<fieldset id="searchField" style="width:99%; text-align: left; vertical-align: middle;">
        				...
        				<table style="margin:5px; vertical-align:middle;" cellspacing="0" class="abgc_td" >
        					...
        					<td align="right">规划路线名称：</td>
								...
								<td><select name="tsdq" id="tsdq" style="width:118px;" ></select></td>
...
<!-- 								<img id="insertData" alt="导入数据" src="../../../images/Button/dreclLeave.GIF" onmouseover="this.src='../../../images/Button/dreclClick.GIF'" onmouseout="this.src='../../../images/Button/dreclLeave.GIF'" onclick="importlmgzkxx('lmgzsh')" style="border-width:0px;vertical-align:middle;" /> -->
								...
								<img onclick="shenhxz('lmgz');"  id="shenPi" src="../../../images/Button/sp1.jpg" onmouseover="this.src='../../../images/Button/sp2.jpg'" onmouseout="this.src='../../../images/Button/sp1.jpg'   " src="" style="border-width:0px;vertical-align:middle;" />
