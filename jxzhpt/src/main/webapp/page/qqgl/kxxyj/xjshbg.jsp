...
<head>
	...
	<script type="text/javascript">
		...
		function showAllxjshbg(){
			...
			$('#datagrid').datagrid({    
			    url:'/jxzhpt/qqgl/selectXjkxbgList.do',
			    striped:true,
			    pagination:true,
			    rownumbers:true,
			    pageNumber:1,
...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;工程可行性研究审核>&nbsp;新建工程项目变更</div>
	</div>
        		...
        		<td align="left" style="padding-left: 10px; padding-top: 10px;height: 100px;">
					...
					<tr height="32">
        				...
        				<td>变更类别：</td>
                              ...
                              <td colspan="10">
        						<img onclick="showAllxjshbg()" alt="搜索" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/Serch01.gif'" style="vertical-align:middle;"/>
        									             </td>
                            </tr></table>
        				</div>
        			</fieldset>
