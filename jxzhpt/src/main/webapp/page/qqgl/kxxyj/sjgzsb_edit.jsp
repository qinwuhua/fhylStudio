...
<script type="text/javascript">
	...
	function saveLxsh(){
		...
		+"&kxxyj.jszlc="+$('#jszlc').val()+"&kxxyj.hyscyj="+$('#hyscyj').val()+"&kxxyj.tgsj="+$('#tgsj').datebox('getValue');
...
<table style="width: 100%; background-color: #aacbf8; font-size: 12px" border="0" cellpadding="3" cellspacing="1">
		   <tr style="height: 25px;">
            ...
            <tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input readonly="readonly" id="ylxbh" name="ylxbh" type="text" style="width: 120px;"/>
				</td>
			...
			<tr style="height: 35px;">
				...
				<td colspan="3" style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input id="xmmc" name="xmmc" type="text" style="width:405px;"/>
			...
			<tr style="height: 35px;">
				...
				<td colspan="3" style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input id="xzqh" name="xzqh" type="text" style="width: 410px;"/>
				</td>
...
<!-- 			<tr style="height: 35px;">
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 25px;" align="left">
					<input id="dq_m" name="dq_m" type="text"  onblur="checkSZ(this)" style="width:120px;"/></td>
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input id="sd_m" name="sd_m" type="text" onblur="checkSZ(this)" style="width: 120px;"/></td>
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input id="tzgs" name="tzgs" style="width: 120px;" type="text" onblur="checkSZ(this)"/></td>
