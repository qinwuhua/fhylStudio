...
<body>
	<div id="righttop">
		<div id="p_top">前期管理>&nbsp;工程可行性研究报告>&nbsp;<span id='bstext'></span>>&nbsp;新建工程项目</div>
	</div>
        				...
        				<tr height="32">
        					<td>规划路线编码：</td>
                              ...
                              <td colspan="10">
        						...
        						<img  name="bxs" id="btnDCMB" onmouseover="this.src='../../../images/Button/DC2.gif'" alt="导出模版" onmouseout="this.src='../../../images/Button/DC1.gif'" src="../../../images/Button/DC1.gif" onclick="dckxxModule('xj');" style="border-width:0px;cursor: hand;vertical-align:middle;" />
								<img name="bxs"id="insertData" alt="导入数据" src="../../../images/Button/dreclLeave.GIF" onmouseover="this.src='../../../images/Button/dreclClick.GIF'" onmouseout="this.src='../../../images/Button/dreclLeave.GIF'" onclick="importxjkxx('xjsh')" style="border-width:0px;vertical-align:middle;" />
...
<%-- 								<img alt="导入" src="${pageContext.request.contextPath}/images/Button/dreclLeave.GIF" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/dreclClick.GIF'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/dreclLeave.GIF'" onclick="importData_jh('abgc_jh')" style="vertical-align:middle;"/> --%>
								<img name="bxs" id="shenPi" src="../../../images/Button/sp1.jpg" onmouseover="this.src='../../../images/Button/sp2.jpg'" onmouseout="this.src='../../../images/Button/sp1.jpg'   " src="" onclick="shangB();" style="border-width:0px;vertical-align:middle;" />
