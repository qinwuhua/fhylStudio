					...
					<tr height="32">
        				...
        				<tr height="32">
                              <td colspan="10">
								...
								<img name="insertData"id="insertData" alt="导入数据" src="../../../images/Button/dreclLeave.GIF" onmouseover="this.src='../../../images/Button/dreclClick.GIF'" onmouseout="this.src='../../../images/Button/dreclLeave.GIF'" onclick="importxjkxx('xjsh')" style="border-width:0px;vertical-align:middle;" />
