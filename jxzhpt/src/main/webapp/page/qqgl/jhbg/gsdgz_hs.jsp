...
<%-- 	<script type="text/javascript" src="${pageContext.request.contextPath}/page/qqgl/lxsh/js/sjgz.js"></script> --%>
	...
	<script type="text/javascript">
		...
		function showMxbAll(){
			...
			var params={'jhsh.xmlx1':xmlx,'jhsh.xmnf':xmnf};
			//loadLj(params);
			$('#grid').datagrid({    
			    url:'/jxzhpt/qqgl/queryGsdgzxd_qxbz.do',
			    striped:true,
			    pagination:false,
			    rownumbers:true,
			    checkOnSelect:true,
				...
				{field:'xzqh',title:'行政区划',width:50,align:'center'},
				{field:'xmnf',title:'项目年份',width:40,align:'center',
					formatter: function(value,row,index){
		        		return row.xmbm.substr(0,4);
		        	}
				},
				{field:'xmmc',title:'项目名称',width:200,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'xmbm',title:'项目编码',width:80,align:'center'},
				{field:'bzxdnf',title:'下达年份',width:50,align:'center',editor:{type:'numberbox',options:{required:false}}},
				{field:'bzpfztz',title:'总投资',width:50,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'bzcgs',title:'车购税',width:50,align:'center',editor:{type:'text',options:{required:false}}},
				...
				{field:'bzyhdk',title:'银行贷款',width:50,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'zyjsnr',title:'主要建设内容',width:130,align:'center',editor:{type:'text',options:{required:false}}},
				{field:'xzscnl',title:'新增能力',width:130,align:'center',editor:{type:'text',options:{required:false}}}
