...
function download(id){
	window.location.href="/jxzhpt/wjxt/downLkhzmxbFile.do?id="+id
}
function dcmb(){
	window.location.href="/jxzhpt/xtgl/getModule_jhfeiLw.do?moduleName=gljszkhzmxb";
}
</script>
<div style="width:100%;">
    <div  style="height:84px;" border="false" >
	    <div id="righttop" >
			<div id="p_top">当前位置>&nbsp;路况评定>&nbsp;公路技术状况汇总明细表</div>
		</div>
			...
			<fieldset style="width:99%; text-align: left; vertical-align: middle;">
 				...
 				<div>
 					<p style="margin: 5px;">
	 					...
	 					<a id="yhgl_btn_add" href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-add"  onclick="insertHzbData('hzb')">导入数据</a>
