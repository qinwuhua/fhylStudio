...
function download(id){
	window.location.href="/jxzhpt/wjxt/downLkpdmxb2014File.do?id="+id
}
function dcmb(){
	window.location.href="/jxzhpt/xtgl/getModule_jhfeiLw.do?moduleName=gljszkpdmxb2014";
}
</script>
<div style="width:100%;">
			...
			<fieldset style="width:99%; text-align: left; vertical-align: middle;">
 				...
 				<div>
 					<p style="margin: 5px;">
	 					...
	 					<a id="yhgl_btn_add" href="javascript:void(0);" class="easyui-linkbutton" plain="true" iconCls="icon-add"  onclick="insertData1('mxb2014')">导入数据</a>
