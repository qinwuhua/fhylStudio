...
$(function(){
	...
	$("#dwgl_btn_Save").click(function(){
		...
		$("#id").val($("#parent").val()+$("#cid").val());
		param = $("#dwgl_form").serialize();
		$.ajax({
		type : "POST",
		url : "../../xtgl/insertBmbm.do",
		dataType : 'json',
		data : param,
	...
	<form id="dwgl_form" style="overflow-x:hidden">
		<table id="dwgl_form_table" cellspacing="0" class="table_grid">
			<tr>
				...
				<td>
					<input  type="text" id="parent" name="unit.parent" readonly="readonly" style="width: 75px"/>-<input type="text" id="cid" class="easyui-validatebox" required="true" validType="numberThree" style="width: 75px"/>
