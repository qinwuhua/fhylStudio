...
<table style="width: 80%; margin-top: 15px; background-color: #aacbf8; font-size: 12px;"
			...
			<tr style="height: 30px;">
				<td style="background-color: #ffffff;width:15%" align="right">项目名称：</td>
				<td style="background-color: #ffffff;" align="left">
					<input id="xmmc" name="xmmc" style="width: 156px;"/>
				</td>
					...
					<tr  style="height: 30px;">
						<td colspan="2" style="background-color: #ffffff;" align="center">
							<table>
								...
								<tr>
									<td><input type="checkbox" id="x.gq" name="xmsq" value="x.gq-工期（月）"/>工期（月）</td>
									<td style="padding-left: 10px;"><input type="checkbox" id="x.gcfl" name="xmsq" value="x.gcfl-工程分类"/>工程分类</td>
								</tr>
								<tr>
									<td><input type="checkbox" id="x.tsdq" name="xmsq" value="x.tsdq-工期（月）"/>特殊地区</td>
