...
function addjgys(){
		...
		if($("#sbz").html(msg.SBZ); || $("#nsqsjjlzj").val()==''||$("#jgtcTable").html()=='' ||$("#wgysTable").html()==''){
...
<table style="width: 98%; margin-top: 15px;margin-left: 10px; background-color: #aacbf8; font-size: 12px"
			...
			<tr style="height: 25px;">
				<td colspan="6" style="border-style: none none solid none; border-width: 1px; color: #55BEEE; font-weight: bold; font-size: small; text-align: left; background-color: #F1F8FF; width: 20%; padding-left: 10px;">
					交工验收信息
				</td>
			</tr>
...
<!-- 			<tr> -->
<!-- 				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:20%" align="right">施工许可文件：</td> -->
...
<!-- 			</tr> -->
				<tr>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:20%" align="right">交（竣）工报告：</td>
			...
			<tr>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:20%" align="right">质量鉴定书：</td>
