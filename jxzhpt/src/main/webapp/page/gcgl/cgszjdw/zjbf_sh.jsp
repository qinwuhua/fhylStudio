...
<script type="text/javascript">
	...
	function zjbf_shty(){
		...
		$.ajax({
			 ...
			 dataType : 'json',
			 data : 'gcglabgc.jhid=' +jhid+"&gcglabgc.cscyj="+$("#cscyj").val()+"&gcglabgc.thyy="+"&gcglabgc.id="+id+"&gcglabgc.sbzt="+1+"&gcglabgc.shzt=1",
...
<table style="width: 98%; margin-top: 15px;margin-left: 10px; background-color: #aacbf8; font-size: 12px"
			...
			<a id='mybuttion2' style="margin-left: 5px;margin-bottom: 1px;" href="javascript:zjbf_shty()" onmouseover="szgq('button button-tiny button-glow button-rounded button-raised button-primary','mybuttion2')" onmouseout="szgq('button button-tiny button-rounded button-raised button-primary','mybuttion2')"  class="button button-tiny button-rounded button-raised button-primary">审核</a>
