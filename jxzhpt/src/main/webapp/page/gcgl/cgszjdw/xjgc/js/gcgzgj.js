...
function wqxiangxi(index){
	...
	//YMLib.UI.createWindow('gclmgj_xx','新建工程项目计划详情',"/jxzhpt/page/jhgl/jhkxx/gclmgj.jsp",'gclmgj_xx',1000,500);
...
function tjgcgzgjcgs(){
	...
	var data="gcglgcgzgj.cgsdwzj="+$("#tj_cgsdwzj").val()+"&gcglgcgzgj.tbr="+$.cookie("truename")+"&gcglgcgzgj.tbsj="+$("#tj_tbsj").val()+"&gcglgcgzgj.tbyf="+$("#tbyf").val()+"&gcglgcgzgj.cscyj="+$("#tj_cscyj").val()+"&gcglgcgzgj.sz="+$("#sz").val()+"&gcglgcgzgj.gz="+$("#gz").val()+"&gcglgcgzgj.yhdk="+$("#yhdk").val()
	+"&gcglgcgzgj.jhid="+parent.parent.obj1.XMBM;
	//alert(data);
	$.ajax({
		type:'post',
		url:'../../../../gcgl/insertXjCgs.do',
		data:data,
		dataType:'json',
		success:function(msg){
			if(Boolean(msg)){
