...
function downGkwj(file){
	window.location.href="/jxzhpt/jhgl/queryWjById.do?jh.id="+parent.obj1.id+"&jh.gkbgmc="+file;
}
			...
			if (msg != null) {
				for ( var i = 0; i < msg.length; i++){
					...
					tbody.append(
							...
							+'<tr style="height: 30px;"><td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;padding-right: 5px;">原技术等级</td><td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;border-bottom: 1px solid #C0C0C0;  text-align: left; padding-left: 10px;"><span>'+msg[i].yjjsdj+'</span>级公路&nbsp;</td>'
