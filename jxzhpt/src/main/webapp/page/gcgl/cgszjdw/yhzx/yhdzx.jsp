	...
	<script type="text/javascript">
		...
		function exportAbyb(){
			...
			$.post('/jxzhpt/gcgl/exportsjyb_set.do',{gydw:xzqhstr} ,function(){
				window.location.href="/jxzhpt/gcgl/exportyhyb.do?"+data;
			  });
		}
...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;资金拨付>&nbsp;<span id="astext">资金拨付</span>>&nbsp;<span id="bstext"></span>>&nbsp;养护中心工程项目</div>
					</div>
        	</tr>
        	<tr>
        				...
        				<div>
        					...
        					<tr height="29">
        						...
        						<td><input name="ddlMonth"
									id="ddlMonth" style="width: 100px;"></td>
        						...
        						<td><select id="ljbfzt" class="easyui-combobox" style="width:90px;">
									<option value="" selected="selected">全部</option>
									<option value="已全部拨付">已全部拨付</option>
									<option value="未全部拨付">未全部拨付</option>
								</select></td>
        						<td align="right">项目名称：</td>
        						<td><input type="text" id="xmmc" style="width:100px;" /></td>
        						</tr>
        						<tr height="29">
        						<td colspan="8">
