...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function exportAbyb(){
			...
			var sbyf=m;
			var data="jgzt="+jgzt+"&kgzt="+kgzt+"&lxmc="+lxmc+"&sbyf="+sbyf+"&tbr="+$.cookie("truename")+"&qlmc="+qlmc+"&gcglabgc.qlbh="+$("#qlbm").val()+"&xmnf="+y+"&sfylrbwqk=是"+"&gcglabgc.gydwtj="+"and 1=1"+
...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;资金拨付>&nbsp;<span id="astext">资金拨付</span>>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;危桥改造工程项目</div>
					</div>
        				...
        				<div>
        					...
        					<tr height="29">
        						...
        						<td><input name="ddlMonth"
									id="ddlMonth" style="width: 68px;"></td>
        						...
        						<td><select id="ljbfzt" class="easyui-combobox" style="width:68px;">
        						...
        						<td><input type="text" id="qlbm" style="width: 138px;"></td>
