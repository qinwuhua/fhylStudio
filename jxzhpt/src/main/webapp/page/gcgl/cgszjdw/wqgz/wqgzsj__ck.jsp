...
<head>
	...
	<script type="text/javascript">
		...
		function exportAbyb(){
			...
			var sbyf=m;
			var data="jgzt="+jgzt+"&kgzt="+kgzt+"&lxmc="+lxmc+"&sbyf="+sbyf+"&tbr="+$.cookie("truename")+"&qlmc="+qlmc+"&gcglabgc.qlbh="+$("#qlbm").val()+"&xmnf="+y+"&sfylrbwqk="+$("#sfylrbwqk").combobox('getValue')+"gcglabgc.gydwtj="+"and gydwbm like '1%'"+
...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;工程管理>&nbsp;车购税资金到位情况>&nbsp;危桥改造工程项目</div>
					</div>
