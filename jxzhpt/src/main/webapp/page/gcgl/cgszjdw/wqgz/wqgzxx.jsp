...
function downFile1(){
	parent.window.location.href="/jxzhpt/jhgl/downAbgcFile.do?jh.gkbgmc="+'gkbg'+"&jh.id="+parent.obj1.jhid;
}
function downFile2(){
	parent.window.location.href="/jxzhpt/jhgl/downAbgcFile.do?jh.gkbgmc="+'sjsgt'+"&jh.id="+parent.obj1.jhid;
}
</script>
<style type="text/css">
a {
	...
	<div style="text-align: left; font-size: 12px; margin: 5px;">
		<table width="97%" border="0"
			...
			<tr style="height: 30px;">
				<td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0; color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF; width: 16%; padding-right: 5px;">
					桥梁名称</td>
				<td
