...
function zjdw(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','资金到位情况','wqgzzjdw.jsp','wqxx1',900,500);
	//window.open("wqgzzjdw.jsp");
}
function zjdw__ck(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','资金到位情况','wqgzzjdw__ck.jsp','wqxx1',900,500);
	//window.open("wqgzzjdw.jsp");
}
function closes(str){
...
function addCgs(){
	YMLib.UI.createWindow('wqxx','资金到位添加','wqgzzjdwtj.jsp','wqxx',700,250);
}
function editCgs(index){
	var data=$("#zjgrid").datagrid('getRows')[index];
	obj=data;
	YMLib.UI.createWindow('wqxx','资金到位编辑','wqgzzjdwxg.jsp','wqxx',700,250);
}
//添加车购税
function tjwqgzcgs(){
	var myDate = new Date();
	...
	var data="gcglwqgz.cgsdwzj="+$("#tj_cgsdwzj").val()+"&gcglwqgz.tbr="+$.cookie("truename")+"&gcglwqgz.tbsj="+$("#tj_tbsj").val()+"&gcglwqgz.tbyf="+$("#tj_tbyf").val()+"&gcglwqgz.cscyj="+$("#tj_cscyj").val()+"&gcglwqgz.stz="+$("#tj_stz").val()
...
function xgwqgzcgs(){
	...
	var data="gcglwqgz.cgsdwzj="+$("#xg_cgsdwzj").val()+"&gcglwqgz.tbsj="+$("#xg_tbsj").val()
