        			...
        			<fieldset style="width:99.7%; text-align: left; vertical-align: middle;margin: 1% 0px 0px 0px;">
        				...
        				<div>
        					...
        					<tr height="29">
        						...
        						<td><select name="ddlYear" id="ddlYear" style="width: 85px;">
        						<option value="">全部</option>
        						</select></td>
        						<td align="right">拨付月份：</td>
        						<td><input name="ddlMonth"
									id="ddlMonth" style="width: 70px;"></td>
        						...
        						<td><select id="ljbfzt" class="easyui-combobox" style="width:70px;">
									<option value="" selected="selected">全部</option>
									<option value="已全部拨付">已全部拨付</option>
									<option value="未全部拨付">未全部拨付</option>
								</select></td>
								<td align="right">路线编码：</td>
        						<td><input type="text" id="lxbm" style="width:80px;" /></td>
								</tr>
										<tr height="29">
								
        						<td align="right">项目名称：</td>
        						<td><input type="text" id="xmmc" style="width:148px;" /></td>
