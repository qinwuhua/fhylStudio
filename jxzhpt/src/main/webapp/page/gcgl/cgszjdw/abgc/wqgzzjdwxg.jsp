			...
			<tr>
				<td height="25" align="left"
					...
					<font color="#1a5780" style="font-size: small">工程管理</font>&nbsp;>&nbsp; <font color="#1a5780"
                            style="font-size: small">车购税资金到位情况</font>&nbsp;>&nbsp; <font color="Gray" style="font-size: small">
                                <span id="lblTitle">危桥改造施工过程管理</span></font>&nbsp;>&nbsp;
                        <font color="Gray" style="font-size: small">车购税资金到位</font>
                        ...
                        <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                            ...
                            <tr style="height: 35px;">
                                ...
                                <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                    ...
                                    <input name="txtCGSZJDW" type="text" id="txtCGSZJDW" onkeyup="MangeTZ(event,this)" onblur="checkNum(this)" value="20" />万元
                                </td>
                            </tr>
                            <tr style="height: 35px;">
                        ...
                        <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                            ...
                            <tr style="height: 30px;">
                                <td align="center">
                                    ...
                                    &nbsp;
                                    <input type="image" name="btnCancel" id="btnCancel" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/fanhui2.GIF'" alt="返回" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/fanhui1.GIF'" src="${pageContext.request.contextPath}/images/Button/fanhui1.GIF" style="border-width:0px;" />
                                </td>
                            </tr>
                        </table>
                    </td>
