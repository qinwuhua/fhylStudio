...
function ybsb(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','养护中心月报信息','yhdzxyb.jsp','wqxx1',1059,467);
}
...
function Showybxx(index){
	...
	parent.obj=data;
	parent.YMLib.UI.createWindow('wqxx','养护中心月报详情','yhdzxybxx.jsp','wqxx',800,340);
}
...
function showYBlist(){
	...
	$('#ybgrid').datagrid({    
	    url:'../../../../gcgl/selectYhzxYbByJhid.do',
	    striped:true,
	    pagination:true,
	    rownumbers:true,
	    pageNumber:1,
