	            ...
	            <td height="25" align="left" background="${pageContext.request.contextPath}/images/dht_bg.jpg" style="padding-left: 25px; background-repeat: no-repeat; font-size: 12px;">
                    <font color="#1a5780" style="font-size: small">工程管理</font>&nbsp;>&nbsp; <font color="#1a5780"
                        style="font-size: small">干线公路建设及养护管理</font>&nbsp;>&nbsp; <font color="Gray" style="font-size: small">
                            安保工程施工过程管理</font>&nbsp;>&nbsp; <font color="Gray" style="font-size: small">月报上报</font>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 30px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <input name="BYWC_C" type="text" id="BYWC_C" />
                            </td>
                            <td style="border-left: 1px none #C0C0C0; border-right: 1px none #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; color: #007DB3; font-weight: bold; font-size: small;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" class="style2">
                                <input name="BYWC_GL" type="text" id="BYWC_GL" />
                            </td>
                            <td style="border-left: 1px none #C0C0C0; border-right: 1px none #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; color: #007DB3; font-weight: bold; font-size: small;
                                text-align: right; background-color: #F1F8FF; padding-right: 5px;">
                        ...
                        <tr style="height: 30px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px none #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                colspan="5">
                                部投资（万元）：<input name="BYWCTZ_B" type="text" id="BYWCTZ_B" style="width:50px;" />
                                省投资（万元）：<input name="BYWCTZ_S" type="text" id="BYWCTZ_S" style="width:50px;" />
                                其他投资（万元）:
                                <input name="BYWCTZ_QT" type="text" id="BYWCTZ_QT" style="width:50px;" />
                            </td>
                        </tr>
                        <tr style="height: 30px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px none #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                部投资（万元）：<input name="BYZJSY_B" type="text" id="BYZJSY_B" onblur="CheckCGS(this.value)" style="width:50px;" />
                                省投资（万元）：<input name="BYZJSY_S" type="text" id="BYZJSY_S" style="width:50px;" />
                                其他投资（万元）:
                                <input name="BYZJSY_QT" type="text" id="BYZJSY_QT" style="width:50px;" />
                            </td>
                        </tr>
