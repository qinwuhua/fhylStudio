		...
		<table width="99%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td height="30" align="left" style="font-size: 12px;">
                    项目计划下达资金共【<span id="lblXDZJ" style="color: Red; font-weight: bold;">0</span>】万元，
                    累计拨付资金共【<span id="lblBFZJ" style="color: Red; font-weight: bold;">0</span>】万元。
                    其中，2014年计划下达资金【<span id="lblBNXDZJ" style="color: Red;
                ...
                <td>
                            ...
                            <table width="100%" height="90%" cellpadding="0" cellspacing="0" border="1" style="padding-top: 10px;">
                              ...
                              <tr align="center">
                                ...
                                <td>
                                    <span id="rpDate_ctl01_BYWCML" style="font-size:10pt;">1</span>
                                </td>
                                <td>
