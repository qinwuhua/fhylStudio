		...
		<table width="99%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
	            <td height="25" align="left" background="${pageContext.request.contextPath}/images/dht_bg.jpg" style="padding-left: 25px; background-repeat: no-repeat; font-size: 12px;">
	            	...
	            	<font style="color: #5C5C5C;">&nbsp;>&nbsp;养护大中修月报上报</font>
	            </td>
        	</tr>
        	<tr>
                ...
                <td>
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 30px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px none #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; width: 18%; text-align: left; padding-left: 10px;">
                                <span id="lblPQI"><a href='###' onclick='openPQIDetails(1660.43,1672.181,&#39;G105&#39;,&#39;南昌市公路管理局安义分局&#39;)' style='cursor:help;' title='点击查看' >良</a></span>
                            </td>
                        </tr>
                        <tr style="height: 30px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; width: 19%; text-align: left; padding-left: 10px;">
                                <span id="lblJTL"><a href='###' onclick='openAADTDetails(1660.43,1672.181,&#39;G105&#39;,&#39;南昌市公路管理局安义分局&#39;)' style='cursor:help;' title='点击查看' >400</a></span>
                            </td>
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                                color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;
                                width: 15%; padding-right: 5px;">
                ...
                <td align="center">
                            ...
                            <table width="100%" height="90%" cellpadding="0" cellspacing="0" border="1" style="padding-top: 10px;">
                                <tr>
                                    ...
                                    <td colspan="3" style="border-style: solid solid solid solid; border-width: 1px;
                                        border-color: #C0C0C0; color: #007DB3; font-weight: bold; font-size: 12px; text-align: center;
                                        background-color: #F1F8FF; padding-right: 5px;">
                                        本月完成投资（万元）
                                    </td>
