...
function downFile1(){
	parent.window.location.href="/nmyhgc/jhgl/downAbgcFile.do?jh.gkbgmc="+'gkbg'+"&jh.id="+parent.obj1.jhid;
}
function downFile2(){
	parent.window.location.href="/nmyhgc/jhgl/downAbgcFile.do?jh.gkbgmc="+'sjsgt'+"&jh.id="+parent.obj1.jhid;
}
</script>
<style type="text/css">
a {
