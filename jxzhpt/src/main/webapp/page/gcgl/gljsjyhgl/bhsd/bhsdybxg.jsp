...
// 			$("#xg_sbsj").text(sbsj);
			...
			$("#xg_sbsj").datebox('setValue',data.sbsj);
			$("#xg_sbyf").val(data.sbyf);
			$("#xg_wczj_cgs").val(data.wczj_cgs);
			$("#xg_wczj_rys").val(data.wczj_rys);
			$("#xg_wczj_cz").val(data.wczj_cz);
			$("#xg_wczj_gmsptzj").val(data.wczj_gmsptzj);
			$("#xg_dwzj_cgs").val(data.dwzj_cgs);
			$("#xg_dwzj_rys").val(data.dwzj_rys);
                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <input style="width: 50px" name="ZJ_BTZ" type="text" id="xg_zjdw_btz" />
                                </td>
                                <td style="width: 157px;">省投资：
                                <input style="width: 50px" name="ZJ_STZ" type="text" id="xg_zjdw_stz" />
                                </td>
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <input id="xg_sbsj" type="text" class="easyui-datebox" style="width: 100px;"></input>
                            </td>
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                                color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;
                                 padding-right: 5px;">
