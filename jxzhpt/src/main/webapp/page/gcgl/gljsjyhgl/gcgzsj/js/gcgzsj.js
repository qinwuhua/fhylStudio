...
function ybsb(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','升级改造工程项目月报信息','gcgzsjyb.jsp','wqxx1',1059,467);
	//window.open("gcgzsjyb.jsp");
}
function ybsb__ck(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','升级改造工程项目月报信息','gcgzsjyb__ck.jsp','wqxx1',1059,467);
	//window.open("gcgzsjyb.jsp");
}
function AddInfo(){
...
function tjgcgzsjyb(){
	...
	+"&gcglgcgzsj.wkglc="+$("#wkglc").val()+"&gcglgcgzsj.gz="+$("#gz").val()+"&gcglgcgzsj.sz="+$("#sz").val()
	...
	$('#ybgrid').datagrid({    
	    ...
	    columns:[
	             [
			        ...
			        {title:'本月完成投资（万元）',colspan:7},
			        {field:'bywctze',title:'本月完成投资',width:120,align:'center',rowspan:2},
