                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                部投资：<input name="WC_BTZ" type="text" id="WC_BTZ" value="9" />&nbsp;&nbsp;&nbsp;&nbsp; 省投资：<input name="WC_STZ" type="text" id="WC_STZ" value="9" />&nbsp;&nbsp;&nbsp;&nbsp; 其他投资：<input name="WC_QTTZ" type="text" id="WC_QTTZ" value="9" />&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr style="height: 35px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" colspan="5">
                                部投资：<input name="ZJ_BTZ" type="text" id="ZJ_BTZ" onblur="CheckCGS(this.value)" value="8" />&nbsp;&nbsp;&nbsp;&nbsp;
                                省投资：<input name="ZJ_STZ" type="text" id="ZJ_STZ" value="9" />&nbsp;&nbsp;&nbsp;&nbsp; 其他投资：<input name="ZJ_QTTZ" type="text" id="ZJ_QTTZ" value="9" />&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr style="height: 35px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" colspan="5">
                                <input name="JZKGDL" type="text" id="JZKGDL" style="width: 327px;" value="9" />
                            </td>
                        </tr>
                        <tr style="height: 35px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" colspan="5">
                                <input name="QKSM" type="text" id="QKSM" style="width: 327px;" value="9" />
                            </td>
                        </tr>
                        <tr style="height: 35px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <input name="BYWCGL" type="text" id="BYWCGL" value="9" />
                            </td>
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                                color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;
                                width: 15%; padding-right: 5px;">
