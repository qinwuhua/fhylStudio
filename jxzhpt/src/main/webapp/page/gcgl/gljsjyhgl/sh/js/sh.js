...
function ybsb(){
	YMLib.UI.createWindow('wqxx','水毁项目月报上报','shyb.jsp','wqxx',1059,450);
	//window.open("shyb.jsp");
}
function AddInfo(){
	YMLib.UI.createWindow('wqxx','水毁项目月报添加','shybtj.jsp','wqxx',900,400);
...
function Edityb(){
	YMLib.UI.createWindow('wqxx','水毁项目月报编辑','shybxg.jsp','wqxx',900,400);
