...
function tjwqgzkg(){
	...
	+"&gcglgcgzgj.htje="+$("#tj_htje").val()+"&gcglgcgzgj.gsztz="+$("#tj_gys").val()+"&gcglgcgzgj.jhid="+parent.obj1.jhid;
	alert(data);
	$.ajax({
		type:'post',
...
//完工
function tjwqgzwg(){
	var data="gcglgcgzgj.sjwgsj="+$("#tj_sjwgsj").datebox('getValue')+"&gcglgcgzgj.jhid="+parent.obj1.jhid;
	//alert(data);
	$.ajax({
		type:'post',
...
//未完工
function tjwqgzwwg(){
	var data="gcglgcgzgj.wjgyy="+$("#tj_wjgyy").val()+"&gcglgcgzgj.jhid="+parent.obj1.jhid;
	//alert(data);
	$.ajax({
		type:'post',
...
function uploadFile(str){
	...
	var weatherDlg = new J.dialog( {
		id : 'id1',
		title : title,
		page : '../../upload.jsp?url='+"/jxzhpt/gcgl/uploadGcgzgjFile.do"+'&flag='+'gljsjyhgl%2fgcgzgj%2fgcgzgjxx'+'&type='+str+'&jhid='+parent.obj1.jhid,
		width : 450,
		height : 400,
		top : 0,
		rang : true,
...
function downFile(str){
	if($("#xz_"+str).text()=='下载附件'){
		parent.window.location.href="../../../../gcgl/downGcgzgjFile.do?type="+str+"&jhid="+parent.obj1.jhid;
	}
	else return;
}
