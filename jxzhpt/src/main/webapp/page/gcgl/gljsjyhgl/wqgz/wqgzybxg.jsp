...
<!--                                 省投资：<input style="width: 50px" name="WC_STZ" type="text" id="xg_wc_stz" />&nbsp;&nbsp;&nbsp;&nbsp; -->
                                 其他投资：<input onblur="checkZJ1(this)" style="width: 50px" name="WC_QTTZ" type="text" id="xg_wc_qttz" />&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr style="height: 35px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
...
<!--                                 省投资：<input style="width: 50px" name="ZJ_STZ" type="text" id="xg_zjdw_stz" />&nbsp;&nbsp;&nbsp;&nbsp;  -->
                                其他投资：<input onblur="checkZJ1(this)" style="width: 50px" name="ZJ_QTTZ" type="text" id="xg_zjdw_qttz" />&nbsp;&nbsp;&nbsp;&nbsp;
                            </td>
                        </tr>
                        <tr style="height: 35px;">
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
