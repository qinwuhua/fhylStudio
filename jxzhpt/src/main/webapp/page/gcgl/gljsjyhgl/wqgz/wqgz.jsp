...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 0.1%; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;<span id="astext">进度填报</span>>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;危桥改造工程项目</div>
					</div>
        	...
        	<tr>
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top:5px;">
					...
					<tr height="30">
        						...
        						<td><input id="kgzt" style="width: 60px;"></td>
        						<td align="right">路线名称：</td>
        							<td><input type="text" id="lxmc" style="width: 75px;"></td>
        						<td align="right">桥梁名称：</td>
        						<td><input type="text" id="qlmc" style="width: 75px;"></td>
								...
								<td><select name="ddlTSDQ" id="ddlTSDQ" style="width:77px; vertical-align:middle;">
								</select></td>
								
        							<td align="right">桥梁编码：</td>
        						<td><input type="text" id="qlbm" style="width: 75px;"></td>
