                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <td style="width: 157px;">其他(市、县等)投资：<input style="width: 50px" name="WC_QTTZ" type="text" id="tj_wc_qttz"  onblur='check(this)' /><font color='red' size='2'>*&nbsp;</font></td>
                                </tr>
                                </table>
                                </div>
                            </td>
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <td style="width: 157px;">其他(市、县等)投资：<input style="width: 50px" name="ZJ_QTTZ" type="text" id="tj_zjdw_qttz"  onblur='check(this)'/><font color='red' size='2'>*&nbsp;</font></td>
                                </tr>
                                </table>
                                </div>
                            </td>
                        ...
                        <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <input  type="text" id="tj_bywcmc" style="width: 50px;"/><font color='red' size='2'>*&nbsp;</font>
                            </td> -->
                             <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                                color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;
                                 padding-right: 5px;">
                                <b><font color="#009ACD" style=" font-size: 10px;width: 35px;">本月完成情况(%)：</font></b>
                            </td>
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;width:100px;
                                border-bottom: 1px solid #C0C0C0;  text-align: left; padding-left: 10px;" >
                           ...
                           <!--  <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" >
                                <input name="JZKGDL" type="text" id="tj_kgdl" style="width: 50px;" /><font color='red' size='2'>*&nbsp;</font>
                            </td>
                            -->
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                                color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;
...
<!--                                 <select id="tj_sbyf" onchange="getYuefen()"></select> -->
                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 30px;">
                            <td align="center">
                                <img id="addbtn" src="${pageContext.request.contextPath}/images/Button/baocun1.gif" id="Img1" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/baocun2.gif'" alt="保存" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/baocun1.gif'" style="cursor: hand" onclick="tjwqgzyb1();" />
