                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" colspan="5">
               					<table>
               					 ...
               					 <tr>
               						<td>按路面类型：</td>
               						<td>沥青<input id='lq' type="text" class="easyui-numberbox" data-options="precision:3" style="width: 50px;" value='0'></td>
               					 	<td>水泥<input id='sn' type="text" class="easyui-numberbox" data-options="precision:3" style="width: 50px;" value='0'></td>
                       ...
                       <tr style="height: 35px;">
                            ...
                            <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0;
                                ...
                                <input type="text" id="bndsslc" style="width: 50px;" class='easyui-numberbox' data-options="precision:3" value='0'/><font color="red">*</font>
                            </td>
                            <td style="border-style: none none solid none; border-width: 1px; border-color: #C0C0C0;
                                color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF;
                                padding-right: 5px;">
