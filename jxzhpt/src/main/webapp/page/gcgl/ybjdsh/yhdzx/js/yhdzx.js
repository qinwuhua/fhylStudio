...
function ybsh(index){
	var data=$("#ybgrid").datagrid('getRows')[index];
	obj=data;
	YMLib.UI.createWindow('wqxx','危桥改造月报审核','yhdzxybsh.jsp','wqxx',450,280);
}
function shyhdzxyb(){
	var myDate = new Date();
	...
	+"&gcglyhdzx.shtime="+sbsj+"&gcglyhdzx.shuser="+"admin"+"&gcglyhdzx.jhid="+jhid+"&gcglyhdzx.id="+parent.obj.id;
	//alert(data);
	$.ajax({
		type:'post',
