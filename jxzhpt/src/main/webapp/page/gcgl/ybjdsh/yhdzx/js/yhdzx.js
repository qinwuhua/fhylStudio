...
function thsjyb(index){
	...
	var data="gcglyhdzx.id="+data1.id+"&gcglyhdzx.sfsj=9";
	if(confirm("确认退回吗？")){
		$.ajax({
			type:'post',
...
function uploadFile(str){
	...
	var weatherDlg = new J.dialog( {
		id : 'id1',
		title : title,
		page : '../../upload.jsp?url='+"/jxzhpt/gcgl/uploadYhdzxFile.do"+'&flag='+'ybjdsh%2fyhdzx%2fyhdzxxx'+'&type='+str+'&jhid='+parent.obj1.id,
		width : 450,
		height : 400,
		top : 0,
		rang : true,
