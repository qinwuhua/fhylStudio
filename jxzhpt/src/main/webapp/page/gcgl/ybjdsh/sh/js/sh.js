...
function Edityb1(index){
	...
	ybxiangxi=data;
	YMLib.UI.createWindow('wqxx','灾毁月报编辑','../../gljsjyhgl/sh/shybxg.jsp','wqxx',850,350);
}
...
function ybsb(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','项目月报信息','/jxzhpt/page/gcgl/ybjdsh/gcjdyb.jsp','wqxx1',950,467);
	//window.open("wqgzyb.jsp");
}
function ybsb__ck(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','灾毁重建项目月报列表','shyb__ck.jsp','wqxx1',1059,480);
	//window.open("wqgzyb.jsp");
}
...
function showAll(){
	...
	$('#datagrid').datagrid({    
	    ...
	    queryParams: {
	    	...
	    	'gcglsh.xmzt':$("#xmzt").combobox('getText')
		},
	    columns:[[
