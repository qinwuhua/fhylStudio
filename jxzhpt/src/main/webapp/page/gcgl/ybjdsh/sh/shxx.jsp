...
function downGkwj(file){
	window.location.href="/jxzhpt/jhgl/queryShuihwjById.do?jh.id="+parent.obj1.id+"&jh.gkbgmc="+file;
}
function downSjt(file){
	window.location.href="/jxzhpt/jhgl/queryShuihwjById.do?jh.id="+parent.obj1.id+"&jh.sjsgtmc="+file;
}
</script>
<style type="text/css">
a {
