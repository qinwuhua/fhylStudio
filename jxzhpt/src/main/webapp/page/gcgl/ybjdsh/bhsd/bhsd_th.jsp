...
function tuiHui(){
	...
	var data="gcglbhsd.id="+data1.id+"&gcglbhsd.sfsj=9"+"&gcglbhsd.yhtype=7"+"&gcglbhsd.jhid="+data1.jhid
	          +"&gcglbhsd.yb_thyj="+$("#thyj").val();
	if(confirm("确认退回吗？")){
		$.ajax({
			type:'post',
			url:'/jxzhpt/gcgl/sbBhsdYb.do',
			data:data,
			dataType:'json',
...
<table style="width: 98%; margin-top: 15px;margin-left: 10px; background-color: #aacbf8; font-size: 12px"
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;width:18%" align="left">
					<input type="text" name="thyj" id="thyj" style="width: 250px" />
				</td>				
			</tr>
			<tr style="height: 35px;">
