...
function Edityb1(index){
	...
	ybxiangxi=data;
	YMLib.UI.createWindow('wqxx','路面改造月报编辑','../../gljsjyhgl/gcgzgj/gcgzgjybxg.jsp','wqxx',850,350);
}
...
function ybsb__ck(index){
	var data=$("#datagrid").datagrid('getRows')[index];
	obj1=data;
	YMLib.UI.createWindow('wqxx1','路面改造工程项目月报列表','gcgzgjyb__ck.jsp','wqxx1',1059,480);
	//window.open("wqgzyb.jsp");
}
...
function shgcgzgjyb(){
	...
	+"&gcglgcgzgj.shtime="+sbsj+"&gcglgcgzgj.shuser="+$("#shuser").val()+"&gcglgcgzgj.jhid="+parent.obj.jhid+"&gcglgcgzgj.id="+parent.obj.id;
	//alert(data);
	$.ajax({
		type:'post',
