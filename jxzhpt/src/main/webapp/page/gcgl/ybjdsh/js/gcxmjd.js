...
function tuihyb(index){
	var data=$("#ybgrid").datagrid('getRows')[index];
	obj=data;
	YMLib.UI.createWindow('wqxx','项目月报审核','/jxzhpt/page/gcgl/ybjdsh/gcjdyb_th.jsp','wqxx',400,200);
}
	              	...
	              	{field:'c',title:'操作',width:300,align:'center',rowspan:3,formatter:function(value,row,index){
	              		...
	              		if(yhjb.length<8&&yhjb.length>=2){
	              			if(row.shzt==0){
		              			...
		              			return '<a href="#" onclick="ShowybInfo('+index+')" style="color:#3399CC;">详细</a>    '+'<a href="#" onclick="Edityb('+index+')" style="color:#3399CC;">编辑</a>   '+'已上报    '+'<a href="#" onclick="shenhyb('+index+')" style="color:#3399CC;">未审核    </a>'+'<a href="#" onclick="tuihyb('+index+')" style="color:#3399CC;">退回    </a>'+'<a href="javascript:showStr('+"'"+row.thyy+"'"+')"  style="color:#3399CC;">退回原因</a>    '+'综规未审核';
	              				else
	              					return '<a href="#" onclick="ShowybInfo('+index+')" style="color:#3399CC;">详细</a>    '+'<a href="#" onclick="Edityb('+index+')" style="color:#3399CC;">编辑</a>   '+'已上报    '+'<a href="#" onclick="shenhyb('+index+')" style="color:#3399CC;">未审核    </a>'+'<a href="#" onclick="tuihyb('+index+')" style="color:#3399CC;">退回    </a>'+'退回原因    '+'综规未审核';
             					
	              			}
	              			else{
	              				if(row.zgshzt==0)
			              		return '<a href="#" onclick="ShowybInfo('+index+')" style="color:#3399CC;">详细</a>    '+'编辑   '+'已上报    '+'已审核    '+'退回    '+'退回原因    '+'综规未审核';
	              				else
	              					return '<a href="#" onclick="ShowybInfo('+index+')" style="color:#3399CC;">详细</a>    '+'编辑   '+'已上报    '+'已审核    '+'退回    '+'退回原因    '+'综规已审核';
	              			}
	              		}
	              	}},
