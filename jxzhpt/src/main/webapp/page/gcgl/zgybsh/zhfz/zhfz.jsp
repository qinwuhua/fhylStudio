        		...
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top:5px;">
					...
					<tr height="30">
        						...
        						<img alt="查询" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'"
                                        ...
                                        <img name="shenPi" id="shenPi" src="/jxzhpt/images/Button/sp1.jpg" onmouseover="this.src='/jxzhpt/images/Button/sp2.jpg'" onmouseout="this.src='/jxzhpt/images/Button/sp1.jpg'   " src="" onclick="plshyb('zhfz');" style="border-width:0px;vertical-align:middle;"" />
                                                					</p>
        				</td></tr></table></div>
        			</fieldset>
        		</td>
