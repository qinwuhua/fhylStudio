...
<script type="text/javascript">
	...
	function shty(){
		...
		var data="gcglxmjd.id="+data1.id+"&gcglxmjd.xmbm="+parent.parent.obj1.XMBM+"&gcglxmjd.sbzt=1"+"&gcglxmjd.shzt=1"+"&gcglxmjd.zgshzt=1"+"&gcglxmjd.shyj="+data1.shyj+"&gcglxmjd.zgshyj="+$("#cscyj").val()+"&gcglxmjd.thyy=";
