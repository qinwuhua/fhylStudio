...
function zjbf_shbty(){
	...
	var data="gcglxmjd.id="+data1.id+"&gcglxmjd.xmbm="+parent.parent.obj1.XMBM+"&gcglxmjd.sbzt=1"+"&gcglxmjd.shzt=0"+"&gcglxmjd.zgshzt=0"+"&gcglxmjd.shyj="+"&gcglxmjd.zgshyj="+"&gcglxmjd.thyy="+$("#thyy").val();
