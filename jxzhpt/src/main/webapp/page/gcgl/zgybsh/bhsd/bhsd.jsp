...
<body>
    <div id="righttop">
		<div id="p_top">进度报表>&nbsp;<span id="astext">进度审核</span>>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;病害隧道</div>
	</div>
        	...
        	<tr>
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top:5px;">
					...
					<tr height="30">
        					...
        					<tr height="30">
        						<td>隧道名称：</td>
        							<td><input type="text" id="sdmc" style="width: 150px;" ></td>
        						<td>隧道代码：</td>
        							<td><input type="text" id="sddm"  style="width: 80px;"></td>
        						</tr>
        						<tr height="30">
        						<td colspan="10">
