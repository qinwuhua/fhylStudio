...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;<span id="astext">进度审核</span>>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;危桥改造工程项目</div>
					</div>
        	...
        	<tr>
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top:5px;">
					...
					<tr height="30">
        						...
        						<td><input type="text" id="qlmc" style="width:80px;"></td>
        						
        						</tr>
        							<tr height="30">
        							<td align="right">项目年份：</td>
        						<td><select name="ddlYear" id="ddlYear" style="width: 150px;">
        						...
        						<td><input type="text" id="qlbm" style="width: 80px;"></td>
        							
								</tr>
								<tr height="30">
								<td align="right">月报状态：</td>
        						<td><select id="ybzt" style="width: 150px;">
        							<option value="">全&nbsp;&nbsp;部</option>
        							<option value="已上报">已上报</option>
        							<option value="未上报">未上报</option>
        						</select></td>
								<td align="right">项目库类型：</td>
								<td><select class="easyui-combobox" id='xmklx' style="width: 120px;">
        						...
        						<img alt="查询" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'"
                                        ...
                                        <img name="shenPi" id="shenPi" src="/jxzhpt/images/Button/sp1.jpg" onmouseover="this.src='/jxzhpt/images/Button/sp2.jpg'" onmouseout="this.src='/jxzhpt/images/Button/sp1.jpg'   " src="" onclick="plshyb('wqgz');" style="border-width:0px;vertical-align:middle;"" />       					</p>
        		</td></tr></table>		</div>
        			</fieldset>
        		</td>
        	</tr>
            ...
            <tr>
                <td width="100%" style="padding-top: 7px;padding-left:10px;">
                    <div>
						<table id="datagrid" >
						</table>
					</div>
