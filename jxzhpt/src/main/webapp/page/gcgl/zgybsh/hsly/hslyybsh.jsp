...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/easyui/easyui-lang-zh_CN.js">
	</script><script type="text/javascript" src="../../../../js/util/jquery.cookie.js"></script>
	
	<script type="text/javascript" src="js/hsly.js"></script>
	<script type="text/javascript">
		$(function(){
			var data=parent.obj;
			$("#sh_bfzj").text(data.bfzj);
...
<!-- /*                                 color: #007DB3; font-weight: bold; font-size: small; text-align: right; background-color: #F1F8FF; */ -->
<!--                                 padding-right: 5px;"> -->
<!--                                 <b><font color="#009ACD" style="cursor: hand; font-size: 12px">审核意见：</font></b> -->
<!--                             </td> -->
<!--                             <td style="border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; border-top: 1px none #C0C0C0; -->
<!--                                 border-bottom: 1px solid #C0C0C0; text-align: left; padding-left: 10px;" colspan="5"> -->
...
<!--                         </tr> -->
                    ...
                    <table width="100%" border="0" style="border-style: solid; border-width: 3px 1px 1px 1px;
                        ...
                        <tr style="height: 30px;">
                            <td align="center">
                                <img src="${pageContext.request.contextPath}/images/Button/baocun1.gif" id="Img1" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/baocun2.gif'" alt="保存" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/baocun1.gif'" style="cursor: hand" onclick="shhslyyb();" />
