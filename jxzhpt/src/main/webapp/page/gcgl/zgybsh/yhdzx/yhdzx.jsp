...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
				<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;<span id="astext">进度审核</span>>&nbsp;<span id="bstext"></span>>&nbsp;养护大中修工程项目</div>
			</div>
        	...
        	<tr>
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top:5px;">
					...
					<tr height="30">
								...
								<td><select name="ddlPDDJ" id="ddlPDDJ" style="width:60px; vertical-align:middle;"></select></td>
								<td align="right">原行政等级：</td>
								<td><select name="ddlGldj" id="ddlGldj" style="width:75px; vertical-align:middle;"></select></td>
        						...
        						<td><input type="text" id="xmmc" style="width:73px;" /></td>
