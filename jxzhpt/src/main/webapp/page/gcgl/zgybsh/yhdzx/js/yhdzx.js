function urlxmnf(id,flag){
	...
	if(flag=='01011201020101'||flag=='0101120102010101'||flag=='0101120102010102'||
		...
		flag=='01011501020102'||flag=='010115010202'||flag=='010115010206'||flag=='010114020402'
	){
...
function showAll(){
	...
	$('#datagrid').datagrid({    
	    ...
	    queryParams: {
	    	...
	    	'gcglyhdzx.xmzt':$("#xmzt").combobox('getText')
		},
...
function showYBlist(){
	$('#ybgrid').datagrid({    
	    url:'../../../../gcgl/selYhdzxZgYbByJhid.do?jhid='+parent.obj1.XMBM,
	    striped:true,
	    pagination:true,
	    rownumbers:true,
	    pageNumber:1,
