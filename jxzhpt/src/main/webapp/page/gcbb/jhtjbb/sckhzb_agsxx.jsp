...
var xzqhdm=$("#xzqh").combotree("getValues");
	...
	$.ajax({
		type:'post',
		url:'/jxzhpt/gcbb/getSckhzbAgsxx.do',
		dataType:"json",
				...
				for(var i=0;i<msg.length;i++){
					...
					if(i!=0){
						if(i==1||i==5||i==8){
							if(i=1){
								str+="<tr align='center'>"+
								"<td rowspan='4'>"+msg[i].v_0+"</td>"+
								"<td>"+msg[i].v_1+"</td>"+
								"<td>"+parseInt(msg[i].v_2)+"</td>"+
								"<td>"+msg[i].v_3+"</td>"+
								"<td>"+msg[i].v_4+"</td>"+
								"<td>"+msg[i].v_5+"</td>"+
							"</tr>";
...
var xzqhdm=$("#xzqh").combotree("getValues");
	...
	$.post('/jxzhpt/gcbb/exportbbsj_set.do',{gydw:gydwstr,xzqh:xzqhstr},function(){
		window.location.href='/jxzhpt/gcbb/getJckhzbAgsxx.do?'+data;
	 });
