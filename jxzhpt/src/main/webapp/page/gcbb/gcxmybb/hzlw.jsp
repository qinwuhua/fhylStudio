...
<%-- 	<script type="text/javascript" src="${pageContext.request.contextPath}/page/qqgl/lxsh/js/sjgz.js"></script> --%>
	...
	function ybyf(id){
		...
		function showAll(){
			...
			var tbody = $("#wqgzlist");
			tbody.empty();
			var data="flag=&gcglwqgz.xmnf="+xmnf+"&gcglwqgz.ybnf="+$("#ybnf").combobox('getValue')+"&gcglwqgz.ybyf="+$("#ybyf").combobox('getValue')+"&gcglwqgz.xmlx="+$("#xmlx").combobox('getValue');
			//alert(data);
			$.ajax({
	...
	function exportWqgzyb(){
		...
		var data="flag=flag&gcglwqgz.xmnf="+xmnf+"&gcglwqgz.ybnf="+$("#ybnf").combobox('getValue')+"&gcglwqgz.ybyf="+$("#ybyf").combobox('getValue')+"&gcglwqgz.xmlx="+$("#xmlx").combobox('getValue');
		window.location.href="/jxzhpt/gcybb/getHzlw.do?"+data;
	}	
	</script>
	<style type="text/css">
<!--
	...
	<div style="text-align: left; font-size: 12px; margin: 0px;" >
		<table width="100%" border="0" style="margin-top: 1px; margin-left: 1px;height:100%;" cellspacing="0" cellpadding="0" >
			...
			<div id="righttop"  style="height: 30px">
						<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;<span id="astext">生成报表</span>>&nbsp;<span id="bstext"></span>>&nbsp;路网结构改造项目</div>
					</div>
        	</tr>
        	<tr>
