...
<%-- 	<script type="text/javascript" src="${pageContext.request.contextPath}/page/qqgl/lxsh/js/sjgz.js"></script> --%>
	...
	function exportWqgzyb(){
		...
		window.location.href="/jxzhpt/gcybb/getHzzh.do?"+data;
	}	
	</script>
	<style type="text/css">
<!--
	...
	<div style="text-align: left; font-size: 12px; margin: 0px;" >
		<table width="100%" border="0" style="margin-top: 1px; margin-left: 1px;height:100%;" cellspacing="0" cellpadding="0" >
			...
			<div id="righttop"  style="height: 30px">
						<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;<span id="astext">生成报表</span>>&nbsp;<span id="bstext"></span>>&nbsp;中央车购税灾毁</div>
					</div>
        	</tr>
        	<tr>
                	...
                	$("#gddiv").attr('style','width:100%;height:'+($(window).height()-110)+'px');
                		...
                		<div  class="easyui-layout" fit="true" >
							...
							<table id="kdtb" width="2000px" >
								<caption align="top" style="font-size:x-large;font-weight: bolder;">中央车购税灾毁</caption>
								<thead id="biaotou">
									<tr>
