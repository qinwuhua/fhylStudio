...
<title>公路路网结构改造工程(危桥改造)统计月报表字段选择</title>
...
<script type="text/javascript">
	$(function(){
        ...
        createtree('tt','./json/wqgz_pfqk.json'); 
        createtree('tt1','./json/wqgz_ssqk.json'); 
	});
	...
	function search(){
		...
		if(parent.YMLib.Var.flag=='flag'){
			...
			$.ajax({
				data:'excel_list.name='+str+"&excel_list.ssbb=wqgzybb",
				type:'post',
				dataType:'json',
