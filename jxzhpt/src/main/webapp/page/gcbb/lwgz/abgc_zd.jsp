...
<title>公路路网结构改造工程(安保工程)统计月报表字段选择</title>
...
<script type="text/javascript">
	$(function(){
        ...
        createtree('tt','./json/abgc_pfqk.json'); 
        createtree('tt1','./json/abgc_ssqk.json'); 
	});
	...
	function search(){
		...
		if(parent.YMLib.Var.flag=='flag'){
			...
			$.ajax({
				data:'excel_list.name='+str+"&excel_list.ssbb=abgcybb",
				type:'post',
				dataType:'json',
