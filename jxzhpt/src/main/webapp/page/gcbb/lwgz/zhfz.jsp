...
var xzqhdm=$("#xzqh").combotree("getValues");
	...
	loadjzt();
	 $.post('/jxzhpt/gcbb/exportbbsj_set.do',{gydw:gydwstr,xzqh:xzqhstr,nameValue:str1,colValue:str2,sql:json_data},function(){
		window.location.href='/jxzhpt/gcybb/getLwgzZhfzybb.do?'+data;
	 }); 
...
function wcmxb(){
	YMLib.Var.flag='';
	YMLib.UI.createWindow('zdybb','公路路网结构改造工程（危桥改造）统计月报表字段选择','zhfz_zd.jsp','zdybb','680','380');
}
...
var xzqhdm=$("#xzqh").combotree("getValues");
	...
	loadjzt();
	$.ajax({
		url:"/jxzhpt/gcybb/getLwgzZhfzybb.do",
		data:data,
		type:"post",
		dataType:"JSON",
...
<body style="padding-right:1px">
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.9%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
					<div id="righttop">
						<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;生成报表>&nbsp;月报表>&nbsp;公路路网结构改造工程（灾害防治）统计月报表</div>
					</div>
        	</tr>
        	<tr>
                	...
                	<div id="gddiv" style="width:100%;height: 380px;" >
                		...
                		<div class="easyui-layout"  fit="true">
							...
							<table id='bbtable' width="8000px">
								<caption align="top" style="font-size:x-large;font-weight: bolder;">公路路网结构改造工程（灾害防治）统计月报表</caption>
								<tbody id='biaotou'>
									<tr>
