...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<title>普通国省干线公路灾毁恢复建设任务完成情况表</title>
...
// 			loadDist("xzqh",$.cookie("dist"));
	...
	function exportWqgzyb(){
		...
		var data="flag=flag&gcglwqgz.tiaojian="+"&gcglwqgz.xmnf="+xmnf+"&gcglwqgz.ybnf="+$("#ybsj").datebox("getValue").substr(0,4)+"&gcglwqgz.ybyf="+$("#ybsj").datebox("getValue").substr(5,2)+"&gcglwqgz.ybsj="+$("#ybsj").datebox('getValue');
		window.location.href="/jxzhpt/gcybb/getZhhfwcb.do?"+data;
	}	
...
<body style="padding-right:1px">
	<div style="text-align: left; font-size: 12px; margin: 0px;" >
		<table width="100%" border="0" style="margin-top: 1px; margin-left: 1px;height:100%;" cellspacing="0" cellpadding="0" >
			<tr>
			<div id="righttop"  >
						<div id="p_top">当前位置>&nbsp;进度报表>&nbsp;<span id="astext">生成报表</span>>&nbsp;<span id="bstext"></span>&nbsp;普通国省干线公路灾毁恢复建设任务完成情况表</div>
					</div>
        	</tr>
        	<tr>
                	...
                	$("#gddiv").attr('style','width:100%;height:'+($(window).height()-126)+'px');
                		...
                		<div  class="easyui-layout" fit="true" >
							...
							<table id="kdtb" width="6000px" >
								<caption align="top" style="font-size:x-large;font-weight: bolder;">全省普通国省干线灾毁恢复完成情况表</caption>
								<thead id="biaotou">
									<!-- <tr>
