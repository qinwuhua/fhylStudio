...
function showAlljc(){
	$('#datagrid').datagrid({    
	    ...
	    columns:[[
	        ...
	        {field:'qlbm',title:'起点桩号',width:110,align:'center'},
	        {field:'qlmc',title:'止点桩号',width:110,align:'center'},
	        {field:'qlzxzh',title:'总里程',width:110,align:'center'},
	        {field:'xjnd',title:'隐患里程',width:110,align:'center'},
	        {field:'qlqc',title:'修建/改建年度',width:110,align:'center'},
	        {field:'qlqk',title:'隐患内容',width:110,align:'center'},
...
function showAlljh(){
	$('#datagrid').datagrid({    
	    ...
	    columns:[[
			...
			{field:'qlzxzh',title:'总里程',width:110,align:'center'},
			{field:'xjnd',title:'隐患里程',width:110,align:'center'},
	        {field:'sjdw',title:'设计单位',width:110,align:'center'},
	        {field:'qlqc',title:'设计批复单位',width:110,align:'center'},
	        {field:'qlqk',title:'批复文号',width:110,align:'center'},
...
function showAllsc(){
	$('#datagrid').datagrid({    
	    ...
	    columns:[[
	        ...
	        {field:'xjnd',title:'隐患里程',width:110,align:'center'},
	        {field:'qlqc',title:'修建/改建年度',width:110,align:'center'},
	        {field:'kjzc',title:'方案评估单位',width:110,align:'center'},
	        {field:'dkzdkj',title:'方案审查单位',width:110,align:'center'},
	        {field:'kjfl',title:'方案审批时间',width:110,align:'center'},
	        {field:'sbjgxs',title:'审批文号',width:110,align:'center'},
