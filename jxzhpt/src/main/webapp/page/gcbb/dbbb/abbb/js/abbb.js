...
function showAlljh(){
	$('#datagrid').datagrid({    
	    ...
	    columns:[[
	        ...
	        {field:'jhsybbzje',title:'计划使用部补助金额（万元）',width:170,align:'center'},
	        {field:'jhsydfzczj',title:'计划使用地方自筹资金（万元）',width:170,align:'center'},
