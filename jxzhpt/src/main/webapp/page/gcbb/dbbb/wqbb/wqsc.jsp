...
<body style="padding-right:1px">
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="100%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			<tr>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;工程报表>&nbsp;对部报表>&nbsp;危桥审查库报表</div>
					</div>
        	</tr>
        	<tr>
        						...
        						<select id="xmnf" style="width:80px;">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									 ...
									 <img alt="导出Ecel" src="${pageContext.request.contextPath}/images/Button/dcecl1.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/dcecl2.gif'"
                                        onmouseout="this.src='${pageContext.request.contextPath}/images/Button/dcecl1.gif' " onclick="exportExcel_wqsc()" style="vertical-align: -50%;" />
        					</p>
        				</div>
        			</fieldset>
        		</td>
            ...
            <tr>
            	<td style="padding-top: 10px;padding-left:10px;padding-right:10px;">
							<p align="center" style="font-size:x-large;font-weight: bolder;">危桥审查库报表</p><br/>
