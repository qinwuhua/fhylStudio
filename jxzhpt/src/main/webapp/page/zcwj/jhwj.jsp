...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript">
		...
		function showAll(){
			...
			$('#datagrid').datagrid({    
			    url:'/jxzhpt/wjxt/selectjhwjlist.do',
			    striped:true,
			    pagination:true,
			    rownumbers:true,
			    pageNumber:1,
		...
		function xxtztj(){
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '计划文件添加',
				page : 'jhwj_add.jsp?url='+"/jxzhpt/wjxt/uploadWjFile.do"+'&flag=jhwj.jsp'+'&id='+new Date().getTime(),
				width : 570,
				height : 340,
				top : 0,
				rang : true,
		...
		function editwj(index){
			...
			var weatherDlg = new J.dialog( {
				id : 'id2',
				title : '计划文件编辑',
				page : 'jhwj_xg.jsp?url='+"/jxzhpt/wjxt/uploadWjFile.do"+'&flag=jhwj.jsp'+'&id='+data.id,
				width : 570,
				height : 340,
				top : 0,
				rang : true,
		...
		function ckwj(index){
			var data=$("#datagrid").datagrid('getRows')[index];
			obj=data;
			YMLib.UI.createWindow('zcwj','计划文件详情','jhwj_ck.jsp','zcwj',730,300);
		}
	</script>
	<style type="text/css">
<!--
...
<body>
	<div style="text-align: left; font-size: 12px; margin: 0px;">
		<table width="99.8%" border="0" style="margin-top: 1px; margin-left: 1px;" cellspacing="0" cellpadding="0">
			...
			<td>
			<div id="righttop">
						<div id="p_top">当前位置>&nbsp;文件管理>&nbsp;计划文件</div>
			</div>
	           </td>
        	</tr>
        	<tr>
