...
<body id="index_layout" class="easyui-layout">
    <div data-options="region:'west',split:false, iconCls: 'icon-west'" style="width:253px;overflow:hidden">
		<div id="aa" fit="true" class="easyui-accordion" style="width:251px;">  
		    <div id="left_menu1" title="基础库统计分析" data-options="iconCls:'icon-save',selected:true" style="overflow:auto;text-align: center;">
		    	
		    </div>
		    <div id="left_menu2" title="计划库统计分析" data-options="iconCls:'icon-save',selected:true" style="overflow:auto;text-align: center;">
		    
		    </div>
		    <div id="left_menu3" title="工程库统计分析" data-options="iconCls:'icon-save',selected:true" style="overflow:auto;text-align: center;">
