...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			setxmnf("xmnf",urlid);
			setTimeout("showAllxjDs()",'1700');
			//showAllxj();
		});
		function showAllxjDs(){
			showgjtj('xj');
...
//					    {field : 'dfzc',title : '地方自筹',width : 100,align : 'center'},
		...
		function dsxjxiangxi(index){
			var data=$("#datagrid").datagrid('getRows')[index];
			obj=data;
			YMLib.UI.createWindow('lxxx','五年规划详细信息','/jxzhpt/page/wngh/wnjh/xj_xx.jsp','lxxx',900,360);
		}
		function Lsjl(xmbm){
			YMLib.Var.xmbm=xmbm;
		...
		function tjxjlx(index){
			var data=$("#datagrid").datagrid('getRows')[index];
			obj=data;
			YMLib.UI.createWindow('lxxx','添加路线','/jxzhpt/page/wngh/wnjh/xjlx_add.jsp','lxxx',900,380);
		}
