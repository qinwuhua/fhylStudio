			...
			$('#datagrid').datagrid({    
			    ...
			    columns:[[
			        ...
			        {field:'c',title:'操作',width:80,align:'center',formatter:function(value,row,index){
		 	        	return '<a style="text-decoration:none;color:#3399CC;" href="#" onclick="dingwei('+index+')">定位</a>   '+'<a style="text-decoration:none;color:#3399CC;" href="#" onclick="dssjxiangxi('+index+')">详细</a>    ';
			        }},
					...
					{field : 'xmklx',title : '项目库类型',width : 70,align : 'center'},
