...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			setxmnf("xmnf",urlid);
			setTimeout("showAlllmJh()",'1700');
			//showAlllm();
		});
		
		function showAlllmJh(){
        			...
        			<fieldset id="searchField" style="width:99.3%; text-align: left; vertical-align: middle;">
        				...
        				<div>
        					...
        					<tr height="28">
								...
								<td>
									<select id='xmklx' class="easyui-combobox"  style="width: 78px;" data-options="editable:false,panelHeight:'auto'">
        					...
        					<tr height="28">
                              ...
                              <td colspan="10">
        						<img onclick="showAlllmJh()" alt="搜索" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/Serch01.gif'" style="vertical-align:middle;"/>
