...
function setxmnf(id,flag){
	...
	if(flag=='010111010101'||flag=='01011101010101'||flag=='01011101010102'||flag=='01011101010103'||flag=='010111010104'||flag=='01011101010401'||flag=='01011101010402'||flag=='01011101010403'||flag=='010111010105'||flag=='01011101010501'||flag=='01011101010502'||flag=='01011101010503'){
		$("#bstext").html('十三五');
		for(var i=0;i<5;i++){
			if(i==0){
	...
	if(flag=='010111020101'||flag=='01011102010101'||flag=='01011102010102'||flag=='01011102010103'||flag=='010111020105'||flag=='01011102010501'||flag=='01011102010502'||flag=='01011102010503'){
		$("#bstext").html('十四五');
		for(var i=0;i<5;i++){
			if(i==0){
				first=myDate.getFullYear()-i;
