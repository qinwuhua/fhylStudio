...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			setxmnf("xmnf",urlid);
			setTimeout("showAllgjJh()",'1700');
// 			showAllgj();
		});
		
		function showAllgjJh(){
			showgjtj('sjgz');
        		...
        		<td align="left" style="padding-left: 10px; padding-top: 5px;height: 130px;">
        			<fieldset id="searchField" style="width:99.3%; text-align: left; vertical-align: middle; ">
        				...
        				<div>
        					...
        					<tr height="28">        														
                              <td colspan="10">
        						<img onclick="showAllgjJh()" alt="搜索" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/Serch01.gif'" style="vertical-align:middle;"/>
