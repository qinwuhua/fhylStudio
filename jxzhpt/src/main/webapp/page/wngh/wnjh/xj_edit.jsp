...
<script type="text/javascript">
	...
	function saveLxsh(){
		...
		+$("#gydw").combobox("getValues").join(',')+"&lxsh.xzqhdm="+xzqhdm+"&lxsh.xzqhdm2="+$("#xzqh").combobox("getValues").join(',')+"&lxsh.tsdq="+$("#tsdq").val()
		...
		"&lxsh.yhdk="+$('#yhdk').val()+"&lxsh.gz="+$('#gz').val()+"&lxsh.sz="+$('#sz').val()+"&lxsh.xmklx="+$('#xmklx').combobox('getValue')+"&lxsh.ghxlxmc="+$('#ghxlxmc').val()+"&lxsh.ghxlxbm="+$('#xjlxbm').val();
...
<form action="" id="lxsh">
	<table style="width: 100%; background-color: #aacbf8; font-size: 12px"
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" id="ghxlxmc" name='ghxlxmc' style="width: 120px"/>
				</td>
			...
			<tr style="height: 35px;">
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" name="gxlxbm" id="gxlxbm" style="width: 120px"/>
				</td>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">
					<font color='red' size='2'>*&nbsp;</font>共线起点桩号：</td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<input type="text" name="gxqdzh" id="gxqdzh" style="width: 120px"/>
				</td>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">
			...
			<tr style="height: 35px;">
			    ...
			    <td rowspan="2" style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right">
					特殊地区：</td>
				<td rowspan="2" style="background-color: #ffffff; height: 20px;width:18%" align="left">
