...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;计划申报>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;病害隧道项目</div>
	</div>
        		...
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top: 10px;">
        			<fieldset id="searchField" style="width:100%; text-align: left; vertical-align: middle;border:1px solid #e4e5e6;">
        				...
        				<div>
        						...
        						<td  colspan="3" ><select id="gydw" style="width:177px;"></select> </td>
        					...
        					<tr height="32">
        						...
        						<td><input name="sddm" type="text" id="sddm" style="width:50px;" /></td>
        						<td align="right">计划年份：</td>
        						<td><select id="sbnf" style="width: 50px;"></select></td>
        						<td align="right">计划状态：</td>
        						<td><select name="ddlSHZT" id="ddlSHZT" style="width:60px;" class="easyui-combobox">
								...
								<td><select name="ddlPDDJ" id="ddlPDDJ" style="width:55px;" class="easyui-combobox">
								</select></td>
								</tr>
