...
<head>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			var jh={xmlx:'af',jhnf:$('#sbnf').combobox("getValue"),sbzt:null,spzt:'0',jh_sbthcd:0,sfylsjl:$('#sfylsjl').combo("getValue")};
		...
		function searchAbgctj(){
			var jh={xmlx:'af',jhnf:$('#sbnf').combobox("getValue"),sbzt:null,spzt:null,jh_sbthcd:0,sfylsjl:$('#sfylsjl').combo("getValue")};
			if(!xian){
				jh.jh_sbthcd=2;
			}
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;项目计划库上报>&nbsp;安防工程项目</div>
	</div>
