...
<body>
	<div style="text-align: center;">
		<table width="97%" height="90%" cellpadding="0" cellspacing="0"
				...
				<td align="center">
					...
					<table width="100%" height="90%" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<td><span id="rpZJXX_ctl01_XDZJ" style="font-size: 10pt;">200</span>
							</td>
						...
						<tr>
							...
							<td><span id="rpZJXX_ctl02_XDZJ" style="font-size: 10pt;">1000</span>
							</td>
						...
						<tr>
							<td><a id="rpZJXX_ctl03_btnEdit"
								...
								style="color: #0066CB;">编辑</a> &nbsp;|&nbsp; <a
								onclick="return CheckDel(&quot;2014&quot;,&quot;1&quot;);"
								id="rpZJXX_ctl03_btnDel" disabled="disabled"
								style="color: #0066CB;">删除</a></td>
							<td><span id="rpZJXX_ctl03_SFZJ" style="font-size: 10pt;">是</span>
							</td>
							<td><span id="rpZJXX_ctl03_XDNF" style="font-size: 10pt;">2014</span>
							</td>
							<td><span id="rpZJXX_ctl03_XDZJ" style="font-size: 10pt;">100</span>
							</td>
			...
			<tr>
				<td>共 <span id="lblcount">3</span>条记录，当前 <span id="lblcurrent">1/1</span>页&nbsp;&nbsp;
					<a id="hlfist" disabled="disabled">首页</a>&nbsp; <a id="hlprev"
					disabled="disabled">上一页</a>&nbsp; <a id="hlnext"
					disabled="disabled">下一页</a>&nbsp; <a id="hllast"
					disabled="disabled">末页</a>&nbsp;&nbsp; <select name="ddlPage"
					...
					<table>
						<tr>
							<td><img id="imgAdd"
								...
								onClick="AddInfo()" src="${pageContext.request.contextPath}/images/Button/tianj1.gif"
