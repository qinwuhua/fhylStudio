	...
	<div>
		...
		<tr>
			<td style="text-align: left; padding-left: 20px; font-size: 12px;">
				...
				id="lblXDZJ" style="font-weight: bold; color: #FF0000">30</span>&nbsp;】万元。
			</td>
		</tr>
		<tr>
			<td align="center">
				...
				<table width="100%" height="90%" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td><span id="rpZJXX_ctl01_XDZJ" style="font-size: 10pt;">10</span>
						</td>
					...
					<tr>
						...
						<td><span id="rpZJXX_ctl02_XDZJ" style="font-size: 10pt;">20</span>
						</td>
