		...
		<table width="97%" height="90%" cellpadding="0" cellspacing="0"
				...
				<td>
					<table width="100%" border="0"
						...
						<tr style="height: 50px;">
							...
							<td colspan="5"
								style="border-left: 1px solid #C0C0C0; border-top: 1px solid #C0C0C0; text-align: left; padding-left: 10px;"
								class="style1"><span id="Lab_BZ">g</span>&nbsp;</td>
						</tr>
					</table>
				</td>
			</tr>
			...
			<tr>
				<td style="text-align: left; padding-left: 20px; font-size: 12px;">
					...
					id="lblXDZJ" style="font-weight: bold; color: #FF0000">2</span>&nbsp;】万元。
				</td>
			</tr>
			<tr>
				<td align="center">
					...
					<table width="100%" height="90%" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td><a id="rpZJXX_ctl01_btnEdit"
								...
								id="rpZJXX_ctl01_btnDel"
								href="javascript:__doPostBack('rpZJXX$ctl01$btnDel','')"
							...
							<td><span id="rpZJXX_ctl01_XDZJ" style="font-size: 10pt;">1</span>
							</td>
						...
						<tr>
							...
							<td><span id="rpZJXX_ctl02_XDZJ" style="font-size: 10pt;">1</span>
							</td>
