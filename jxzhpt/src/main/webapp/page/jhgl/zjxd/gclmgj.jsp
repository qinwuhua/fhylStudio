	...
	<div>
		<table width="100%" border="0"
			...
			<tr style="height: 25px;">
				<td colspan="6"
					...
					<span id="lblName2">工程改造路面改建项目基本信息</span>
				</td>
			</tr>
		...
		<tr>
			<td style="text-align: left; padding-left: 20px; font-size: 12px;">
				...
				style="font-weight: bold; color: #FF0000">4</span>&nbsp;】个下发信息，下发资金共【&nbsp;<span
				id="lblXDZJ" style="font-weight: bold; color: #FF0000">53</span>&nbsp;】万元。
			</td>
		</tr>
		<tr>
			<td align="center">
