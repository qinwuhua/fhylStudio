						...
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr>
								<td align="left" nowrap="nowrap" style="width: 50%;"><span
									id="lblGKBG_GK">暂无附件！</span> </td>
								<td align="left">
								<a onclick="uploadFile('gkbg')" id="gkbg" href="#" style="color: #2C7ED1;">上传</a>
									&nbsp;|&nbsp;删除</td>
							</tr>
						</table>
					</div>
					...
					<div id="divSJSGT_TJ" style="display: block;">
						<table width="100%" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td align="left">
								<a onclick="uploadFile('jhsgt')" id="jhsgt" href="#" style="color: #2C7ED1;">上传</a>
									&nbsp;|&nbsp;删除</td>
							</tr>
						</table>
					</div>
