...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			var jh={xmlx:'af',jhnf:xmnf,jh_sbthcd:6,sfylsjl:$('#sfylsjl').combo("getValue")};
		...
		function searchAbgc(){
			...
			if(tsdq.substr(0,1)==',')
				tsdq=tsdq.substr(1,tsdq.length);
			var jh={xmlx:'af',jhnf:xmnf,jh_sbthcd:6,kgzt:null,jgzt:null,sfylsjl:$('#sfylsjl').combo("getValue")};
			var lx={gydwbm:getgydw("gydw"),xzqhdm:getxzqhdm('xzqh'),lxmc:null,lxjsdj:jsdj,lxbm:null,gldj:gldj,tsdq:tsdq,'lx.xmklx':$("#xmklx").combobox('getValue')};
			if($('#txtRoad').val()!=""){
				lx.lxmc=$('#txtRoad').val();
			}
			if($('#lxbm').val()!=""){
		...
		function queryMessage(jh,lx){
			var param={"jh.xmlx":jh.xmlx,"jh.sbzt":jh.sbzt,"jh.spzt":jh.spzt,"jh.jhnf":jh.jhnf,'jh.sfylsjl':jh.sfylsjl,
					...
					"lx.lxbm":lx.lxbm,"lx.tsdq":lx.tsdq,"jh.jh_sbthcd":jh.jh_sbthcd,xmklx:$("#xmklx").combobox('getValue')};
			$.ajax({
				type:'post',
		...
		function exportExcelZjxd(){
			...
			if(tsdq.substr(0,1)==',')
				tsdq=tsdq.substr(1,tsdq.length);
			var param="jh.jh_sbthcd=6"+"&jh.xmlx=af"+"&lx.gydwdm="+gydwdm+"&lx.gydwbm="+gydwbm+"&lx.xzqhdm="+xzqhdm+
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;计划下达>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;安防工程项目</div>
	</div>
        			...
        			<fieldset id="searchField" style="width:100%; text-align: left; vertical-align: middle;">
        				...
        				<div>
       					...
       					<tr height="28">
        						...
        						<td colspan="3" ><select id="xzqh" style="width:174px;"></select></td>
        					...
        					<tr height="28">
        						...
        						<td><select id="sbnf" style="width: 55px; vertical-align:middle;"></select></td>
								<td align="right">特殊地区</td>
								<td><select name="ddlTSDQ" id="ddlTSDQ" style="width:70px; vertical-align:middle;">
								</select></td>
								...
								<td><select name="ddlPDDJ" id="ddlPDDJ" style="width:50px; vertical-align:middle;"></select></td>
