...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			tsdq('ddlTSDQ');
			sbnf("sbnf");
			var jh={xmlx:'af',jhnf:$('#sbnf').combobox('getValue'),jh_sbthcd:6,sfylsjl:$('#sfylsjl').combo("getValue")};
			var lx={gydwbm:getgydw("gydw"),xzqhdm:getxzqhdm('xzqh')};
			queryMessage(jh,lx);
			afgcxm_zjxd(jh,lx);
		});
		function searchAbgctj(){
			var jh={xmlx:'af',jhnf:$('#sbnf').combobox('getValue'),jh_sbthcd:6,kgzt:null,jgzt:null,sfylsjl:$('#sfylsjl').combo("getValue")};
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;项目计划库资金下达>&nbsp;安防工程项目</div>
	</div>
