...
function loadJhkxx1(){
	$.ajax({
		 type : "POST",
		 url : "/jxzhpt/jhgl/loadwqgzjhkbyid1.do",
		 dataType : 'json',
		 data : 'id='+parent.obj,
		 success : function(msg){
			 $("#tzsj").html(msg.tzsj);
			 $("#ysfylrbwqk").html(msg.sfylrbwqk);
			 $("#ysbnf").html(msg.sbnf);
			 $("#yjhjsxz").html(msg.jhjsxz);
			 $("#yjhkgsj").html(msg.jhkgsj);
			 $("#yjhwgsj").html(msg.jhwgsj);
			 $("#ysjdw").html(msg.sjdw);
			 $("#ysjpfdw").html(msg.sjpfdw);
			 $("#yjhpfwh").html(msg.pfwh);
			 $("#ypfsj").html(msg.pfsj);
			 $("#ysfsqablbz").html(msg.sfsqablbz);
			 $("#yablbzwh").html(msg.ablbzwh);
			 $("#ypfztz").html(msg.pfztz);
			 if(msg.sfylrbwqk=='是'){
				 $("#ywenz").html('计划使用部补助金额(万元)：');
				 $("#yshengbz").html(msg.jhsybzje);
				 $("#ydfzc").html(accSub(msg.pfztz,msg.jhsybzje));
			 }else{
				 $("#ywenz").html('计划使用省补助金额(万元)：');
				 $("#yshengbz").html(msg.shengbz);
				 $("#ydfzc").html(accSub(msg.pfztz,msg.shengbz));
			 }
			 $("#yqlszxz").html(msg.qlszxz);
			 $("#yjhqlqc").html(msg.jhqlqc);
			 $("#yjhqlqk").html(msg.jhqlqk);
			 $("#yzyjsnr").html(msg.zyjsnr);
			 $("#yjhbz").html(msg.bz);
		 }
	});
}
	...
	$.ajax({
		...
		success:function(msg){
			if(msg){
				...
				parent.tjwqgz();
				parent.$('#wq_edit1').window('destroy');
			}
		}
	});
}
	...
	<body>
		...
		<tr>
			...
			<tr style="height: 30px;">
				...
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<span id="ypfztz"></span></td>
				<td style="background-color:#F1F8FF;color: #007DB3; font-weight: bold;width:15%" align="right"><font id="ywenz">计划使用省补助金额(万元)：</font></td>
				<td style="background-color: #ffffff; height: 20px;" align="left">
					<span id="yshengbz"></span></td>
