        			...
        			<fieldset style="width:99%; text-align: left; vertical-align: middle;">
        				...
        				<div>
							...
							<p style="margin:8px 0px 4px 20px;">
								...
								<img alt="添加" src="${pageContext.request.contextPath}/images/Button/tianjia1.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/tianjia2.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/tianjia1.gif' " onclick="AddBridge()" style="vertical-align:middle;">
