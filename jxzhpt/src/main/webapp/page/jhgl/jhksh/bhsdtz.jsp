...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;计划变更>&nbsp;<span id="bstext"></span>>&nbsp;路网结构工程>&nbsp;病害隧道项目</div>
	</div>
        		...
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top: 8px;">
					...
					<tr height="32">
        				...
        				<tr height="32">
        						...
        						<td align="right">审定状态： </td>
        						<td><select name="ddlSDZT" class="easyui-combobox" id="ddlSDZT" style="width:55px;">
									<option selected="selected" value="">全部</option>
									<option value="未审定">未审定</option>
									<option value="已审定">已审定</option>
								</select> </td>
								<td align="right">技术等级： </td>
								<td><select name="ddlPDDJ" class="easyui-combobox" id="ddlPDDJ" style="width:55px;">
								</select> </td>
								<td >调整类型： </td>
