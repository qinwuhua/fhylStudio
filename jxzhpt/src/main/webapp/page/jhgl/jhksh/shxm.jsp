...
<head>
	...
	<script type="text/javascript">
		...
		function batchSp(){
			...
			$.ajax({
				type:'post',
				url:'../../../jhgl/editShuihStatusBatch.do',
				dataType:'json',
				data:jh,
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;项目计划库审核>&nbsp;水毁项目</div>
	</div>
        		...
        		<td align="left" style="padding-left: 10px; padding-right: 10px;padding-top: 8px;">
        			<fieldset id="searchField" style="width:100%; text-align: left; vertical-align: middle;">
        				...
        				<div>
        					...
        					<p style="margin:8px 0px 4px 20px;">
        						<img onclick="searchShuih()" alt="搜索" src="${pageContext.request.contextPath}/images/Button/Serch01.gif" onmouseover="this.src='${pageContext.request.contextPath}/images/Button/Serch02.gif'" onmouseout="this.src='${pageContext.request.contextPath}/images/Button/Serch01.gif'" style="vertical-align:middle;padding-left: 10px;"/>
	...
	<div id="shxm_sh" style="text-align: left;font-size: 12px;width:80%;"></div>
</body>
</html>
