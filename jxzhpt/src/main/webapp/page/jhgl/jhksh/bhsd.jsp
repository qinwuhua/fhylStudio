...
// 			queryZjqf($('#sbnf').combobox("getValue"));
			...
			var lx={gydwbm:gydw,xzqhdm:xzqh};
				querySumWqgz(jh,lx);
				wqxm_sh(jh,lx);
		});
		function searchWqgz(){
			...
			var lx={gydwbm:gydwstr,xzqhdm:xzqhstr,lxmc:null,jsdj:null,lxbm:null,sdmc:null};
...
// 			queryZjqf($('#sbnf').combobox("getValue"));
		...
		function spBatch(){
			...
			if(confirm('您确定审批该项目？')){
					$.ajax({
						 type : "POST",
						 url : "/nmyhgc/jhgl/xgJhkBhsdBathSp.do",
						 dataType : 'json',
						 data : jh,
