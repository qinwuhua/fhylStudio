...
<head>
	...
	<script type="text/javascript">
		$(function(){
			...
			var jh={xmlx:'af',jhnf:$('#sbnf').combobox("getValue"),sbzt:'1',spzt:null,jh_sbthcd:4,sfylsjl:$('#sfylsjl').combo("getValue")};
		...
		function searchAbgctj(){
			var jh={xmlx:'af',jhnf:null,sbzt:null,spzt:null,jh_sbthcd:4,sfylsjl:$('#sfylsjl').combo("getValue")};
...
<body>
	<div id="righttop">
		<div id="p_top">计划管理>&nbsp;项目计划库审核>&nbsp;安防工程项目</div>
	</div>
