...
<body id="index_layout" class="easyui-layout">
    ...
    <div data-options="region:'south',border:false,split:false" style="height: 25px;line-height: 25px;color:#FFF; background: url(image/footerbg.gif) 0 0 repeat-x; text-align: center;overflow: hidden;">
