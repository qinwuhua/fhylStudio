...
$(function(){
	...
	$("#Menu_1,#Menu_2,#Menu_9,#Menu_8,#Menu_3,#Menu_4,#Menu_5,#Menu_6,#Menu_7,#Menu_10,#Menu_11,#Menu_12,#Menu_13,#Menu_14,#Menu_15").click(function(e){
		$("#Menu_1,#Menu_2,#Menu_9,#Menu_8,#Menu_3,#Menu_4,#Menu_5,#Menu_6,#Menu_7,#Menu_10,#Menu_11,#Menu_12,#Menu_13,#Menu_14,#Menu_15").removeClass('now');
		$("#" + this.id).addClass('now');
	});
    
    $("#Menu_1").click(function () {
        $("#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c1").show();
        if (c1){
    ...
    $("#Menu_2").click(function () {
        $("#c1,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c2").show();
        if (c2) {
    ...
    $("#Menu_9").click(function () {
        $("#c1,#c8,#c2,#c3,#c4,#c5,#c6,#c7,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c9").show();
        if (c2) {
    ...
    $("#Menu_8").click(function () {
        $("#c1,#c2,#c9,#c3,#c4,#c5,#c6,#c7,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c8").show();
        if (c2) {
    ...
    $("#Menu_3").click(function () {
        $("#c1,#c2,#c9,#c8,#c4,#c5,#c6,#c7,#c10,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c3").show();
        if (c3) {
    ...
    $("#Menu_4").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c5,#c6,#c7,#c10,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c4").show();
        if (c4) {
    ...
    $("#Menu_5").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c6,#c7,#c10,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c5").show();
        if (c5) {
    ...
    $("#Menu_6").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c7,#c10,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c6").show();
        if (c6) {
    ...
    $("#Menu_7").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c10,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c7").show();
        if (c7) {
    ...
    $("#Menu_10").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c11,#c12,#c13,#c14,#c15").hide();
        $("#c10").show();
        if (c7) {
    ...
    $("#Menu_11").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c10,#c12,#c13,#c14,#c15").hide();
        $("#c11").show();
        if (c7) {
    ...
    $("#Menu_12").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c10,#c11,#c13,#c14,#c15").hide();
        $("#c12").show();
        if (c7) {
    ...
    $("#Menu_13").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c10,#c11,#c12,#c14,#c15").hide();
        $("#c13").show();
        if (c7) {
    ...
    $("#Menu_14").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c10,#c11,#c12,#c13,#c15").hide();
        $("#c14").show();
        if (c7) {
    ...
    $("#Menu_15").click(function () {
        $("#c1,#c2,#c9,#c8,#c3,#c4,#c5,#c6,#c7,#c10,#c11,#c12,#c13,#c14").hide();
        $("#c15").show();
        if (c7) {
	...
	for(var i=0;i<qx.length;i++){
		...
		if($("#menu_"+qx[i]).html()!=undefined){
			...
			if(flag==false){
				...
				case "15": url="page/newzjbf/Menu.jsp";break;
				}
