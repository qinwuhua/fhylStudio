...
+" select "
        +" jh.xmbm v_1,(select name from xtgl_xzqh where id=lx.xzqhdm) v_2,substr(instr(xzqhmc, '市'),length(xzqhmc)) v_3,lx.lxbm||'  '||cb.xmmc v_4,substr(cb.xmbm,0,4) v_5,"
        ...
        +" jz3.ssdctc v_61,jz3.wkglc v_62,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_63,round(jz4.zycgs/jh.bbzzj*100,0)||'%' v_64,round(jz4.ztz/jh.pfztz*100,0)||'%' v_65,l.bz v_66,lx.xzqhdm v_67,'新建' v_68,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxmc lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm"
        +" from jhsh_xj jh,"
        +" cbsj_xj cb,"
        +" kxxyj_xj kx,"
        +" lxsh_xj l,"
...
+" select "
       ...
       +" decode(l.jsjsdj,'二级',jz4.wcmc,'0') v_56,decode(l.jsjsdj,'三级',jz4.wcmc,'0') v_57,decode(l.jsjsdj,'四级',jz4.wcmc,'0') v_58,jz4.lq v_59,jz4.sn v_60,"
       +" jz3.ssdctc v_61,jz3.wkglc v_62,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_63,round(jz4.zycgs/jh.bbzzj*100,0)||'%' v_64,round(jz4.ztz/jh.pfztz*100,0)||'%' v_65,l.bz v_66,lx.xzqhdm v_67,'改建' v_68,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxmc lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm"
        +" from jhsh_sjgz jh,"
       +" cbsj_sjgz cb,"
       +" kxxyj_sjgz kx,"
       +" lxsh_sjgz l,"
...
+" select "
       ...
       +" jz.ssdctc v_41,jz2.ztz v_42,jz2.bywcmc v_43,jz2.wctze v_44,jz4.ztz v_45,jz4.zycgs v_46,jz4.dfbz v_47,jz4.yhdk v_48,jz4.gz v_49,jz4.sz v_50,jz4.sttx v_51,jz4.qttz v_52,jz4.xmwc v_53,jz4.wcmc v_54,decode(l.jsjsdj,'一级',jz4.wcmc,'0') v_55,"
       +" decode(l.jsjsdj,'二级',jz4.wcmc,'0') v_56,decode(l.jsjsdj,'三级',jz4.wcmc,'0') v_57,decode(l.jsjsdj,'四级',jz4.wcmc,'0') v_58,jz4.lq v_59,jz4.sn v_60,"
      +"  jz3.ssdctc v_61,jz3.wkglc v_62,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_63,round(jz4.zycgs/jh.bbzzj*100,0)||'%' v_64,round(jz4.ztz/jh.pfztz*100,0)||'%' v_65,l.bz v_66,lx.xzqhdm v_67,'路面改造' v_68,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxmc lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm"
       +" from jhsh_lmgz jh,"
       +" cbsj_lmgz cb,"
       +" kxxyj_lmgz kx,"
        +" lxsh_lmgz l,"
...
+" select "
        ...
        +" jz3.ssdctc v_61,jz3.wkglc v_62,decode(lx.xmlc,'0','0',null,'0',round(jz4.wcmc/lx.xmlc*100,0))||'%' v_63,decode(jh.bbzzj,'0','0',null,'0',round(jz4.zycgs/jh.bbzzj*100,0))||'%' v_64,decode(jh.pfztz,'0','0',null,'0',round(jz4.ztz/jh.pfztz*100,0))||'%' v_65,l.bz v_66,lx.xzqhdm v_67,'灾毁重建' v_68,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxmc lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm"
        +" from jhsh_sh jh,"
        +" cbsj_sh cb,"
        +" xmsq_sh l,"
        +" (select xmid jhid,min(xzqh) xzqhmc,min(gydwdm) gydw,min(xzqhdm) xzqhdm,replace(WMSYS.WM_CONCAT(to_char(QDZH)),',','、') QDZH,replace(WMSYS.WM_CONCAT(to_char(lxbm)),',','、') lxbm,replace(WMSYS.WM_CONCAT(to_char(lxmc)),',','、') lxmc,"
