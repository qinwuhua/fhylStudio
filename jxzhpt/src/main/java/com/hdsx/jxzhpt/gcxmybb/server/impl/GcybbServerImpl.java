...
public class GcybbServerImpl extends BaseOperate implements GcybbServer {
	...
	public List<Excel_list> getGlgzxj(Gcglabgc gcglabgc) {
        ...
        +" lx.xzdj v_8,lx.qdzh v_9,lx.zdzh v_10,lx.yjsdj v_11,lx.jsjsdj v_12,cb.jsxz v_13,lx.xmlc v_14,sgt.lc v_15,sgt.qdzh v_16,sgt.zdzh v_17,(nvl(jh.bbzzj,0)+nvl(jh.gz,0)+nvl(jh.sz,0)+nvl(jh.zq,0)+nvl(jh.dk,0)+nvl(jh.jl,0)+nvl(jh.qt,0)+nvl(jh.dfzc,0)+nvl(jh.yhdk,0)) v_18,jh.bbzzj v_19,jh.gz v_20,jh.sz v_21,jh.zq v_22,jh.dk v_23,jh.jl v_24,jh.qt v_25,jh.dfzc v_26,jh.yhdk v_27,xd.bnjh v_28,xd.qzbtz v_29,jz.bndsslc v_30,"
        ...
        +" jh.kgsj v_34,jh.wgsj v_35,(nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)) v_36,cgs.cgs v_37,cgs.gz v_38,cgs.sz v_39,cgs.zq v_40,cgs.dk v_41,cgs.jl v_42,cgs.qt v_43,cgs.dfzc v_44,cgs.yhdk v_45,jz1.xmwc v_46,decode((nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)),'0','0',null, '0',round((jz1.xmwc / (nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0))) * 100),2) v_47,jz1.wcmc v_48,jz1.yiji v_49,"
        +" jz1.erji v_50,jz1.sanji v_51,jz1.siji v_52,jz1.lq v_53,jz1.sn v_54,"
        +" jz.ssdctc v_55,jz2.ztz v_56,jz2.bywcmc v_57,jz2.wctze v_58,(nvl(cgs1.cgs,0)+nvl(cgs1.gz,0)+nvl(cgs1.sz,0)+nvl(cgs1.zq,0)+nvl(cgs1.dk,0)+nvl(cgs1.jl,0)+nvl(cgs1.qt,0)+nvl(cgs1.dfzc,0)+nvl(cgs1.yhdk,0)) v_59,cgs1.cgs v_60,cgs1.gz v_61,cgs1.sz v_62,cgs1.zq v_63,cgs1.dk v_64,cgs1.jl v_65,cgs1.qt v_66,cgs1.dfzc v_67,cgs1.yhdk v_68,jz4.xmwc v_69,jz4.wcmc v_70,jz4.yiji v_71,"
        +" jz4.erji v_72,jz4.sanji v_73,jz4.siji v_74,jz4.lq v_75,jz4.sn v_76,"
        +" jz3.ssdctc v_77,nvl(lx.xmlc,0)-nvl(jz4.wcmc,0) v_78,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_79,decode(jh.bbzzj,'0','0%',null,'0%',round(jz4.zycgs/jh.bbzzj*100,0)||'%') v_80,round(jz4.ztz/jh.pfztz*100,0)||'%' v_81,l.bz v_82,lx.xzqhdm v_83,'新建' v_84,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxbm lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm,(case when kgzt='0' then '未开工' when jgzt='1' then '完工' else '已开工' end) jzzt,substr(jh.xmbm,5,4)||'00' xzqhdm,(select name from xtgl_xzqh where id=substr(jh.xmbm,5,4)||'00') xzqhmc"
        +" from jhsh_xj jh,"
        +" cbsj_xj cb,"
        +" kxxyj_xj kx,"
        +" lxsh_xj l,"
       ...
       +" (select zj.xmid,(sum(nvl(zj.btzzj,0))+sum(nvl(zj.gz,0))+sum(nvl(zj.sz,0))+sum(nvl(zj.zq,0))+sum(nvl(zj.dk,0))+sum(nvl(zj.jl,0))+sum(nvl(zj.qt,0))+sum(nvl(zj.dfzc,0))+sum(nvl(zj.yhdk,0)))  bnjh,sum(zj.btzzj) qzbtz from plan_zjxd zj where zj.xdnf=substr('"+gcglabgc.getSbyf()+"',0,4) group by zj.xmid) xd,"
       ...
       +" ' 0' sttx,sum(g.zjdw_qttz) qttz,sum(g.wc_btz+g.yhdk+g.gz+g.sz+g.wc_qttz) xmwc,(nvl(sum(yiji),0)+nvl(sum(erji),0)+nvl(sum(sanji),0)+nvl(sum(siji),0)) wcmc,sum(lqlmwcqk) lq,(nvl(sum(yiji),0)+nvl(sum(erji),0)+nvl(sum(sanji),0)+nvl(sum(siji),0)-nvl(sum(lqlmwcqk),0)) sn,sum(yiji) yiji,sum(erji) erji,sum(sanji) sanji,sum(siji) siji,sum(g.dwgz) gz,sum(g.dwsz) sz"
      ...
      +"(select xmid jhid,sum(c.ztz) ztz,sum(c.btzzj) cgs,sum(c.gz) gz,sum(c.sz) sz,sum(c.zq) zq,sum(c.dk) dk, sum(c.jl) jl,sum(c.qt) qt,sum(c.dfzc) dfzc,sum(c.yhdk) yhdk from plan_zjxd c where substr(c.xdnf,0,4)=substr('"+gcglabgc.getSbyf()+"',0,4)  group by c.xmid) cgs,"
      +"(select xmid jhid,sum(c.ztz) ztz,sum(c.btzzj) cgs,sum(c.gz) gz,sum(c.sz) sz,sum(c.zq) zq,sum(c.dk) dk, sum(c.jl) jl,sum(c.qt) qt,sum(c.dfzc) dfzc,sum(c.yhdk) yhdk from plan_zjxd c where substr(c.xdnf,0,4)<=substr('"+gcglabgc.getSbyf()+"',0,4) group by c.xmid) cgs1"
      ...
      +" union all"
				+" select "
		        +" jh.xmbm v_1,xzqhmc v_2,substr(instr(xzqhmc, '市'),length(xzqhmc)) v_3,l.tsdq v_4,lx.lxbm v_5,jh.xmmc v_6,substr(cb.xmbm,0,4) v_7,"
		        +" lx.xzdj v_8,lx.qdzh v_9,lx.zdzh v_10,lx.yjsdj v_11,lx.jsjsdj v_12,cb.jsxz v_13,lx.xmlc v_14,sgt.lc v_15,sgt.qdzh v_16,sgt.zdzh v_17,(nvl(jh.bbzzj,0)+nvl(jh.gz,0)+nvl(jh.sz,0)+nvl(jh.zq,0)+nvl(jh.dk,0)+nvl(jh.jl,0)+nvl(jh.qt,0)+nvl(jh.dfzc,0)+nvl(jh.yhdk,0)) v_18,jh.bbzzj v_19,jh.gz v_20,jh.sz v_21,jh.zq v_22,jh.dk v_23,jh.jl v_24,jh.qt v_25,jh.dfzc v_26,decode(jh.yhdk,null,0,jh.yhdk) v_27,xd.bnjh v_28,xd.qzbtz v_29,jz.bndsslc v_30,"
		        +" (case when jh.kgzt='1' and jh.jgzt='0' then '1' else '0' end) v_31,(case when jh.jgzt='1' then '1' else '0' end) v_32,(case when jh.kgzt='0' then '1' else '0' end) v_33,"
		        +" jh.kgsj v_34,jh.wgsj v_35,(nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)) v_36,cgs.cgs v_37,cgs.gz v_38,cgs.sz v_39,cgs.zq v_40,cgs.dk v_41,cgs.jl v_42,cgs.qt v_43,cgs.dfzc v_44,cgs.yhdk v_45,jz1.xmwc v_46,decode((nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)),'0','0',null, '0',round((jz1.xmwc / (nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0))) * 100),2) v_47,jz1.wcmc v_48,jz1.yiji v_49,"
		        +" jz1.erji v_50,jz1.sanji v_51,jz1.siji v_52,jz1.lq v_53,jz1.sn v_54,"
		        +" jz.ssdctc v_55,jz2.ztz v_56,jz2.bywcmc v_57,jz2.wctze v_58,(nvl(cgs1.cgs,0)+nvl(cgs1.gz,0)+nvl(cgs1.sz,0)+nvl(cgs1.zq,0)+nvl(cgs1.dk,0)+nvl(cgs1.jl,0)+nvl(cgs1.qt,0)+nvl(cgs1.dfzc,0)+nvl(cgs1.yhdk,0)) v_59,cgs1.cgs v_60,cgs1.gz v_61,cgs1.sz v_62,cgs1.zq v_63,cgs1.dk v_64,cgs1.jl v_65,cgs1.qt v_66,cgs1.dfzc v_67,cgs1.yhdk v_68,jz4.xmwc v_69,jz4.wcmc v_70,jz4.yiji v_71,"
		        +" jz4.erji v_72,jz4.sanji v_73,jz4.siji v_74,jz4.lq v_75,jz4.sn v_76,"
		        +" jz3.ssdctc v_77,nvl(lx.xmlc,0)-nvl(jz4.wcmc,0) v_78,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_79,decode(jh.bbzzj,'0','0%',null,'0%',round(jz4.zycgs/jh.bbzzj*100,0)||'%') v_80,round(jz4.ztz/jh.pfztz*100,0)||'%' v_81,l.bz v_82,lx.xzqhdm v_83,'改建' v_84,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxbm lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm,(case when kgzt='0' then '未开工' when jgzt='1' then '完工' else '已开工' end) jzzt,substr(jh.xmbm,5,4)||'00' xzqhdm,(select name from xtgl_xzqh where id=substr(jh.xmbm,5,4)||'00') xzqhmc"
		        +" from jhsh_sjgz jh,"
		        +" cbsj_sjgz cb,"
		        +" kxxyj_sjgz kx,"
		        +" lxsh_sjgz l,"
		       ...
		       +" sum(g.bywctze) xmwc,(nvl(sum(yiji),0)+nvl(sum(erji),0)+nvl(sum(sanji),0)+nvl(sum(siji),0)) wcmc,sum(lqlmwcqk) lq,(nvl(sum(yiji),0)+nvl(sum(erji),0)+nvl(sum(sanji),0)+nvl(sum(siji),0)-nvl(sum(lqlmwcqk),0)) sn,sum(yiji) yiji,sum(erji) erji,sum(sanji) sanji,sum(siji) siji"
		...
		+" union all"	
		        ...
		        +" jz.ssdctc v_55,jz2.ztz v_56,jz2.bywcmc v_57,jz2.wctze v_58,(nvl(cgs1.cgs,0)+nvl(cgs1.gz,0)+nvl(cgs1.sz,0)+nvl(cgs1.zq,0)+nvl(cgs1.dk,0)+nvl(cgs1.jl,0)+nvl(cgs1.qt,0)+nvl(cgs1.dfzc,0)+nvl(cgs1.yhdk,0)) v_59,cgs1.cgs v_60,cgs1.gz v_61,cgs1.sz v_62,cgs1.zq v_63,cgs1.dk v_64,cgs1.jl v_65,cgs1.qt v_66,cgs1.dfzc v_67,cgs1.yhdk v_68,jz4.xmwc v_69,jz4.wcmc v_70,jz4.yiji v_71,"
		        +" jz4.erji v_72,jz4.sanji v_73,jz4.siji v_74,jz4.lq v_75,jz4.sn v_76,"
		        +" jz3.ssdctc v_77,nvl(lx.xmlc,0)-nvl(jz4.wcmc,0) v_78,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_79,decode(jh.bbzzj,'0','0%',null,'0%',round(jz4.zycgs/jh.bbzzj*100,0)||'%') v_80,round(jz4.ztz/jh.pfztz*100,0)||'%' v_81,l.bz v_82,lx.xzqhdm v_83,'路面改造' v_84,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxbm lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm,(case when kgzt='0' then '未开工' when jgzt='1' then '完工' else '已开工' end) jzzt,substr(jh.xmbm,5,4)||'00' xzqhdm,(select name from xtgl_xzqh where id=substr(jh.xmbm,5,4)||'00') xzqhmc"
		        +" from jhsh_lmgz jh,"
		        +" cbsj_lmgz cb,"
		        +" kxxyj_lmgz kx,"
		        +" lxsh_lmgz l,"
		      ...
		      +"  where jh.xmbm=cgs.jhid(+) and jh.xmbm=cgs1.jhid(+) and jh.xmbm=cb.xmbm and jh.xmbm = sgt.xmbm(+) and jh.xmbm=kx.xmbm and jh.xmbm=l.xmbm and jh.xmbm=lx.jhid(+) and jh.xmbm=xd.xmid(+) and jh.xmbm=jz.jhid(+) and jh.xmbm=jz1.jhid(+) and jh.xmbm=jz2.jhid(+) and jh.xmbm=jz3.jhid(+) and jh.xmbm=jz4.jhid(+)  and jh.xdzt='1'      "
				...
				+" select "
		        +" jh.xmbm v_1,xzqhmc v_2,substr(instr(xzqhmc, '市'),length(xzqhmc)) v_3,l.tsdq v_4,lx.lxbm v_5,jh.xmmc v_6,substr(cb.xmbm,0,4) v_7,"
		        +" lx.xzdj v_8,lx.qdzh v_9,lx.zdzh v_10,lx.yjsdj v_11,lx.jsjsdj v_12,cb.jsxz v_13,lx.xmlc v_14,null v_15,null v_16,null v_17,(nvl(jh.bbzzj,0)+nvl(jh.gz,0)+nvl(jh.sz,0)+nvl(jh.zq,0)+nvl(jh.dk,0)+nvl(jh.jl,0)+nvl(jh.qt,0)) v_18,jh.bbzzj v_19,jh.gz v_20,jh.sz v_21,jh.zq v_22,jh.dk v_23,jh.jl v_24,jh.qt v_25,0 v_26,0 v_27,xd.bnjh v_28,xd.qzbtz v_29,jz.bndsslc v_30,"
		        +" (case when jh.kgzt='1' and jh.jgzt='0' then '1' else '0' end) v_31,(case when jh.jgzt='1' then '1' else '0' end) v_32,(case when jh.kgzt='0' then '1' else '0' end) v_33,"
		        +" jh.sjkgsj v_34,jh.sjwgsj v_35,(nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)) v_36,cgs.cgs v_37,cgs.gz v_38,cgs.sz v_39,cgs.zq v_40,cgs.dk v_41,cgs.jl v_42,cgs.qt v_43,cgs.dfzc v_44,cgs.yhdk v_45,jz1.xmwc v_46,decode((nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)),'0','0',null, '0',round((jz1.xmwc / (nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0))) * 100),2) v_47,jz1.wcmc v_48,jz1.yiji v_49,"
		        +" jz1.erji v_50,jz1.sanji v_51,jz1.siji v_52,jz1.lq v_53,jz1.sn v_54,"
		        +" jz.ssdctc v_55,jz2.ztz v_56,jz2.bywcmc v_57,jz2.wctze v_58,(nvl(cgs1.cgs,0)+nvl(cgs1.gz,0)+nvl(cgs1.sz,0)+nvl(cgs1.zq,0)+nvl(cgs1.dk,0)+nvl(cgs1.jl,0)+nvl(cgs1.qt,0)+nvl(cgs1.dfzc,0)+nvl(cgs1.yhdk,0)) v_59,cgs1.cgs v_60,cgs1.gz v_61,cgs1.sz v_62,cgs1.zq v_63,cgs1.dk v_64,cgs1.jl v_65,cgs1.qt v_66,cgs1.dfzc v_67,cgs1.yhdk v_68,jz4.xmwc v_69,jz4.wcmc v_70,jz4.yiji v_71,"
		        +" jz4.erji v_72,jz4.sanji v_73,jz4.siji v_74,jz4.lq v_75,jz4.sn v_76,"
		        +" jz3.ssdctc v_77,nvl(lx.xmlc,0)-nvl(jz4.wcmc,0) v_78,round(jz4.wcmc/lx.xmlc*100,0)||'%' v_79,decode(jh.bbzzj,'0','0%',null,'0%',round(jz4.zycgs/jh.bbzzj*100,0)||'%') v_80,round(jz4.ztz/jh.pfztz*100,0)||'%' v_81,l.bz v_82,lx.xzqhdm v_83,'灾毁重建' v_84,lx.gydw gydw,lx.xzqhdm xzqh,lx.lxbm lxmc,substr(jh.xmbm,0,4) xmnf,lx.lxbm lxbm,(case when kgzt='0' then '未开工' when jgzt='1' then '完工' else '已开工' end) jzzt,substr(jh.xmbm,5,4)||'00' xzqhdm,(select name from xtgl_xzqh where id=substr(jh.xmbm,5,4)||'00') xzqhmc"
		        +" from jhsh_sh jh,"
		        +" cbsj_sh cb,"
		        +" kxxyj_sh kx,"
		        +" xmsq_sh l,"
...
+" select "
       ...
       +" jh.kgsj v_27,jh.wgsj v_28,jz1.ztz v_29,jz1.zycgs v_30,jz1.dfbz v_31,jz1.yhdk v_32,jz1.gz v_33,jz1.sz v_34,to_char(jz1.sttx) v_35,jz1.qttz v_36,jz1.xmwc v_37,decode((nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)),'0','0',null, '0',round((jz1.xmwc / (nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0))) * 100),2) v_38,jz1.wcmc v_39,jz1.yiji v_40,"
...
+" select "
       +" jh.xmbm v_1,(select name from xtgl_xzqh where id=lx.xzqhdm) v_2,substr(instr(xzqhmc, '市'),length(xzqhmc)) v_3,l.tsdq v_4,lx.lxbm v_5,jh.xmmc v_6,substr(cb.xmbm,0,4) v_7,"
        +" lx.xzdj v_8,lx.qdzh v_9,lx.zdzh v_10,lx.yjsdj v_11,lx.jsjsdj v_12,cb.jsxz v_13,lx.xmlc v_14,sgt.lc v_15,sgt.qdzh v_16,sgt.zdzh v_17,jh.pfztz v_18,jh.bbzzj v_19,(jh.pfztz-jh.bbzzj) v_20,xd.bnjh v_21,xd.qzbtz v_22,jz.bndsslc v_23,"
        +" (case when jh.kgzt='1' and jh.jgzt='0' then '1' else '0' end) v_24,(case when jh.jgzt='1' then '1' else '0' end) v_25,(case when jh.kgzt='0' then '1' else '0' end) v_26,"
        +" jh.kgsj v_27,jh.wgsj v_28,jz1.ztz v_29,jz1.zycgs v_30,jz1.dfbz v_31,jz1.yhdk v_32,jz1.gz v_33,jz1.sz v_34,jz1.sttx v_35,jz1.qttz v_36,jz1.xmwc v_37,decode((nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0)),'0','0',null, '0',round((jz1.xmwc / (nvl(cgs.cgs,0)+nvl(cgs.gz,0)+nvl(cgs.sz,0)+nvl(cgs.zq,0)+nvl(cgs.dk,0)+nvl(cgs.jl,0)+nvl(cgs.qt,0)+nvl(cgs.dfzc,0)+nvl(cgs.yhdk,0))) * 100),2) v_38,jz1.wcmc v_39,jz1.yiji v_40,"
       +" jz1.erji v_41,jz1.sanji v_42,jz1.siji v_43,jz1.lq v_44,jz1.sn v_45,"
