...
public interface GcybbServer {
	...
	List<Excel_list> getLwgzZhfzybb(Gcglabgc gcglabgc);
	...
	List<Excel_list> getWnjhQqtjhzb(Gcglabgc gcglabgc);
	...
	List<Excel_list> getSjgzjdxxb(Gcglabgc gcglabgc);

	List<Excel_list> getSjgzjdhzb(Gcglabgc gcglabgc);
