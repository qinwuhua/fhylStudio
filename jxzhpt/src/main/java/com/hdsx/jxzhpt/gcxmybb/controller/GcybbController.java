	...
	public void getGjxjmxb(){
		...
		try{
			    ...
			    if("升级改造".equals(gcglwqgz.getTiaojian())){
			    	...
			    	+" select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_sjgz j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_sjgz cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null) group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1 "
		    		+" union all"
				...
				if("路面改造".equals(gcglwqgz.getTiaojian())){
					...
					+" select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_lmgz j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_lmgz cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null)group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1 "
		            +" union all"
		            +" select '36' xzqh,'全省汇总' xzqhmc,jhnf,sum(xmsl),sum(xmlc), sum(xmzj),sum(wclc),sum(wcxmzj),sum(bbzorsbz),sum(bbz), sum(pfztz) from (select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_lmgz j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_lmgz cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null)group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1)  group by substr(xzqh, 1, 2), jhnf order by xzqh, jhnf";
				...
				if("灾毁重建".equals(gcglwqgz.getTiaojian())){
					...
					+" select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_sh j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_sh cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null)group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1 "
		            +" union all"
		            +" select '36' xzqh,'全省汇总' xzqhmc,jhnf,sum(xmsl),sum(xmlc), sum(xmzj),sum(wclc),sum(wcxmzj),sum(bbzorsbz),sum(bbz), sum(pfztz) from (select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_sh j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_sh cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null)group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1)  group by substr(xzqh, 1, 2), jhnf order by xzqh, jhnf";
				...
				if("新建".equals(gcglwqgz.getTiaojian())){
					...
					+" select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_xj j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_xj cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null) group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1 "
		            +" union all"
		            +" select '36' xzqh,'全省汇总' xzqhmc,jhnf,sum(xmsl),sum(xmlc), sum(xmzj),sum(wclc),sum(wcxmzj),sum(bbzorsbz),sum(bbz), sum(pfztz) from (select t1.xzqh,to_char((select name from xtgl_xzqh where id = t1.xzqh || '00')) xzqhmc,t1.jhnf,t1.xmsl,t1.xmlc,t1.bbzorsbz xmzj,t1.bnwclc wclc,t1.bnwctz wcxmzj,t1.bbzorsbz,t1.bncgs bbz,t1.pfztz from (select substr(cb.xzqhdm, 0, 4) xzqh,t.xdnf jhnf,count(distinct j.xmbm) xmsl,sum(lx1.zlc) xmlc,sum(t.bbzorsbz) bbzorsbz,sum(t.pfztz) pfztz,sum(decode(t.xdnf, lx.ybnf, lx.bnwclc, 0)) bnwclc,sum(decode(t.xdnf, lx.ybnf, lx.bnwctz, 0)) bnwctz,sum(decode(t.xdnf, cgs.ybnf, cgs.cgs, 0)) bncgs  from jhsh_xj j,(select xmid,decode(substr(xmid,11,1),1,(nvl(sum(jhyilc),0)+nvl(sum(jherlc),0)+nvl(sum(jhsanlc),0)+nvl(sum(jhsilc),0)+nvl(sum(jhdwlc),0)+nvl(sum(jhwllc),0)),(nvl(sum(yilc),0)+nvl(sum(erlc),0)+nvl(sum(sanlc),0)+nvl(sum(silc),0)+nvl(sum(dwlc),0)+nvl(sum(wllc),0))) zlc from lxsh_lx where jdbs=2 group by xmid) lx1,(select xmid,min(xdnf) xdnf,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0)) bbzorsbz,sum(nvl(btzzj,0))+sum(nvl(gz,0))+sum(nvl(sz,0))+sum(nvl(zq,0))+sum(nvl(dk,0))+sum(nvl(jl,0))+sum(nvl(qt,0))+sum(nvl(yhdk,0))+sum(nvl(dfzc,0)) pfztz from plan_zjxd where jhxdwh is not null and xdnf <='"+gcglwqgz.getYbnf()+"' group by xmid) t,(select xmbm,substr(ybyf,0,4) ybnf,max(bndsslc) bndsslc,sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0))+sum(nvl(yilc,0)) bnwclc,sum(nvl(wccgs,0))+sum(nvl(wcgz,0))+sum(nvl(wcsz,0))+sum(nvl(wczq,0))+sum(nvl(wcdk,0))+sum(nvl(wcjl,0))+sum(nvl(wcqt,0))+sum(nvl(wcyhdk,0))+sum(nvl(wcdfzc,0)) bnwctz from gcgl_xmjd where to_date(ybyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by xmbm,substr(ybyf,0,4)) lx, (select jhid,substr(tbyf,0,4) ybnf,sum(cgsdwzj) cgs from gcgl_cgs where to_date(tbyf, 'yyyy-mm') <= to_date('"+gcglwqgz.getYbnf()+"-"+gcglwqgz.getYbyf()+"', 'yyyy-mm') group by jhid,substr(tbyf,0,4) ) cgs,cbsj_xj cb  where j.xmbm=t.xmid(+) and j.xmbm=cgs.jhid(+) and j.xmbm=cb.xmbm(+) and j.xmbm=lx.xmbm(+) and j.xmbm=lx1.xmid(+) and j.xmbm in (select xmid from plan_zjxd where jhxdwh is not null) group by substr(cb.xzqhdm, 0, 4),t.xdnf) t1 )  group by substr(xzqh, 1, 2), jhnf order by xzqh, jhnf";
