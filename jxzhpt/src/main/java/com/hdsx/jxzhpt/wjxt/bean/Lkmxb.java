...
public class Lkmxb implements Serializable {
	...
	public String getMxb_id() {
		return mxb_id;
	}
	public void setMxb_id(String mxb_id) {
		this.mxb_id = mxb_id;
	}
	...
	public String getQjfx() {
		return qjfx;
	}
	public void setQjfx(String qjfx) {
		this.qjfx = qjfx;
	}
	public String getPdlc() {
		return pdlc;
	}
	public void setPdlc(String pdlc) {
		this.pdlc = pdlc;
	}
