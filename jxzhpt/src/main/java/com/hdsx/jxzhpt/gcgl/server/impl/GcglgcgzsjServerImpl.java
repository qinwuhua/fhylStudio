...
public class GcglgcgzsjServerImpl extends BaseOperate implements GcglgcgzsjServer {
	...
	@Override
	public List<Map<String,Object>> queryGcgjList(Gcglgcgzsj gcglgcgzsj) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Map<String,Object>> selectWqgzjhList2(Gcglgcgzsj gcglgcgzsj) {
		// TODO Auto-generated method stub
	...
	@Override
	public List<Map<String, Object>> queryGsdList(Gcglgcgzsj gcglgcgzsj) {
		return queryList("queryGsdList", gcglgcgzsj);
	}
