...
public class Gcbb5 {
	...
	private String bnzycgs;//本年度中央车购税
	private String bndsslc;//本年度实施里程
	private String bnzycgs1;//本年年初至本月到位中央车购税
	private String bndfpt;//本年地方投资
	private String bnyhdk;//本年银行贷款
	private String bnqtzj;//本年其他资金
	private String bnwctz;//本年完成投资
	...
	public String getDfpt() {
		return dfpt;
	}
	public void setDfpt(String dfpt) {
		this.dfpt = dfpt;
	}
	...
	public String getBnzycgs() {
		return bnzycgs;
	}
	public void setBnzycgs(String bnzycgs) {
		this.bnzycgs = bnzycgs;
	}
	...
	public String getBnzycgs1() {
		return bnzycgs1;
	}
	public void setBnzycgs1(String bnzycgs1) {
		this.bnzycgs1 = bnzycgs1;
	}
	public String getBnqtzj() {
		return bnqtzj;
	}
	public void setBnqtzj(String bnqtzj) {
		this.bnqtzj = bnqtzj;
	}
	...
	public String getBnwcgzl() {
		return bnwcgzl;
	}
	public void setBnwcgzl(String bnwcgzl) {
		this.bnwcgzl = bnwcgzl;
	}
	public String getZjwctz() {
		return zjwctz;
	}
	public void setZjwctz(String zjwctz) {
		this.zjwctz = zjwctz;
	}
	public String getZjwcgzl() {
		return zjwcgzl;
	}
	public void setZjwcgzl(String zjwcgzl) {
		this.zjwcgzl = zjwcgzl;
	}
	...
	public List<Plan_lx_gcgj> getGcgjlx() {
		return gcgjlx;
	}
	public void setGcgjlx(List<Plan_lx_gcgj> gcgjlx) {
		this.gcgjlx = gcgjlx;
	}
	public List<Plan_lx_shuih> getGcshlx() {
		return gcshlx;
	}
	public void setGcshlx(List<Plan_lx_shuih> gcshlx) {
		this.gcshlx = gcshlx;
	}
	...
	public String getBndfpt() {
		return bndfpt;
	}
	public void setBndfpt(String bndfpt) {
		this.bndfpt = bndfpt;
	}
	public String getBnyhdk() {
		return bnyhdk;
	}
	public void setBnyhdk(String bnyhdk) {
		this.bnyhdk = bnyhdk;
	}
	public String getJhjsdd() {
		return jhjsdd;
	}
	public void setJhjsdd(String jhjsdd) {
		this.jhjsdd = jhjsdd;
	}
}
