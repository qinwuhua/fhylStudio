...
public class GcbbController extends BaseActionSupport{
	...
	public void selGcsjJdbb() throws IOException, Exception{
		...
		if("flag".equals(flag)){
			...
			et.add(new Excel_tilte("桥梁",2,3,22,23));
			et.add(new Excel_tilte("涵洞（米）",2,3,24,24));
			et.add(new Excel_tilte("隧道",2,3,25,26));
			...
			et.add(new Excel_tilte("桥梁",2,3,34,35));
			et.add(new Excel_tilte("涵洞（米）",2,3,36,36));
			et.add(new Excel_tilte("隧道",2,3,37,38));
	...
	public void selGcbb5() throws IOException, Exception{
		try{
			...
			if("flag".equals(flag)){
				...
				et.add(new Excel_tilte("累 计 完 成 工 程 量 （ 公 里 )",2,4,33,40));
				...
				et.add(new Excel_tilte("按技术等级",3,4,24,28));
				et.add(new Excel_tilte("按路面类型",3,4,29,30));
				et.add(new Excel_tilte("砂石垫层通车",3,4,31,31));
				et.add(new Excel_tilte("按技术等级",3,4,33,37));
				et.add(new Excel_tilte("按路面类型",3,4,38,39));
