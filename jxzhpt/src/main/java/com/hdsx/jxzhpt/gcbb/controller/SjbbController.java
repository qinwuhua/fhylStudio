...
public class SjbbController extends BaseActionSupport implements ModelDriven<SjbbMessage>{
	...
	public void getGdzctzjs(){
		try {
			...
			List<SjbbMessage> l = new ArrayList<SjbbMessage>();
			/*for (SjbbMessage s : list) {
				SjbbMessage sj=new SjbbMessage();
				if("交通局".equals(sjbb.getDwlx())){
					sj.setV_0(s.getV_0());sj.setV_1(s.getV_5());sj.setV_2(s.getV_6());sj.setV_3(s.getV_7());sj.setV_4(s.getV_8());sj.setV_5(s.getV_17());sj.setV_6(s.getV_18());sj.setV_7(s.getV_19());sj.setV_8(s.getV_20());sj.setV_9(s.getV_29());sj.setV_10(s.getV_30());sj.setV_11(s.getV_31());sj.setV_12(s.getV_32());sj.setV_13(s.getV_38());
				}else{
					sj.setV_0(s.getV_0());sj.setV_1(s.getV_1());sj.setV_2(s.getV_2());sj.setV_3(s.getV_3());sj.setV_4(s.getV_4());sj.setV_5(s.getV_13());sj.setV_6(s.getV_14());sj.setV_7(s.getV_15());sj.setV_8(s.getV_16());sj.setV_9(s.getV_25());sj.setV_10(s.getV_26());sj.setV_11(s.getV_27());sj.setV_12(s.getV_28());sj.setV_13(s.getV_37());
				}
				l.add(sj);
			}*/
			...
			if("flag".equals(flag)){
				...
				//导出设置
				ExcelData eldata=new ExcelData();//创建一个类
				eldata.setTitleName("建议计划汇总表(按地市汇总)");//设置第一行
				eldata.setSheetName("建议计划汇总表(按地市汇总)");//设置sheeet名
				eldata.setFileName("建议计划汇总表(按地市汇总)");//设置文件名
				eldata.setEl1(list);//将实体list放入类中
				List<Excel_tilte> et=new ArrayList<Excel_tilte>();//创建一个list存放表头
				et.add(new Excel_tilte("项目所在地区",1,3,0,0));
				et.add(new Excel_tilte("危桥改造",1,1,1,12));
				et.add(new Excel_tilte("病隧改造",1,1,13,24));
				et.add(new Excel_tilte("安防工程",1,1,25,36));
				et.add(new Excel_tilte("灾害防灾",1,1,37,48));
				et.add(new Excel_tilte("总计",1,1,49,51));
				
				et.add(new Excel_tilte("小计",2,2,1,4));
				et.add(new Excel_tilte("公路局",2,2,5,8));
				et.add(new Excel_tilte("交通局",2,2,9,12));
				et.add(new Excel_tilte("小计",2,2,13,16));
				et.add(new Excel_tilte("公路局",2,2,17,20));
				et.add(new Excel_tilte("交通局",2,2,21,24));
				et.add(new Excel_tilte("小计",2,2,25,28));
				et.add(new Excel_tilte("公路局",2,2,29,32));
				et.add(new Excel_tilte("交通局",2,2,33,36));
				et.add(new Excel_tilte("小计",2,2,37,40));
				et.add(new Excel_tilte("公路局",2,2,41,44));
				et.add(new Excel_tilte("交通局",2,2,45,48));
				et.add(new Excel_tilte("合计",2,2,49,49));
				et.add(new Excel_tilte("公路",2,2,50,50));
				et.add(new Excel_tilte("交通",2,2,51,51));
				...
				et.add(new Excel_tilte("项目数量",3,3,37,37));
				et.add(new Excel_tilte("处治里程(km)",3,3,38,38));
				et.add(new Excel_tilte("总投资(万元)",3,3,39,39));
				et.add(new Excel_tilte("补助资金(万元)",3,3,40,40));
				et.add(new Excel_tilte("项目数量",3,3,41,41));
				et.add(new Excel_tilte("处治里程(km)",3,3,42,42));
				et.add(new Excel_tilte("总投资(万元)",3,3,43,43));
				et.add(new Excel_tilte("补助资金(万元)",3,3,44,44));
				et.add(new Excel_tilte("项目数量",3,3,45,45));
				et.add(new Excel_tilte("处治里程(km)",3,3,46,46));
				et.add(new Excel_tilte("总投资(万元)",3,3,47,47));
				et.add(new Excel_tilte("补助资金(万元)",3,3,48,48));
				
				et.add(new Excel_tilte("补助资金(万元)",3,3,49,49));
				et.add(new Excel_tilte("补助资金(万元)",3,3,50,50));
				et.add(new Excel_tilte("补助资金(万元)",3,3,51,51));
				eldata.setEt(et);//将表头内容设置到类里面
				HttpServletResponse response= getresponse();//获得一个HttpServletResponse
	...
	public void getJckhzbAds(){
		try {
			...
			sjbb.setUnit(tiaojian1);
			sjbb.setDist(tiaojian2);
			List<SjbbMessage> list = sjbbServer.getJckhzbAds(sjbb);
			/*List<SjbbMessage> l = new ArrayList<SjbbMessage>();
			for (SjbbMessage s : list) {
				SjbbMessage sj=new SjbbMessage();
				if("交通局".equals(sjbb.getDwlx())){
			...
			if("flag".equals(flag)){
				...
				//导出设置
				ExcelData eldata=new ExcelData();//创建一个类
				eldata.setTitleName("基础库情况汇总表(按地市汇总)");//设置第一行
				eldata.setSheetName("基础库情况汇总表(按地市汇总)");//设置sheeet名
				eldata.setFileName("基础库情况汇总表(按地市汇总)");//设置文件名
				eldata.setEl1(list);//将实体list放入类中
				List<Excel_tilte> et=new ArrayList<Excel_tilte>();//创建一个list存放表头
				et.add(new Excel_tilte("项目所在地区",1,3,0,0));
				et.add(new Excel_tilte("危桥改造",1,1,1,6));
				et.add(new Excel_tilte("病隧改造",1,1,7,12));
				et.add(new Excel_tilte("安防工程",1,1,13,18));
				et.add(new Excel_tilte("灾害防灾",1,1,19,24));
				
				et.add(new Excel_tilte("小计",2,2,1,2));
				et.add(new Excel_tilte("公路局",2,2,3,4));
				et.add(new Excel_tilte("交通局",2,2,5,6));
				et.add(new Excel_tilte("小计",2,2,7,8));
				et.add(new Excel_tilte("公路局",2,2,9,10));
				et.add(new Excel_tilte("交通局",2,2,11,12));
				et.add(new Excel_tilte("小计",2,2,13,14));
				et.add(new Excel_tilte("公路局",2,2,15,16));
				et.add(new Excel_tilte("交通局",2,2,17,18));
				et.add(new Excel_tilte("小计",2,2,19,20));
				et.add(new Excel_tilte("公路局",2,2,21,22));
				et.add(new Excel_tilte("交通局",2,2,23,24));
				...
				et.add(new Excel_tilte("座",3,3,5,5));
				et.add(new Excel_tilte("延米",3,3,6,6));
				et.add(new Excel_tilte("项目数量",3,3,7,7));
				et.add(new Excel_tilte("隧道长度(m)",3,3,8,8));
				et.add(new Excel_tilte("项目数量",3,3,9,9));
				et.add(new Excel_tilte("隧道长度(m)",3,3,10,10));
				et.add(new Excel_tilte("项目数量",3,3,11,11));
				et.add(new Excel_tilte("隧道长度(m)",3,3,12,12));
				et.add(new Excel_tilte("项目数量",3,3,13,13));
				et.add(new Excel_tilte("处治里程(km)",3,3,14,14));
				et.add(new Excel_tilte("项目数量",3,3,15,15));
				et.add(new Excel_tilte("处治里程(km)",3,3,16,16));
				et.add(new Excel_tilte("项目数量",3,3,17,17));
				et.add(new Excel_tilte("处治里程(km)",3,3,18,18));
				et.add(new Excel_tilte("项目数量",3,3,19,19));
				et.add(new Excel_tilte("处治里程(km)",3,3,20,20));
				et.add(new Excel_tilte("项目数量",3,3,21,21));
				et.add(new Excel_tilte("处治里程(km)",3,3,22,22));
				et.add(new Excel_tilte("项目数量",3,3,23,23));
				et.add(new Excel_tilte("处治里程(km)",3,3,24,24));
	...
	public void getJckhzbAgsxx(){
		try {
			...
			sjbb.setUnit(tiaojian1);
			sjbb.setDist(tiaojian2);
			List<SjbbMessage> list = sjbbServer.getJckhzbAgsxx(sjbb);
			if("flag".equals(flag)){
				
				//导出设置
				ExcelData eldata=new ExcelData();//创建一个类
				eldata.setTitleName("基础库情况汇总表(按国省县乡汇总)");//设置第一行
				eldata.setSheetName("基础库情况汇总表(按国省县乡汇总)");//设置sheeet名
				eldata.setFileName("基础库情况汇总表(按国省县乡汇总)");//设置文件名
				eldata.setEl1(list);//将实体list放入类中
				List<Excel_tilte> et=new ArrayList<Excel_tilte>();//创建一个list存放表头
				et.add(new Excel_tilte("项目名称",1,1,0,0));
				et.add(new Excel_tilte("行政等级",1,1,1,1));
				...
				et.add(new Excel_tilte("延米",1,1,3,3));
				et.add(new Excel_tilte("处治里程",1,1,4,4));
				et.add(new Excel_tilte("隧道长度(m)",1,1,5,5));
				eldata.setEt(et);//将表头内容设置到类里面
				HttpServletResponse response= getresponse();//获得一个HttpServletResponse
				Excel_export.excel_exportjsjh(eldata,response);
			}else{
	...
	//审查库汇总表----按地市
		public void getSckhzbAds(){
			try {
				...
				sjbb.setUnit(tiaojian1);
				sjbb.setDist(tiaojian2);
				List<SjbbMessage> list = sjbbServer.getSckhzbAds(sjbb);
				List<SjbbMessage> l = new ArrayList<SjbbMessage>();
				/*for (SjbbMessage s : list) {
					SjbbMessage sj=new SjbbMessage();
					if("交通局".equals(sjbb.getDwlx())){
				...
				if("flag".equals(flag)){
					...
					//导出设置
					ExcelData eldata=new ExcelData();//创建一个类
					eldata.setTitleName("审查库情况汇总表(按地市汇总)");//设置第一行
					eldata.setSheetName("审查库情况汇总表(按地市汇总)");//设置sheeet名
					eldata.setFileName("审查库情况汇总表(按地市汇总)");//设置文件名
					eldata.setEl1(list);//将实体list放入类中
					List<Excel_tilte> et=new ArrayList<Excel_tilte>();//创建一个list存放表头
					et.add(new Excel_tilte("项目所在地区",1,3,0,0));
					et.add(new Excel_tilte("危桥改造",1,1,1,9));
					et.add(new Excel_tilte("病隧改造",1,1,10,18));
					et.add(new Excel_tilte("安防工程",1,1,19,27));
					et.add(new Excel_tilte("灾害防灾",1,1,28,36));
					
					et.add(new Excel_tilte("小计",2,2,1,3));
					et.add(new Excel_tilte("公路局",2,2,4,6));
					et.add(new Excel_tilte("交通局",2,2,7,9));
					et.add(new Excel_tilte("小计",2,2,10,12));
					et.add(new Excel_tilte("公路局",2,2,13,15));
					et.add(new Excel_tilte("交通局",2,2,16,18));
					et.add(new Excel_tilte("小计",2,2,19,21));
					et.add(new Excel_tilte("公路局",2,2,22,24));
					et.add(new Excel_tilte("交通局",2,2,25,27));
					et.add(new Excel_tilte("小计",2,2,28,30));
					et.add(new Excel_tilte("公路局",2,2,31,33));
					et.add(new Excel_tilte("交通局",2,2,34,36));
					
					et.add(new Excel_tilte("座",3,3,1,1));
					et.add(new Excel_tilte("延米",3,3,2,2));
					et.add(new Excel_tilte("投资估算(万元)",3,3,3,3));
					et.add(new Excel_tilte("座",3,3,4,4));
					et.add(new Excel_tilte("延米",3,3,5,5));
					et.add(new Excel_tilte("投资估算(万元)",3,3,6,6));
					et.add(new Excel_tilte("座",3,3,7,7));
					et.add(new Excel_tilte("延米",3,3,8,8));
					et.add(new Excel_tilte("投资估算(万元)",3,3,9,9));
					
					et.add(new Excel_tilte("项目数量",3,3,10,10));
					et.add(new Excel_tilte("处治里程(km)",3,3,11,11));
					et.add(new Excel_tilte("投资估算(万元)",3,3,12,12));
					et.add(new Excel_tilte("项目数量",3,3,13,13));
					et.add(new Excel_tilte("处治里程(km)",3,3,14,14));
					et.add(new Excel_tilte("投资估算(万元)",3,3,15,15));
					et.add(new Excel_tilte("项目数量",3,3,16,16));
					et.add(new Excel_tilte("处治里程(km)",3,3,17,17));
					et.add(new Excel_tilte("投资估算(万元)",3,3,18,18));
					
					et.add(new Excel_tilte("项目数量",3,3,19,19));
					et.add(new Excel_tilte("处治里程(km)",3,3,20,20));
					et.add(new Excel_tilte("投资估算(万元)",3,3,21,21));
					et.add(new Excel_tilte("项目数量",3,3,22,22));
					et.add(new Excel_tilte("处治里程(km)",3,3,23,23));
					et.add(new Excel_tilte("投资估算(万元)",3,3,24,24));
					et.add(new Excel_tilte("项目数量",3,3,25,25));
					et.add(new Excel_tilte("处治里程(km)",3,3,26,26));
					et.add(new Excel_tilte("投资估算(万元)",3,3,27,27));
					
					et.add(new Excel_tilte("项目数量",3,3,28,28));
					et.add(new Excel_tilte("处治里程(km)",3,3,29,29));
					et.add(new Excel_tilte("投资估算(万元)",3,3,30,30));
					et.add(new Excel_tilte("项目数量",3,3,31,31));
					et.add(new Excel_tilte("处治里程(km)",3,3,32,32));
					et.add(new Excel_tilte("投资估算(万元)",3,3,33,33));
					et.add(new Excel_tilte("项目数量",3,3,34,34));
					et.add(new Excel_tilte("处治里程(km)",3,3,35,35));
					et.add(new Excel_tilte("投资估算(万元)",3,3,36,36));
		...
		public void getSckhzbAgsxx(){
			try {
				...
				sjbb.setUnit(tiaojian1);
				sjbb.setDist(tiaojian2);
				List<SjbbMessage> list = sjbbServer.getSckhzbAgsxx(sjbb);
				if("flag".equals(flag)){
					...
					et.add(new Excel_tilte("延米",1,1,3,3));
					et.add(new Excel_tilte("处治里程",1,1,4,4));
					et.add(new Excel_tilte("投资估算(万)",1,1,5,5));
