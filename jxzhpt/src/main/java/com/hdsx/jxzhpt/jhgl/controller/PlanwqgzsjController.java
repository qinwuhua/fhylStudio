...
public class PlanwqgzsjController extends BaseActionSupport {
	...
	public void dcwqgzsjjhshExcel(){
		...
		et.add(new Excel_tilte("新桥梁编码",1,1,5,5));
		et.add(new Excel_tilte("桥梁名称",1,1,6,6));
		et.add(new Excel_tilte("桥长（米）",1,1,7,7));
		et.add(new Excel_tilte("桥宽（米）",1,1,8,8));
		et.add(new Excel_tilte("建设性质",1,1,9,9));
		et.add(new Excel_tilte("建设内容",1,1,10,10));
