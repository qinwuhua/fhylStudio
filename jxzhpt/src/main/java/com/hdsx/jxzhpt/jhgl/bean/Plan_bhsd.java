...
public class Plan_bhsd implements Serializable{
	
	
	private String id;//唯一ID
	private String sckid;//病害隧道项目库ID
	...
	private String jhsydfzcje;//计划使用地方自筹金额(申请车购税补助)
	private String zczjyls;//自筹资金已落实
	private String qtzj;//其他资金
	...
	private String acdfl;//隧道分类
	
	private String jh_thyj;//退回意见
	private String tbbmbm;
	private String shFlag;//审核flag
	private String jh_sdzt;//审定状态
	private String xtType;//系统类型 nc or gx
	private String tz_type;//调整类型
	private Date tz_time;//调整时间
	
	
	public String getTz_type() {
		return tz_type;
	}
	public void setTz_type(String tz_type) {
	...
	public String getJh_sdzt() {
		return jh_sdzt;
	}
	public void setJh_sdzt(String jh_sdzt) {
		this.jh_sdzt = jh_sdzt;
	}
	...
	public String getJh_thyj() {
		return jh_thyj;
	}
	public void setJh_thyj(String jh_thyj) {
		this.jh_thyj = jh_thyj;
	}
