...
public class Plan_gcgj {
	...
	private String pfztz;//皮肤总投资(万元)
	private String jhsybzje;//计划使用部补助金额(万元)
	private String jhsydfzcje;//计划使用地方自筹资金(万元)
	...
	public int getWjsczt() {
		return wjsczt;
	}
	public void setWjsczt(int wjsczt) {
		this.wjsczt = wjsczt;
	}
	...
	public String getYjgyy() {
		return yjgyy;
	}
	public void setYjgyy(String yjgyy) {
		this.yjgyy = yjgyy;
	}
