...
public class Jhsh2 {
	...
	public String toString() {
		return "Jhsh2 [id=" + id + ", xmmc=" + xmmc + ", ghlxbh=" + ghlxbh
				+ ", ylxbh=" + ylxbh + ", gcfl=" + gcfl + ", xzqh=" + xzqh
				+ ", xzqhdm=" + xzqhdm + ", jhkgsj=" + jhkgsj + ", jhwgsj="
				+ jhwgsj + ", xmbm=" + xmbm + ", xdwh=" + xdwh + ", xdsj="
				+ xdsj + ", qdzh=" + qdzh + ", zdzh=" + zdzh + ", lc=" + lc
				+ ", xdzt=" + xdzt + ", pfztz=" + pfztz + ", bbzzj=" + bbzzj
				+ ", sbzzj=" + sbzzj + ", ztz=" + ztz + ", sysbbzj=" + sysbbzj
				+ ", yqdbcgs=" + yqdbcgs + ", mclmlx=" + mclmlx + ", mclx="
				+ mclx + ", mcsl=" + mcsl + ", mcje=" + mcje + ", jclx=" + jclx
				+ ", jcsj=" + jcsj + ", jcje=" + jcje + ", xfcsl=" + xfcsl
				+ ", xfcje=" + xfcje + ", bxsl=" + bxsl + ", bxje=" + bxje
				+ ", gfcd=" + gfcd + ", gfje=" + gfje + ", llcl=" + llcl
				+ ", xmlx=" + xmlx + ", jsdj=" + jsdj + ", tsdq=" + tsdq + "]";
	}
}
