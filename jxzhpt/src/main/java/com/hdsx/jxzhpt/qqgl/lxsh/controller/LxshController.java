	...
	public void dckxxModule(){
		try {
			...
			if("lmgz".equals(lxsh.getXmlx())){
				...
				et.add(new Excel_tilte("特大桥(米)",1,1,14,14));
				et.add(new Excel_tilte("特大桥(座)",1,1,15,15));
				et.add(new Excel_tilte("建设技术等级",1,1,16,16));
				et.add(new Excel_tilte("隧道(米)",1,1,17,17));		
				et.add(new Excel_tilte("隧道(座)",1,1,18,18));
				et.add(new Excel_tilte("开工年月",1,1,19,19));
				et.add(new Excel_tilte("完工年月",1,1,20,20));
				et.add(new Excel_tilte("编制单位",1,1,21,21));
				et.add(new Excel_tilte("投资估算",1,1,22,22));
				et.add(new Excel_tilte("地方自筹",1,1,23,23));
				et.add(new Excel_tilte("银行贷款",1,1,24,24));
