...
//			lxsh.setGydw(tiaojian1);
			...
			eldata.setTitleName("公路建设项目立项(国省道改造"+xmbt+"工程)");//设置第一行 
			eldata.setSheetName("公路建设项目立项(国省道改造"+xmbt+"工程)");//设置sheeet名
			eldata.setFileName("公路建设项目立项(国省道改造"+xmbt+"工程)");//设置文件名
			...
			et.add(new Excel_tilte("PQI",1,1,30,30));
	...
	public void dckxxModule(){
		try {
			...
			ExcelData eldata=new ExcelData();//创建一个类
			eldata.setTitleName("公路建设项目工程可行性研究(国省道改造"+xmbt+"工程)");//设置第一行 
			eldata.setSheetName("公路建设项目工程可行性研究(国省道改造"+xmbt+"工程)");//设置sheeet名
			eldata.setFileName("公路建设项目工程可行性研究(国省道改造"+xmbt+"工程)");//设置文件名
			eldata.setEl(elist);//将实体list放入类中
