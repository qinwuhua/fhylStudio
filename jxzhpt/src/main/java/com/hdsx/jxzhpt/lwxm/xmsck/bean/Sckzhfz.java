...
public class Sckzhfz implements Serializable {
	...
	public String toString() {
		return "Sckzhfz [sckid=" + sckid + ", id=" + id + ", xmkid=" + xmkid
				+ ", scqdzh=" + scqdzh + ", sczdzh=" + sczdzh + ", sczlc="
				+ sczlc + ", scyhlc=" + scyhlc + ", scxmnf=" + scxmnf
				+ ", tzgs=" + tzgs + ", spwh=" + spwh + ", fapgdw=" + fapgdw
				+ ", fascdw=" + fascdw + ", faspsj=" + faspsj + ", jsxz="
				+ jsxz + ", jsnr=" + jsnr + ", scbz=" + scbz + ", scbmbm="
				+ scbmbm + ", sck_sbzt=" + sck_sbzt + ", sck_sbsj=" + sck_sbsj
