...
jckwqgzsj.setGydw("and (gydwbm='"+gydw+"'||'00' or gydwbm in(select id from xtgl_department where parent='"+gydw+"'||'00'))");					else
	...
	public void dcwqgzsjsckExcel(){
		...
		et.add(new Excel_tilte("桥梁名称",1,1,8,8));
		et.add(new Excel_tilte("桥梁中心桩号",1,1,9,9));
		et.add(new Excel_tilte("桥梁全长（米）",1,1,10,10));
		et.add(new Excel_tilte("桥梁全宽（米）",1,1,11,11));
		et.add(new Excel_tilte("按跨径分类",1,1,12,12));
		et.add(new Excel_tilte("方案评估（设计）单位",1,1,13,13));
		et.add(new Excel_tilte("方案审查（批复）单位",1,1,14,14));
		et.add(new Excel_tilte("方案审批时间",1,1,15,15));
		et.add(new Excel_tilte("审批文号",1,1,16,16));
		et.add(new Excel_tilte("投资估算（万元）",1,1,17,17));
		et.add(new Excel_tilte("建设性质",1,1,18,18));
		et.add(new Excel_tilte("建设内容",1,1,19,19));
		et.add(new Excel_tilte("项目年份",1,1,20,20));
		et.add(new Excel_tilte("拟申请部（省）级补助资金（万元）",1,1,21,21));
	...
	public void dcwqgzsjsckshExcel(){
		...
		et.add(new Excel_tilte("桥梁全长（米）",1,1,10,10));
		et.add(new Excel_tilte("桥梁全宽（米）",1,1,11,11));
		et.add(new Excel_tilte("方案评估（设计）单位",1,1,12,12));
		et.add(new Excel_tilte("方案审查（批复）单位",1,1,13,13));
		et.add(new Excel_tilte("方案审批时间",1,1,14,14));
		et.add(new Excel_tilte("审批文号",1,1,15,15));
		et.add(new Excel_tilte("投资估算（万元）",1,1,16,16));
		et.add(new Excel_tilte("建设性质",1,1,17,17));
		et.add(new Excel_tilte("建设内容",1,1,18,18));
		et.add(new Excel_tilte("项目年份",1,1,19,19));
		et.add(new Excel_tilte("拟申请部（省）级补助资金（万元）",1,1,20,20));
